...
$jscomp.polyfill=function(a,b){if(b){var c=$jscomp.global;a=a.split(".");for(var d=0;d<a.length-1;d++){var e=a[d];e in c||(c[e]={});c=c[e]}a=a[a.length-1];d=c[a];b=b(d);b!=d&&null!=b&&$jscomp.defineProperty(c,a,{configurable:!0,writable:!0,value:b})}};$jscomp.makeIterator=function(a){$jscomp.initSymbolIterator();var b=a[Symbol.iterator];return b?b.call(a):$jscomp.arrayIterator(a)};$jscomp.FORCE_POLYFILL_PROMISE=!1;
$jscomp.polyfill("Promise",function(a){function b(){this.batch_=null}function c(a){return a instanceof f?a:new f(function(b){b(a)})}if(a&&!$jscomp.FORCE_POLYFILL_PROMISE)return a;b.prototype.asyncExecute=function(a){null==this.batch_&&(this.batch_=[],this.asyncExecuteBatch_());this.batch_.push(a);return this};b.prototype.asyncExecuteBatch_=function(){var a=this;this.asyncExecuteFunction(function(){a.executeBatch_()})};var d=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(a){d(a,
0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var a=this.batch_;this.batch_=[];for(var b=0;b<a.length;++b){var c=a[b];a[b]=null;try{c()}catch(q){this.asyncThrow_(q)}}}this.batch_=null};b.prototype.asyncThrow_=function(a){this.asyncExecuteFunction(function(){throw a;})};var e={PENDING:0,FULFILLED:1,REJECTED:2},f=function(a){this.state_=e.PENDING;this.result_=void 0;this.onSettledCallbacks_=[];var b=this.createResolveAndReject_();try{a(b.resolve,b.reject)}catch(n){b.reject(n)}};
f.prototype.createResolveAndReject_=function(){function a(a){return function(d){c||(c=!0,a.call(b,d))}}var b=this,c=!1;return{resolve:a(this.resolveTo_),reject:a(this.reject_)}};f.prototype.resolveTo_=function(a){if(a===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(a instanceof f)this.settleSameAsPromise_(a);else{a:switch(typeof a){case "object":var b=null!=a;break a;case "function":b=!0;break a;default:b=!1}b?this.resolveToNonPromiseObj_(a):this.fulfill_(a)}};f.prototype.resolveToNonPromiseObj_=
function(a){var b=void 0;try{b=a.then}catch(n){this.reject_(n);return}"function"==typeof b?this.settleSameAsThenable_(b,a):this.fulfill_(a)};f.prototype.reject_=function(a){this.settle_(e.REJECTED,a)};f.prototype.fulfill_=function(a){this.settle_(e.FULFILLED,a)};f.prototype.settle_=function(a,b){if(this.state_!=e.PENDING)throw Error("Cannot settle("+a+", "+b+"): Promise already settled in state"+this.state_);this.state_=a;this.result_=b;this.executeOnSettledCallbacks_()};f.prototype.executeOnSettledCallbacks_=
function(){if(null!=this.onSettledCallbacks_){for(var a=0;a<this.onSettledCallbacks_.length;++a)g.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var g=new b;f.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};f.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(q){c.reject(q)}};f.prototype.then=function(a,b){function c(a,b){return"function"==
typeof a?function(b){try{d(a(b))}catch(t){e(t)}}:b}var d,e,g=new f(function(a,b){d=a;e=b});this.callWhenSettled_(c(a,d),c(b,e));return g};f.prototype["catch"]=function(a){return this.then(void 0,a)};f.prototype.callWhenSettled_=function(a,b){function c(){switch(d.state_){case e.FULFILLED:a(d.result_);break;case e.REJECTED:b(d.result_);break;default:throw Error("Unexpected state: "+d.state_);}}var d=this;null==this.onSettledCallbacks_?g.asyncExecute(c):this.onSettledCallbacks_.push(c)};f.resolve=c;
f.reject=function(a){return new f(function(b,c){c(a)})};f.race=function(a){return new f(function(b,d){for(var e=$jscomp.makeIterator(a),f=e.next();!f.done;f=e.next())c(f.value).callWhenSettled_(b,d)})};f.all=function(a){var b=$jscomp.makeIterator(a),d=b.next();return d.done?c([]):new f(function(a,e){function f(b){return function(c){g[b]=c;k--;0==k&&a(g)}}var g=[],k=0;do g.push(void 0),k++,c(d.value).callWhenSettled_(f(g.length-1),e),d=b.next();while(!d.done)})};return f},"es6","es3");
$jscomp.polyfill("Promise.prototype.finally",function(a){return a?a:a=function(a){return this.then(function(b){var c=Promise.resolve(a());return c.then(function(){return b})},function(b){var c=Promise.resolve(a());return c.then(function(){throw b;})})}},"es9","es3");$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,e=0;e<d;e++){var f=a[e];if(b.call(c,f,e,a))return{i:e,v:f}}return{i:-1,v:void 0}};
...
goog.define=function(a,b){goog.exportPath_(a,b)};goog.DEBUG=!0;goog.LOCALE="en";goog.TRUSTED_SITE=!0;goog.STRICT_MODE_COMPATIBLE=!1;goog.DISALLOW_TEST_ONLY_CODE=!goog.DEBUG;goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING=!1;goog.provide=function(a){if(goog.isInGoogModuleLoader_())throw Error("goog.provide cannot be used within a module.");goog.isInEs6ModuleLoader_()&&goog.logToConsole_("goog.provide should not be used within a module.");goog.constructNamespace_(a)};
goog.constructNamespace_=function(a,b){goog.exportPath_(a,b)};goog.getScriptNonce=function(){null===goog.cspNonce_&&(goog.cspNonce_=goog.getScriptNonce_(goog.global.document)||"");return goog.cspNonce_};goog.NONCE_PATTERN_=/^[\w+/_-]+[=]{0,2}$/;goog.cspNonce_=null;goog.getScriptNonce_=function(a){return(a=a.querySelector&&a.querySelector("script[nonce]"))&&(a=a.nonce||a.getAttribute("nonce"))&&goog.NONCE_PATTERN_.test(a)?a:null};goog.VALID_MODULE_RE_=/^[a-zA-Z_$][a-zA-Z0-9._$]*$/;
...
goog.logToConsole_=function(a){goog.global.console&&goog.global.console.error(a)};goog.require=function(){};goog.basePath="";goog.nullFunction=function(){};goog.abstractMethod=function(){throw Error("unimplemented abstract method");};goog.addSingletonGetter=function(a){a.instance_=void 0;a.getInstance=function(){if(a.instance_)return a.instance_;goog.DEBUG&&(goog.instantiatedSingletons_[goog.instantiatedSingletons_.length]=a);return a.instance_=new a}};goog.instantiatedSingletons_=[];
goog.LOAD_MODULE_USING_EVAL=!0;goog.SEAL_MODULE_EXPORTS=goog.DEBUG;goog.loadedModules_={};goog.DEPENDENCIES_ENABLED=!1;goog.TRANSPILE="detect";goog.TRANSPILE_TO_LANGUAGE="";goog.TRANSPILER="transpile.js";goog.hasBadLetScoping=null;goog.useSafari10Workaround=function(){if(null==goog.hasBadLetScoping){try{var a=!eval('"use strict";let x = 1; function f() { return typeof x; };f() == "number";')}catch(b){a=!1}goog.hasBadLetScoping=a}return goog.hasBadLetScoping};
...
return h}angular.module("material.core").config(["$provide",function(a){a.decorator("$mdUtil",["$delegate",function(a){a.iterator=MdIterator;return a}])}]);
function MdIterator(a,b){function c(){return[].concat(p)}function d(){return p.length}function e(a){return p.length&&-1<a&&a<p.length}function f(a){return a?e(l(a)+1):!1}function g(a){return a?e(l(a)-1):!1}function h(a){return e(a)?p[a]:null}function k(a,b){return p.filter(function(c){return c[a]===b})}function n(a,b){if(!a)return-1;angular.isNumber(b)||(b=p.length);p.splice(b,0,a);return l(a)}function q(a){r(a)&&p.splice(l(a),1)}function l(a){return p.indexOf(a)}function r(a){return a&&-1<l(a)}function m(){return p.length?
p[0]:null}function v(){return p.length?p[p.length-1]:null}function w(a,c,d,f){d=d||t;for(c=l(c);;){if(!e(c))return null;c+=a?-1:1;var g=null;e(c)?g=p[c]:b&&(g=a?v():m(),c=l(g));if(null===g||c===f)return null;if(d(g))return g;angular.isUndefined(f)&&(f=c)}}var t=function(){return!0};a&&!angular.isArray(a)&&(a=Array.prototype.slice.call(a));b=!!b;var p=a||[];return{items:c,count:d,inRange:e,contains:r,indexOf:l,itemAt:h,findBy:k,add:n,remove:q,first:m,last:v,next:angular.bind(null,w,!1),previous:angular.bind(null,
w,!0),hasPrevious:g,hasNext:f}}mdMediaFactory.$inject=["$mdConstant","$rootScope","$window"];angular.module("material.core").factory("$mdMedia",mdMediaFactory);
function mdMediaFactory(a,b,c){function d(b){var d=n[b];angular.isUndefined(d)&&(d=b,d=a.MEDIA[d]||("("!==d.charAt(0)?"("+d+")":d),d=n[b]=d);b=l[d];angular.isUndefined(b)&&((b=q[d])||(b=q[d]=c.matchMedia(d)),b.addListener(e),b=l[b.media]=!!b.matches);return b}function e(a){b.$evalAsync(function(){l[a.media]=!!a.matches})}function f(a){return q[a]}function g(b,c){for(var d=0;d<a.MEDIA_PRIORITY.length;d++){var e=a.MEDIA_PRIORITY[d];if(q[n[e]].matches&&(e=k(b,c+"-"+e),b[e]))return b[e]}return b[k(b,
c)]}function h(b,c,d){var e=[];b.forEach(function(b){var f=k(c,b);angular.isDefined(c[f])&&e.push(c.$observe(f,angular.bind(void 0,d,null)));for(var g in a.MEDIA)f=k(c,b+"-"+g),angular.isDefined(c[f])&&e.push(c.$observe(f,angular.bind(void 0,d,g)))});return function(){e.forEach(function(a){a()})}}function k(a,b){return r[b]||(r[b]=a.$normalize(b))}var n={},q={},l={},r={};d.getResponsiveAttribute=g;d.getQuery=f;d.watchResponsiveAttributes=h;return d}
...
function UtilFactory(a,b,c,d,e,f,g,h,k,n){function q(a){return a?-1<String(a).indexOf("px")||-1<String(a).indexOf("%")?a:a+"px":"0"}var l=f.startSymbol(),r=f.endSymbol(),m="{{"===l&&"}}"===r,v=function(a,b,c){var d=!1;a&&a.length&&(a=k.getComputedStyle(a[0]),d=angular.isDefined(a[b])&&(c?a[b]==c:!0));return d},w={dom:{},now:window.performance&&window.performance.now?angular.bind(window.performance,window.performance.now):Date.now||function(){return(new Date).getTime()},getModelOption:function(a,b){if(a.$options)return a=
a.$options,a.getOption?a.getOption(b):a[b]},bidi:function(b,c,d,e){var f=!("rtl"==a[0].dir||"rtl"==a[0].body.dir);if(0==arguments.length)return f?"ltr":"rtl";var g=angular.element(b);f&&angular.isDefined(d)?g.css(c,q(d)):!f&&angular.isDefined(e)&&g.css(c,q(e))},bidiProperty:function(b,c,d,e){var f=!("rtl"==a[0].dir||"rtl"==a[0].body.dir);b=angular.element(b);f&&angular.isDefined(c)?(b.css(c,q(e)),b.css(d,"")):!f&&angular.isDefined(d)&&(b.css(d,q(e)),b.css(c,""))},clientRect:function(a,b,c){a=a[0]||
a;b=b||a.offsetParent||document.body;b=b[0]||b;a=a.getBoundingClientRect();c=c?b.getBoundingClientRect():{left:0,top:0,width:0,height:0};return{left:a.left-c.left,top:a.top-c.top,width:a.width,height:a.height}},offsetRect:function(a,b){return w.clientRect(a,b,!0)},nodesToArray:function(a){a=a||[];for(var b=[],c=0;c<a.length;++c)b.push(a.item(c));return b},getViewportTop:function(){return window.scrollY||window.pageYOffset||0},findFocusTarget:function(a,b){function c(a,b){var c;(a=a[0].querySelectorAll(b))&&
...
c.on("wheel",b);c.on("touchmove",b);return function(){c.off("wheel");c.off("touchmove");!d.disableScrollMask&&c[0].parentNode&&c[0].parentNode.removeChild(c[0])}}function f(){var b=a[0].documentElement,c=b.style.cssText||"",d=g.style.cssText||"",e=w.getViewportTop(),f=g.clientWidth,h=g.scrollHeight>g.clientHeight+1,t=0<b.scrollTop?b:g;h&&angular.element(g).css({position:"fixed",width:"100%",top:-e+"px"});g.clientWidth<f&&(g.style.overflow="hidden");h&&(b.style.overflowY="scroll");return function(){g.style.cssText=
d;b.style.cssText=c;t.scrollTop=e}}d=d||{};w.disableScrollAround._count=Math.max(0,w.disableScrollAround._count||0);w.disableScrollAround._count++;if(w.disableScrollAround._restoreScroll)return w.disableScrollAround._restoreScroll;var g=a[0].body,h=f(),t=e(c);return w.disableScrollAround._restoreScroll=function(){0>=--w.disableScrollAround._count&&(h(),t(),delete w.disableScrollAround._restoreScroll)}},enableScrolling:function(){var a=this.disableScrollAround._restoreScroll;a&&a()},floatingScrollbars:function(){if(void 0===
this.floatingScrollbars.cached){var b=angular.element("<div><div></div></div>").css({width:"100%","z-index":-1,position:"absolute",height:"35px","overflow-y":"scroll"});b.children().css("height","60px");a[0].body.appendChild(b[0]);this.floatingScrollbars.cached=b[0].offsetWidth==b[0].childNodes[0].offsetWidth;b.remove()}return this.floatingScrollbars.cached},forceFocus:function(a){var b=a[0]||a;document.addEventListener("click",function A(a){a.target===b&&a.$focus&&(b.focus(),a.stopImmediatePropagation(),
a.preventDefault(),b.removeEventListener("click",A))},!0);a=document.createEvent("MouseEvents");a.initMouseEvent("click",!1,!0,window,{},0,0,0,0,!1,!1,!1,!1,0,null);a.$material=!0;a.$focus=!0;b.dispatchEvent(a)},createBackdrop:function(a,b){return c(w.supplant('<md-backdrop class="{0}">',[b]))(a)},supplant:function(a,b,c){c=c||/\{([^{}]*)\}/g;return a.replace(c,function(a,c){c=c.split(".");var d=b;try{for(var e in c)c.hasOwnProperty(e)&&(d=d[c[e]])}catch(E){d=a}return"string"===typeof d||"number"===
typeof d?d:a})},fakeNgModel:function(){return{$fake:!0,$setTouched:angular.noop,$setViewValue:function(a){this.$viewValue=a;this.$render(a);this.$viewChangeListeners.forEach(function(a){a()})},$isEmpty:function(a){return 0===(""+a).length},$parsers:[],$formatters:[],$viewChangeListeners:[],$render:angular.noop}},debounce:function(a,c,d,e){var f;return function(){var g=d,h=Array.prototype.slice.call(arguments);b.cancel(f);f=b(function(){f=void 0;a.apply(g,h)},c||10,e)}},throttle:function(a,b){var c;
return function(){var d=this,e=arguments,f=w.now();if(!c||f-c>b)a.apply(d,e),c=f}},time:function(a){var b=w.now();a();return w.now()-b},valueOnUse:function(a,b,c){var d=null,e=Array.prototype.slice.call(arguments),f=3<e.length?e.slice(3):[];Object.defineProperty(a,b,{get:function(){null===d&&(d=c.apply(a,f));return d}})},nextUid:function(){return""+nextUniqueId++},disconnectScope:function(a){if(a&&a.$root!==a&&!a.$$destroyed){var b=a.$parent;a.$$disconnected=!0;b.$$childHead===a&&(b.$$childHead=a.$$nextSibling);
...
g=d.length;f<g;f++)if(d[f].nodeName.toLowerCase()===b){d=d[f];break a}d=null}if(!d){if(c){if(a)for(d=0,f=a.length;d<f;d++)if(g=a[d],!l)for(var h=0,k=g.childNodes.length;h<k;h++)var l=l||e([g.childNodes[h]])}else l=null;d=l}return d}var f=e(a);!f&&d&&g.warn(w.supplant("Unable to find node '{0}' in element '{1}'.",[b,a[0].outerHTML]));return angular.element(f||a)},initOptionalProperties:function(a,b,c){c=c||{};angular.forEach(a.$$isolateBindings,function(d,e){d.optional&&angular.isUndefined(a[e])&&
(d=angular.isDefined(b[d.attrName]),a[e]=angular.isDefined(c[e])?c[e]:d)})},nextTick:function(a,c,e){function f(){var a=g.queue,b=g.digest;g.queue=[];g.timeout=null;g.digest=!1;a.forEach(function(a){var b=a.scope&&a.scope.$$destroyed;b||a.callback()});b&&d.$digest()}var g=w.nextTick,h=g.timeout,k=g.queue||[];k.push({scope:e,callback:a});null==c&&(c=!0);g.digest=g.digest||c;g.queue=k;return h||(g.timeout=b(f,0,!1))},processTemplate:function(a){return m?a:a&&angular.isString(a)?a.replace(/\{\{/g,l).replace(/}}/g,
r):a},getParentWithPointerEvents:function(a){for(a=a.parent();v(a,"pointer-events","none");)a=a.parent();return a},getNearestContentElement:function(a){for(a=a.parent()[0];a&&a!==h[0]&&a!==document.body&&"MD-CONTENT"!==a.nodeName.toUpperCase();)a=a.parentNode;return a},checkStickySupport:function(){var b=angular.element("<div>");a[0].body.appendChild(b[0]);for(var c=["sticky","-webkit-sticky"],d=0;d<c.length;++d)if(b.css({position:c[d],top:0,"z-index":2}),b.css("position")==c[d]){var e=c[d];break}b.remove();
return e},parseAttributeBoolean:function(a,b){return""===a||!!a&&(!1===b||"false"!==a&&"0"!==a)},hasComputedStyle:v,isParentFormSubmitted:function(a){return(a=(a=w.getClosest(a,"form"))?angular.element(a).controller("form"):null)?a.$submitted:!1},animateScrollTo:function(a,b,c){function d(){var k=c||1E3;var l=w.now()-h;l>k?k=e+f:(k=(l/=k)*l,l*=k,k=e+f*(-2*l+3*k));a.scrollTop=k;(g?k<b:k>b)&&n(d)}var e=a.scrollTop,f=b-e,g=e<b,h=w.now();n(d)},uniq:function(a){if(a)return a.filter(function(a,b,c){return c.indexOf(a)===
b})}};w.dom.animator=e(w);return w}angular.element.prototype.focus=angular.element.prototype.focus||function(){this.length&&this[0].focus();return this};angular.element.prototype.blur=angular.element.prototype.blur||function(){this.length&&this[0].blur();return this};MdAriaService.$inject=["$$rAF","$log","$window","$interpolate"];angular.module("material.core").provider("$mdAria",MdAriaProvider);
...
function MdAriaService(a,b,c,d){function e(a,d,e){var f=angular.element(a)[0]||a,g;if(g=f){if(!(g=f.hasAttribute(d)&&0!==f.getAttribute(d).length)){var h=f;g=d;var k=h.hasChildNodes(),r=!1;if(k)for(h=h.childNodes,k=0;k<h.length;k++){var m=h[k];1===m.nodeType&&m.hasAttribute(g)&&(m=m.currentStyle?m.currentStyle:c.getComputedStyle(m),(m="none"===m.display)||(r=!0))}g=r}g=!g}g&&(e=angular.isString(e)?e.trim():"",e.length?a.attr(d,e):l&&b.warn('ARIA: Attribute "',d,'", required for accessibility, is missing on node:',
f))}function f(b,c,d){a(function(){e(b,c,d())})}function g(a,b){var c=k(a)||"",g=-1<c.indexOf(d.startSymbol());g?f(a,b,function(){return k(a)}):e(a,b,c)}function h(a,b){var c=k(a),f=-1<c.indexOf(d.startSymbol());f||c||e(a,b,c)}function k(a){a=a[0]||a;for(var b=document.createTreeWalker(a,NodeFilter.SHOW_TEXT,null,!1),c="",d;d=b.nextNode();){var e;a:{for(e=d;e.parentNode&&(e=e.parentNode)!==a;)if(e.getAttribute&&"true"===e.getAttribute("aria-hidden")){e=!0;break a}e=void 0}e||(c+=d.textContent)}return c.trim()||
""}function n(a){a=angular.element(a)[0]||a;return a.hasAttribute?a.hasAttribute("aria-label")||a.hasAttribute("aria-labelledby")||a.hasAttribute("aria-describedby"):!1}function q(a,b){function c(a){if(!n(a))return!1;if(a.hasAttribute("role"))switch(a.getAttribute("role").toLowerCase()){case "command":case "definition":case "directory":case "grid":case "list":case "listitem":case "log":case "marquee":case "menu":case "menubar":case "note":case "presentation":case "separator":case "scrollbar":case "status":case "tablist":return!1}switch(a.tagName.toLowerCase()){case "abbr":case "acronym":case "address":case "applet":case "audio":case "b":case "bdi":case "bdo":case "big":case "blockquote":case "br":case "canvas":case "caption":case "center":case "cite":case "code":case "col":case "data":case "dd":case "del":case "dfn":case "dir":case "div":case "dl":case "em":case "embed":case "fieldset":case "figcaption":case "font":case "h1":case "h2":case "h3":case "h4":case "h5":case "h6":case "hgroup":case "html":case "i":case "ins":case "isindex":case "kbd":case "keygen":case "label":case "legend":case "li":case "map":case "mark":case "menu":case "object":case "ol":case "output":case "pre":case "presentation":case "q":case "rt":case "ruby":case "samp":case "small":case "source":case "span":case "status":case "strike":case "strong":case "sub":case "sup":case "svg":case "tbody":case "td":case "th":case "thead":case "time":case "tr":case "track":case "tt":case "ul":case "var":return!1}return!0}
b=b||1;a=angular.element(a)[0]||a;if(!a.parentNode)return!1;if(c(a.parentNode))return!0;b--;return b?q(a.parentNode,b):!1}var l=this.showWarnings;return{expect:e,expectAsync:f,expectWithText:g,expectWithoutText:h,getText:k,hasAriaLabel:n,parentHasAriaLabel:q}}angular.module("material.core").provider("$mdCompiler",MdCompilerProvider);MdCompilerProvider.$inject=["$compileProvider"];
function MdCompilerProvider(a){function b(a,b,c,g,h){this.$q=a;this.$templateRequest=b;this.$injector=c;this.$compile=g;this.$controller=h}var c=!1;this.respectPreAssignBindingsEnabled=function(a){return angular.isDefined(a)?(c=a,this):c};this.$get=["$q","$templateRequest","$injector","$compile","$controller",function(a,c,f,g,h){return new b(a,c,f,g,h)}];b.prototype.compile=function(a){return a.contentElement?this._prepareContentElement(a):this._compileTemplate(a)};b.prototype._prepareContentElement=
function(a){var b=this._fetchContentElement(a);return this.$q.resolve({element:b.element,cleanup:b.restore,locals:{},link:function(){return b.element}})};b.prototype._compileTemplate=function(a){var b=this,c=a.templateUrl,d=a.template||"",h=angular.extend({},a.resolve),k=angular.extend({},a.locals),n=a.transformTemplate||angular.identity;angular.forEach(h,function(a,c){angular.isString(a)?h[c]=b.$injector.get(a):h[c]=b.$injector.invoke(a)});angular.extend(h,k);h.$$ngTemplate=c?this.$templateRequest(c):
this.$q.when(d);return this.$q.all(h).then(function(c){var d=n(c.$$ngTemplate,a);d=a.element||angular.element("<div>").html(d.trim()).contents();return b._compileElement(c,d,a)})};b.prototype._compileElement=function(a,b,c){function d(d){a.$scope=d;if(c.controller){var g=angular.extend({},a,{$element:b});g=e._createController(c,g,a);b.data("$ngControllerController",g);b.children().data("$ngControllerController",g);n.controller=g}return f(d)}var e=this,f=this.$compile(b),n={element:b,cleanup:b.remove.bind(b),
locals:a,link:d};return n};b.prototype._createController=function(b,e,f){var d;(d=c?"function"===typeof a.preAssignBindingsEnabled?a.preAssignBindingsEnabled():1===angular.version.major&&6>angular.version.minor?!0:!1:!0)?(d=this.$controller(b.controller,e,!0),b.bindToController&&angular.extend(d.instance,f),d=d()):(d=this.$controller(b.controller,e),b.bindToController&&angular.extend(d,f));b.controllerAs&&(e.$scope[b.controllerAs]=d);angular.isFunction(d.$onInit)&&d.$onInit();return d};b.prototype._fetchContentElement=
...
MdGestureProvider.prototype={disableAll:function(){disableAllGestures=!0},skipClickHijack:function(){return forceSkipClickHijack=!0},setMaxClickDistance:function(a){maxClickDistance=parseInt(a)},$get:["$$MdGestureHandler","$$rAF","$timeout",function(a,b,c){return new MdGesture(a,b,c)}]};
...
c=0;c<b.length;c++){var d=b[c];d=d?d+"TouchAction":"touchAction";if(angular.isDefined(a.style[d]))return d}}var h=navigator.userAgent||navigator.vendor||window.opera,k=h.match(/ipad|iphone|ipod/i);h=h.match(/android/i);var n=g(),q="undefined"!==typeof window.jQuery&&angular.element===window.jQuery,l={handler:f,register:e,isAndroid:h,isIos:k,isHijackingClicks:(k||h)&&!q&&!forceSkipClickHijack};l.isHijackingClicks&&(l.handler("click",{options:{maxDistance:maxClickDistance},onEnd:d("click")}),l.handler("focus",
...
delay:500},onCancel:function(){c.cancel(this.state.timeout)},onStart:function(a,b){if(!this.state.registeredParent)return this.cancel();this.state.pos={x:b.x,y:b.y};this.state.timeout=c(angular.bind(this,function(){this.dispatchEvent(a,"$md.hold");this.cancel()}),this.state.options.delay,!1)},onMove:function(a,b){n||"touchmove"!==a.type||a.preventDefault();a=this.state.pos.x-b.x;b=this.state.pos.y-b.y;Math.sqrt(a*a+b*b)>this.options.maxDistance&&this.cancel()},onEnd:function(){this.onCancel()}}).handler("drag",
{options:{minDistance:6,horizontal:!0,cancelMultiplier:1.5},onSetup:function(a,b){n&&(this.oldTouchAction=a[0].style[n],a[0].style[n]=b.horizontal?"pan-y":"pan-x")},onCleanup:function(a){this.oldTouchAction&&(a[0].style[n]=this.oldTouchAction)},onStart:function(){this.state.registeredParent||this.cancel()},onMove:function(a,b){n||"touchmove"!==a.type||a.preventDefault();if(this.state.dragPointer)this.dispatchDragMove(a);else{if(this.state.options.horizontal){var c=Math.abs(b.distanceX)>this.state.options.minDistance;
...
a))}function h(a){pointer&&typesMatch(a,pointer)&&(updatePointerState(a,pointer),pointer.endTime=+Date.now(),"pointercancel"!==a.type&&e("end",a),lastPointer=pointer,pointer=null)}disableAllGestures||(document.contains||(document.contains=function(a){return document.body.contains(a)}),!isInitialized&&a.isHijackingClicks&&(document.addEventListener("click",d,!0),document.addEventListener("mouseup",c,!0),document.addEventListener("mousedown",c,!0),document.addEventListener("focus",c,!0),isInitialized=
!0),angular.element(document).on("mousedown touchstart pointerdown",f).on("mousemove touchmove pointermove",g).on("mouseup mouseleave touchend touchcancel pointerup pointercancel",h).on("$$mdGestureReset",function(){lastPointer=pointer=null}))}function makeStartPointer(a){var b=getEventPoint(a);a={startTime:+Date.now(),target:a.target,type:a.type.charAt(0)};a.startX=a.x=b.pageX;a.startY=a.y=b.pageY;return a}function typesMatch(a,b){return a&&b&&a.type.charAt(0)===b.type}
...
function InterimElementProvider(){function a(a){function b(a){n.optionsFactory=a.options;n.methods=(a.methods||[]).concat(h);return q}function c(a,b){k[a]=b;return q}function f(b,c){c=c||{};c.methods=c.methods||[];c.options=c.options||function(){return{}};if(/^cancel|hide|show$/.test(b))throw Error("Preset '"+b+"' in "+a+" is reserved!");if(-1<c.methods.indexOf("_options"))throw Error("Method '_options' in "+a+" is reserved!");n.presets[b]={methods:c.methods.concat(h),optionsFactory:c.options,argOption:c.argOption};
return q}function g(b,c){function d(a){a=a||{};a._options&&(a=a._options);return g.show(angular.extend({},q,a))}function e(a){return g.destroy(a)}function f(b,d){var e={};e[a]=h;return c.invoke(b||function(){return d},{},e)}var g=b(),h={hide:g.hide,cancel:g.cancel,show:d,destroy:e};var l=n.methods||[];var q=f(n.optionsFactory,{});angular.forEach(k,function(a,b){h[b]=a});angular.forEach(n.presets,function(a,b){function c(a){this._options=angular.extend({},d,a)}var d=f(a.optionsFactory,{}),e=(a.methods||
[]).concat(l);angular.extend(d,{$type:b});angular.forEach(e,function(a){c.prototype[a]=function(b){this._options[a]=b;return this}});a.argOption&&(e="show"+b.charAt(0).toUpperCase()+b.slice(1),h[e]=function(a){a=h[b](a);return h.show(a)});h[b]=function(b){return arguments.length&&a.argOption&&!angular.isObject(b)&&!angular.isArray(b)?(new c)[a.argOption](b):new c(b)}});return h}g.$inject=["$$interimElement","$injector"];var h=["onHide","onShow","onRemove"],k={},n={presets:{}},q={setDefaults:b,addPreset:f,
addMethod:c,$get:g};q.addPreset("build",{methods:"controller controllerAs resolve multiple template templateUrl themable transformTemplate parent contentElement".split(" ")});return q}function b(a,b,e,f,g,h,k,n,q,l,r){return function(){function c(a){a=a||{};var c=new y(a||{}),d=a.multiple?b.resolve():b.all(A);a.multiple||(d=d.then(function(){var a=D.concat(B.map(z.cancel));return b.all(a)}));var e=d.then(function(){return c.show()["catch"](function(a){return a})["finally"](function(){A.splice(A.indexOf(e),
1);B.push(c)})});A.push(e);c.deferred.promise["catch"](function(a){a instanceof Error&&r(a);return a});return c.deferred.promise}function d(a,c){function d(b){var d=b.remove(a,!1,c||{})["catch"](function(a){return a})["finally"](function(){D.splice(D.indexOf(d),1)});B.splice(B.indexOf(b),1);D.push(d);return b.deferred.promise}c=c||{};return c.closeAll?b.all(B.slice().reverse().map(d)):void 0!==c.closeTo?b.all(B.slice(c.closeTo).map(d)):d(B[B.length-1])}function w(a,c){var d=B.pop();if(!d)return b.when(a);
var e=d.remove(a,!0,c||{})["catch"](function(a){return a})["finally"](function(){D.splice(D.indexOf(e),1)});D.push(e);return d.deferred.promise["catch"](angular.noop)}function t(a){return function(){var c=arguments;return B.length?a.apply(z,c):A.length?A[0]["finally"](function(){return a.apply(z,c)}):b.when("No interim elements currently showing up.")}}function p(a){var c=a?null:B.shift(),d=angular.element(a).length&&angular.element(a)[0].parentNode;d&&(a=B.filter(function(a){return a.options.element[0]===
d}),a.length&&(c=a[0],B.splice(B.indexOf(c),1)));return c?c.remove(!1,!1,{$destroy:!0}):b.when(!1)}function y(c){function d(){return b(function(b,d){function e(a){v.deferred.reject(a);d(a)}c.onCompiling&&c.onCompiling(c);m(c).then(function(d){var f=d,h=c;angular.extend(f.locals,h);f=f.link(h.scope);h.element=f;var k=h;var l=f,n=h,t=n.parent;t=angular.isFunction(t)?t(n.scope,l,n):angular.isString(t)?angular.element(a[0].querySelector(t)):angular.element(t);if((t||{}).length)var m=t;else g[0]&&g[0].querySelector&&
(m=g[0].querySelector(":not(svg) > body")),m||(m=g[0]),"#comment"==m.nodeName&&(m=a[0].body),m=angular.element(m);k.parent=m;h.themable&&q(f);A=f;c.cleanupElement=d.cleanup;y=p(A,c,d.controller).then(b,e)})["catch"](e)})}function l(a,d,e){function f(a){v.deferred.reject(a)}if(!A)return b.when(!1);c=angular.extend(c||{},e||{});c.cancelAutoHide&&c.cancelAutoHide();c.element.triggerHandler("$mdInterimElementRemove");if(!0===c.$destroy)return E(c.element,c).then(function(){d&&f(a)||v.deferred.resolve(a)});
b.when(y)["finally"](function(){E(c.element,c).then(function(){d?f(a):v.deferred.resolve(a)},f)});return v.deferred.promise}function t(a){a=a||{};a.template&&(a.template=k.processTemplate(a.template));return angular.extend({preserveScope:!1,cancelAutoHide:angular.noop,scope:a.scope||e.$new(a.isolateScope),onShow:function(a,b,c){return h.enter(b,c.parent)},onRemove:function(a,c){return c&&h.leave(c)||b.when()}},a)}function m(a){var c=a.skipCompile?null:n.compile(a);return c||b(function(b){b({locals:{},
link:function(){return a.element}})})}function r(){var a=angular.noop;if(c.hideDelay){var b=f(z.hide,c.hideDelay);a=function(){f.cancel(b)}}c.cancelAutoHide=function(){a();c.cancelAutoHide=void 0}}function p(a,c,d){var e=c.onShowing||angular.noop,f=c.onComplete||angular.noop;try{e(c.scope,a,c,d)}catch(ca){return b.reject(ca)}return b(function(e,g){try{b.when(c.onShow(c.scope,a,c,d)).then(function(){f(c.scope,a,c);r();e(a)},g)}catch(ia){g(ia.message)}})}function E(a,c){var d=c.onRemoving||angular.noop;
return b(function(e,f){try{var g=b.when(c.onRemove(c.scope,a,c)||!0);d(a,g);c.$destroy?(e(a),!c.preserveScope&&c.scope&&g.then(function(){c.scope.$destroy()})):g.then(function(){!c.preserveScope&&c.scope&&c.scope.$destroy();e(a)},f)}catch(ma){f(ma.message)}})}var v,A,y=b.when(!0);c=t(c);return v={options:c,deferred:b.defer(),show:d,remove:l}}var z,A=[],D=[],B=[];return z={show:c,hide:t(d),cancel:t(w),destroy:p,$injector_:l}}}b.$inject="$document $q $rootScope $timeout $rootElement $animate $mdUtil $mdCompiler $mdTheming $injector $exceptionHandler".split(" ");
a.$get=b;return a}
(function(){function a(a){function g(a){return a.replace(l,"").replace(t,function(a,b,c,d){return d?c.toUpperCase():c})}var l=/^((?:x|data)[:\-_])/i,t=/([:\-_]+(.))/g,m=" xs gt-xs sm gt-sm md gt-md lg gt-lg xl print".split(" "),q=["layout","flex","flex-order","flex-offset","layout-align"],r=["show","hide","layout-padding","layout-margin"];angular.forEach(m,function(b){angular.forEach(q,function(c){c=b?c+"-"+b:c;a.directive(g(c),e(c))});angular.forEach(r,function(c){c=b?c+"-"+b:c;a.directive(g(c),
f(c))})});a.provider("$$mdLayout",function(){return{$get:angular.noop,validateAttributeValue:n,validateAttributeUsage:k,disableLayouts:function(a){B.enabled=!0!==a}}}).directive("mdLayoutCss",c).directive("ngCloak",d("ng-cloak")).directive("layoutWrap",f("layout-wrap")).directive("layoutNowrap",f("layout-nowrap")).directive("layoutNoWrap",f("layout-no-wrap")).directive("layoutFill",f("layout-fill")).directive("layoutLtMd",h("layout-lt-md",!0)).directive("layoutLtLg",h("layout-lt-lg",!0)).directive("flexLtMd",
...
function b(){var a=!!document.querySelector("[md-layouts-disabled]");B.enabled=!a}function c(){B.enabled=!1;return{restrict:"A",priority:"900"}}function d(a){return["$timeout",function(b){return{restrict:"A",priority:-10,compile:function(c){if(!B.enabled)return angular.noop;c.addClass(a);return function(c,d){b(function(){d.removeClass(a)},10,!1)}}}}]}function e(a){function b(b,c,d){c=g(c,a,d);var e=d.$observe(d.$normalize(a),c);c(l(a,d,""));b.$on("$destroy",function(){e()})}return["$mdUtil","$interpolate",
"$log",function(c,d,e){m=c;v=d;w=e;return{restrict:"A",compile:function(c,d){if(B.enabled){k(a,d,c,w);n(a,l(a,d,""),q(c,a,d));var e=b}return e||angular.noop}}}]}function f(a){function b(b,c){c.addClass(a)}return["$mdUtil","$interpolate","$log",function(c,d,e){m=c;v=d;w=e;return{restrict:"A",compile:function(c,d){if(B.enabled){n(a,l(a,d,""),q(c,a,d));c.addClass(a);var e=b}return e||angular.noop}}}]}function g(a,b){var c;return function(d){d=n(b,d||"");angular.isDefined(d)&&(c&&a.removeClass(c),c=d?
b+"-"+d.trim().replace(p,"-"):b,a.addClass(c))}}function h(a){var b=a.split("-");return["$log",function(c){c.warn(a+"has been deprecated. Please use a `"+b[0]+"-gt-<xxx>` variant.");return angular.noop}]}function k(a,b,c,d){b=c[0].nodeName.toLowerCase();switch(a.replace(t,"")){case "flex":if("md-button"==b||"fieldset"==b)b="<"+b+" "+a+"></"+b+">",c="https://github.com/philipwalton/flexbugs#9-some-html-elements-cant-be-flex-containers",a="Markup '{0}' may not work as expected in IE Browsers. Consult '{1}' for details.",
d.warn(m.supplant(a,[b,c]))}}function n(a,b,c){var d;if(!(-1<(b||"").indexOf(v.startSymbol()))){switch(a.replace(t,"")){case "layout":r(b,z)||(b=z[0]);break;case "flex":r(b,y)||isNaN(b)&&(b="");break;case "flex-offset":case "flex-order":if(!b||isNaN(+b))b="0";break;case "layout-align":a={main:"start",cross:"stretch"};b=b||"";if(0===b.indexOf("-")||0===b.indexOf(" "))b="none"+b;b=b.toLowerCase().trim().replace(p,"-").split("-");b.length&&"space"===b[0]&&(b=[b[0]+"-"+b[1],b[2]]);0<b.length&&(a.main=
b[0]||a.main);1<b.length&&(a.cross=b[1]||a.cross);0>A.indexOf(a.main)&&(a.main="start");0>D.indexOf(a.cross)&&(a.cross="stretch");b=m.supplant("{main}-{cross}",a);break;case "layout-padding":case "layout-margin":case "layout-fill":case "layout-wrap":case "layout-nowrap":b=""}b!=d&&(c||angular.noop)(b)}return b?b.trim():""}function q(a,b,c){return function(a){-1<(a||"").indexOf(v.startSymbol())||(c[c.$normalize(b)]=a)}}function l(a,b,c){a=b.$normalize(a);return b[a]?b[a].trim().replace(p,"-"):c||null}
function r(a,b,c){a=c&&a?a.replace(p,c):a;var d=!1;a&&b.forEach(function(b){b=c?b.replace(p,c):b;d=d||b===a});return d}var m,v,w,t=/(-gt)?-(sm|md|lg|print)/g,p=/\s+/g,y="grow initial auto none noshrink nogrow".split(" "),z=["row","column"],A=" start center end stretch space-around space-between".split(" "),D=["","start","center","end","stretch"],B={enabled:!0,breakpoints:[]};a(angular.module("material.core.layout",["ng"]))})();MdLiveAnnouncer.$inject=["$timeout"];
...
(function(a){function b(a){var b=!!document.querySelector("[md-themes-disabled]");a.disableTheming(b)}function c(b,c){function d(a,b){b=b||{};m[a]=f(a,b);return r}function e(b,c){return f(b,a.extend({},m[b]||{},c))}function f(a,b){var c=B.filter(function(a){return!b[a]});if(c.length)throw Error("Missing colors %1 in palette %2!".replace("%1",c.join(", ")).replace("%2",a));return b}function h(b,c){if(q[b])return q[b];c=c||"default";c="string"===typeof c?q[c]:c;var d=new t(b);c&&a.forEach(c.colors,
function(b,c){d.colors[c]={name:b.name,hues:a.extend({},b.hues)}});return q[b]=d}function t(b){function c(b){b=0===arguments.length?!0:!!b;if(b!==d.isDark){d.isDark=b;d.foregroundPalette=d.isDark?w:v;d.foregroundShadow=d.isDark?"1px 1px 0px rgba(0,0,0,0.4), -1px -1px 0px rgba(0,0,0,0.4)":"";var c=d.isDark?D:A,e=d.isDark?A:D;a.forEach(c,function(a,b){var c=d.colors[b];b=e[b];if(c)for(var f in c.hues)c.hues[f]===b[f]&&(c.hues[f]=a[f])});return d}}var d=this;d.name=b;d.colors={};d.dark=c;c(!1);z.forEach(function(b){var c=
(d.isDark?D:A)[b];d[b+"Palette"]=function(e,f){var g=d.colors[b]={name:e,hues:a.extend({},c,f)};Object.keys(g.hues).forEach(function(a){if(!c[a])throw Error("Invalid hue name '%1' in theme %2's %3 color %4. Available hue names: %4".replace("%1",a).replace("%2",d.name).replace("%3",e).replace("%4",Object.keys(c).join(", ")));});Object.keys(g.hues).map(function(a){return g.hues[a]}).forEach(function(a){if(-1==B.indexOf(a))throw Error("Invalid hue value '%1' in theme %2's %3 color %4. Available hue values: %5".replace("%1",
a).replace("%2",d.name).replace("%3",b).replace("%4",e).replace("%5",B.join(", ")));});return d};d[b+"Color"]=function(){var a=Array.prototype.slice.call(arguments);console.warn("$mdThemingProviderTheme."+b+"Color() has been deprecated. Use $mdThemingProviderTheme."+b+"Palette() instead.");return d[b+"Palette"].apply(d,a)}})}function n(b,c,d,e){function f(a){return void 0===a||""===a?!0:void 0!==l.THEMES[a]}function g(a,b){function d(b){if(b){f(b)||e.warn("Attempted to use unregistered theme '"+b+
"'. Register it with $mdThemingProvider.theme().");var c=a.data("$mdThemeName");c&&a.removeClass("md-"+c+"-theme");a.addClass("md-"+b+"-theme");a.data("$mdThemeName",b);g&&a.data("$mdThemeController",g)}}var g=b.controller("mdTheme")||a.data("$mdThemeController");b=a.scope();d(g&&g.$mdTheme||("default"===y?"":y));if(g){var h=p||g.$shouldWatch||c.parseAttributeBoolean(a.attr("md-theme-watch"));if(h||g.isAsyncTheme){var k=function(){l&&(l(),l=void 0)},l=g.registerChanges(function(a){d(a);h||k()});if(b)b.$on("$destroy",
k);else a.on("$destroy",k)}}}var l=function(a,b){void 0===b&&(b=a);l.inherit(b,b)};Object.defineProperty(l,"THEMES",{get:function(){return a.extend({},q)}});Object.defineProperty(l,"PALETTES",{get:function(){return a.extend({},m)}});Object.defineProperty(l,"ALWAYS_WATCH",{get:function(){return p}});l.inherit=g;l.registered=f;l.defaultTheme=function(){return y};l.generateTheme=function(a){k(q[a],a,E.nonce)};l.defineTheme=function(a,b){b=b||{};var c=h(a);b.primary&&c.primaryPalette(b.primary);b.accent&&
c.accentPalette(b.accent);b.warn&&c.warnPalette(b.warn);b.background&&c.backgroundPalette(b.background);b.dark&&c.dark();this.generateTheme(a);return d.resolve(a)};l.setBrowserColor=G;return l}n.$inject=["$rootScope","$mdUtil","$q","$log"];m={};var q={},r,p=!1,y="default";a.extend(m,b);var H=function(a){var b=c.setMeta("theme-color",a),d=c.setMeta("msapplication-navbutton-color",a);return function(){b();d()}},G=function(b){b=a.isObject(b)?b:{};var c=b.theme||"default",d=b.hue||"800";b=m[b.palette]||
m[q[c].colors[b.palette||"primary"].name];d=a.isObject(b[d])?b[d].hex:b[d];return H(d)};return r={definePalette:d,extendPalette:e,theme:h,configuration:function(){return a.extend({},E,{defaultTheme:y,alwaysWatchTheme:p,registeredStyles:[].concat(E.registeredStyles)})},disableTheming:function(b){E.disableTheming=a.isUndefined(b)||!!b},registerStyles:function(a){E.registeredStyles.push(a)},setNonce:function(a){E.nonce=a},generateThemesOnDemand:function(a){E.generateOnDemand=a},setDefaultTheme:function(a){y=
a},alwaysWatchTheme:function(a){p=a},enableBrowserColor:G,$get:n,_LIGHT_DEFAULT_HUES:A,_DARK_DEFAULT_HUES:D,_PALETTES:m,_THEMES:q,_parseRules:g,_rgba:l}}function d(b,c,d,e,f,g){return{priority:101,link:{pre:function(h,k,l){var t=[],n=c.startSymbol(),m=c.endSymbol(),q=l.mdTheme.trim();q=q.substr(0,n.length)===n&&q.lastIndexOf(m)===q.length-m.length;n="::"===l.mdTheme.split(n).join("").split(m).join("").trim().substr(0,2);m=function(){var a=c(l.mdTheme)(h);return d(a)(h)||a};var r={isAsyncTheme:a.isFunction(m())||
a.isFunction(m().then),registerChanges:function(b,c){c&&(b=a.bind(c,b));t.push(b);return function(){var a=t.indexOf(b);-1<a&&t.splice(a,1)}},$setTheme:function(a){b.registered(a)||g.warn("attempted to use unregistered theme '"+a+"'");r.$mdTheme=a;for(var c=t.length;c--;)t[c](a)},$shouldWatch:e.parseAttributeBoolean(k.attr("md-theme-watch"))||b.ALWAYS_WATCH||q&&!n};k.data("$mdThemeController",r);var p=function(b){if("string"===typeof b)return r.$setTheme(b);f.when(a.isFunction(b)?b():b).then(function(a){r.$setTheme(a)})};
p(m());var v=h.$watch(m,function(a){a&&(p(a),r.$shouldWatch||v())})}}}}function e(){E.disableTheming=!0;return{restrict:"A",priority:"900"}}function f(a){return a}function g(b,c,d){n(b,c);d=d.replace(/THEME_NAME/g,b.name);var e=new RegExp("\\.md-"+b.name+"-theme","g");c=/'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue-[0-3]|shadow|default)-?(\d\.?\d*)?(contrast)?\s*\}\}'?"?/g;d=d.replace(c,function(a,c,d,e,f){if("foreground"===c)return"shadow"==d?b.foregroundShadow:b.foregroundPalette[d]||b.foregroundPalette["1"];
if(0===d.indexOf("hue")||"default"===d)d=b.colors[c].hues[d];return l((m[b.colors[c].name][d]||"")[f?"contrast":"value"],e)});var f=/('|")?{{\s*([a-zA-Z]+)-(color|contrast)-?(\d\.?\d*)?\s*}}("|')?/g,g=[];a.forEach(["default","hue-1","hue-2","hue-3"],function(a){var c=d.replace(f,function(c,d,e,f,g){e=b.colors[e];c=m[e.name];e=e.hues[a];return l(c[e]["color"===f?"value":"contrast"],g)});"default"!==a&&(c=c.replace(e,".md-"+b.name+"-theme.md-"+a));if("default"==b.name){var h=/((?:\s|>|\.|\w|-|:|\(|\)|\[|\]|"|'|=)*)\.md-default-theme((?:\s|>|\.|\w|-|:|\(|\)|\[|\]|"|'|=)*)/g;
c=c.replace(h,function(a,b,c){return a+", "+b+c})}g.push(c)});return g}function h(b,c){function d(b){var c=b.contrastDefaultColor,d=b.contrastLightColors||[],e=b.contrastStrongLightColors||[],f=b.contrastDarkColors||[];"string"===typeof d&&(d=d.split(" "));"string"===typeof e&&(e=e.split(" "));"string"===typeof f&&(f=f.split(" "));delete b.contrastDefaultColor;delete b.contrastLightColors;delete b.contrastStrongLightColors;delete b.contrastDarkColors;a.forEach(b,function(g,h){if(!a.isObject(g)){var k=
q(g);if(!k)throw Error("Color %1, in palette %2's hue %3, is invalid. Hex or rgb(a) color expected.".replace("%1",g).replace("%2",b.name).replace("%3",h));b[h]={hex:b[h],value:k,contrast:"light"===c?-1<f.indexOf(h)?t:-1<e.indexOf(h)?y:p:-1<d.indexOf(h)?-1<e.indexOf(h)?y:p:t}}})}var e=document.head;e=e?e.firstElementChild:null;b=!E.disableTheming&&b.has("$MD_THEME_CSS")?b.get("$MD_THEME_CSS"):"";b+=E.registeredStyles.join("");e&&0!==b.length&&(a.forEach(m,d),b=b.split(/\}(?!(\}|'|"|;))/).filter(function(a){return a&&
a.trim().length}).map(function(a){return a.trim()+"}"}),z.forEach(function(a){G[a]=""}),b.forEach(function(a){for(var b=0,c;c=z[b];b++)if(-1<a.indexOf(".md-"+c))return G[c]+=a;for(b=0;c=z[b];b++)if(-1<a.indexOf(c))return G[c]+=a;return G.primary+=a}),E.generateOnDemand||a.forEach(c.THEMES,function(a){r[a.name]||"default"!==c.defaultTheme()&&"default"===a.name||k(a,a.name,E.nonce)}))}function k(a,b,c){var d=document.head,e=d?d.firstElementChild:null;r[b]||(z.forEach(function(b){for(b=g(a,b,G[b]);b.length;){var f=
b.shift();if(f){var h=document.createElement("style");h.setAttribute("md-theme-style","");c&&h.setAttribute("nonce",c);h.appendChild(document.createTextNode(f));d.insertBefore(h,e)}}}),r[a.name]=!0)}function n(a,b){if(!m[(a.colors[b]||{}).name])throw Error("You supplied an invalid color palette for theme %1's %2 palette. Available palettes: %3".replace("%1",a.name).replace("%2",b).replace("%3",Object.keys(m).join(", ")));}function q(b){if(a.isArray(b)&&3==b.length)return b;if(/^rgb/.test(b))return b.replace(/(^\s*rgba?\(|\)\s*$)/g,
"").split(",").map(function(a,b){return 3==b?parseFloat(a,10):parseInt(a,10)});"#"==b.charAt(0)&&(b=b.substring(1));if(/^([a-fA-F0-9]{3}){1,2}$/g.test(b)){var c=b.length/3,d=b.substr(0,c),e=b.substr(c,c);b=b.substr(2*c);1===c&&(d+=d,e+=e,b+=b);return[parseInt(d,16),parseInt(e,16),parseInt(b,16)]}}function l(b,c){if(!b)return"rgb('0,0,0')";4==b.length&&(b=a.copy(b),c?b.pop():c=b.pop());return c&&("number"==typeof c||"string"==typeof c&&c.length)?"rgba("+b.join(",")+","+c+")":"rgb("+b.join(",")+")"}
b.$inject=["$mdThemingProvider"];d.$inject="$mdTheming $interpolate $parse $mdUtil $q $log".split(" ");f.$inject=["$mdTheming"];c.$inject=["$mdColorPalette","$$mdMetaProvider"];h.$inject=["$injector","$mdTheming"];a.module("material.core.theming",["material.core.theming.palette","material.core.meta"]).directive("mdTheme",d).directive("mdThemable",f).directive("mdThemesDisabled",e).provider("$mdTheming",c).config(b).run(h);var r={},m,v={name:"dark",1:"rgba(0,0,0,0.87)",2:"rgba(0,0,0,0.54)",3:"rgba(0,0,0,0.38)",
4:"rgba(0,0,0,0.12)"},w={name:"light",1:"rgba(255,255,255,1.0)",2:"rgba(255,255,255,0.7)",3:"rgba(255,255,255,0.5)",4:"rgba(255,255,255,0.12)"},t=q("rgba(0,0,0,0.87)"),p=q("rgba(255,255,255,0.87)"),y=q("rgb(255,255,255)"),z=["primary","accent","warn","background"],A={accent:{"default":"A200","hue-1":"A100","hue-2":"A400","hue-3":"A700"},background:{"default":"50","hue-1":"A100","hue-2":"100","hue-3":"300"}},D={background:{"default":"A400","hue-1":"800","hue-2":"900","hue-3":"A200"}};z.forEach(function(a){var b=
{"default":"500","hue-1":"300","hue-2":"800","hue-3":"A100"};A[a]||(A[a]=b);D[a]||(D[a]=b)});var B="50 100 200 300 400 500 600 700 800 900 A100 A200 A400 A700".split(" "),E={disableTheming:!1,generateOnDemand:!1,registeredStyles:[],nonce:null},G={}})(window.angular);angular.module("material.core").factory("$$mdAnimate",["$q","$timeout","$mdConstant","$animateCss",function(a,b,c,d){return function(e){return AnimateDomUtils(e,a,b,c,d)}}]);
function AnimateDomUtils(a,b,c,d,e){var f;return f={translate3d:function(a,b,c,d){function f(c){return e(a,{to:c||b,addClass:d.transitionOutClass,removeClass:d.transitionInClass,duration:d.duration}).start()}return e(a,{from:b,to:c,addClass:d.transitionInClass,removeClass:d.transitionOutClass,duration:d.duration}).start().then(function(){return f})},waitTransitionEnd:function(a,e){var f=3E3;return b(function(b){function g(e){e&&e.target!==a[0]||(e&&c.cancel(k),a.off(d.CSS.TRANSITIONEND,g),b())}function h(b){b=
b||window.getComputedStyle(a[0]);return"0s"==b.transitionDuration||!b.transition&&!b.transitionProperty}e=e||{};h(e.cachedTransitionStyles)&&(f=0);var k=c(g,e.timeout||f);a.on(d.CSS.TRANSITIONEND,g)})},calculateTransformValues:function(a,b){var c=b.element;b=b.bounds;if(c||b){c?(c=f.clientRect(c))||(c=(c=(c=a?a.parent():null)?c.parent():null)?f.clientRect(c):null):c=f.copyRect(b);a=f.copyRect(a[0].getBoundingClientRect());b=f.centerPointFor(a);var d=f.centerPointFor(c);return{centerX:d.x-b.x,centerY:d.y-
...
function mdIconDirective(a,b,c){function d(d,f,g){function e(){if(!g.mdSvgIcon&&!g.mdSvgSrc){g.mdFontIcon&&(f.removeClass(k),f.addClass(g.mdFontIcon),k=g.mdFontIcon);var b=a.fontSet(g.mdFontSet);n!==b&&(f.removeClass(n),f.addClass(b),n=b)}}b(f);var k=g.mdFontIcon,n=a.fontSet(g.mdFontSet);g.mdSvgIcon||g.mdSvgSrc||(g.mdFontIcon&&f.addClass("md-font "+g.mdFontIcon),f.addClass(n));g.$observe("mdFontIcon",e);g.$observe("mdFontSet",e);f[0].getAttribute(g.$attr.mdSvgSrc);d=g.$normalize(g.$attr.mdSvgIcon||
g.$attr.mdSvgSrc||"");g.role||(c.expect(f,"role","img"),g.role="img");if("img"===g.role&&!g.ariaHidden&&!c.hasAriaLabel(f)){var q;g.alt?c.expect(f,"aria-label",g.alt):c.parentHasAriaLabel(f,2)?c.expect(f,"aria-hidden","true"):(q=g.mdFontIcon||g.mdSvgIcon||f.text())?c.expect(f,"aria-label",q):c.expect(f,"aria-hidden","true")}d&&g.$observe(d,function(b){f.empty();b&&a(b).then(function(a){f.empty();f.append(a)})})}return{restrict:"E",link:d}}MdIconService.$inject="config $templateRequest $q $log $mdUtil $sce".split(" ");
...
function MdIconService(a,b,c,d,e,f){function g(b){b=b||"";angular.isString(b)||(b=f.getTrustedUrl(b));if(t[b])return c.when(k(t[b]));if(y.test(b)||z.test(b))return r(b).then(n(b));-1==b.indexOf(":")&&(b="$default:"+b);var d=a[b]?q:l;return d(b).then(n(b))}function h(b){var c=angular.isUndefined(b)||!(b&&b.length);if(c)return a.defaultFontSet;var d=b;angular.forEach(a.fontSets,function(a){a.alias==b&&(d=a.fontSet||d)});return d}function k(a){a=a.clone();var b="_cache"+e.nextUid();a.id&&(a.id+=b);angular.forEach(a.querySelectorAll("[id]"),
function(a){a.id+=b});return a}function n(b){return function(c){var d=c;d=angular.isDefined(d.element)&&angular.isDefined(d.config);t[b]=d?c:new m(c,a[b]);return t[b].clone()}}function q(b){var c=a[b];return r(c.url).then(function(a){return new m(a,c)})}function l(b){function e(a){var c=b.slice(b.lastIndexOf(":")+1);return(a=a.querySelector("#"+c))?new m(a,h):f(b)}function f(a){var b="icon "+a+" not found";d.warn(b);return c.reject(b||a)}var g=b.substring(0,b.lastIndexOf(":"))||"$default",h=a[g];
return h?r(h.url).then(e):f(b)}function r(a){function e(a){var b=z.exec(a);b=(a=/base64/i.test(a))?window.atob(b[2]):b[2];return c.when(angular.element(b)[0])}function f(a){return c(function(c,e){var f=function(a){var b=angular.isString(a)?a:a.message||a.data||a.statusText;d.warn(b);e(a)},g=function(b){p[a]||(p[a]=angular.element("<div>").append(b)[0].querySelector("svg"));c(p[a])};b(a,!0).then(g,f)})}return z.test(a)?e(a):f(a)}function m(a,b){if(a&&"symbol"===a.tagName.toLowerCase()){var c=a.getAttribute("viewBox");
a=angular.element('<svg xmlns="http://www.w3.org/2000/svg">').html(a.innerHTML)[0];c&&a.setAttribute("viewBox",c)}a&&"svg"!==a.tagName.toLowerCase()&&(a=angular.element('<svg xmlns="http://www.w3.org/2000/svg">').append(a.cloneNode(!0))[0]);a.getAttribute("xmlns")||a.setAttribute("xmlns","http://www.w3.org/2000/svg");this.element=a;this.config=b;this.prepare()}function v(){var b=this.config?this.config.viewBoxSize:a.defaultViewBoxSize;angular.forEach({fit:"",height:"100%",width:"100%",preserveAspectRatio:"xMidYMid meet",
viewBox:this.element.getAttribute("viewBox")||"0 0 "+b+" "+b,focusable:!1},function(a,b){this.element.setAttribute(b,a)},this)}function w(){return this.element.cloneNode(!0)}var t={},p={},y=/[-\w@:%+.~#?&//=]{2,}\.[a-z]{2,4}\b(\/[-\w@:%+.~#?&//=]*)?/i,z=/^data:image\/svg\+xml[\s*;\w\-=]*?(base64)?,(.*)$/i;m.prototype={clone:w,prepare:v};g.fontSet=h;return g}ngmaterial.components.icon=angular.module("material.components.icon");angular.module("material.components.showHide",["material.core"]).directive("ngShow",createDirective("ngShow",!0)).directive("ngHide",createDirective("ngHide",!1));
function createDirective(a,b){return["$mdUtil","$window",function(c,d){return{restrict:"A",multiElement:!0,link:function(e,f,g){var h=e.$on("$md-resize-enable",function(){h();var k=f[0],n=k.nodeType===d.Node.ELEMENT_NODE?d.getComputedStyle(k):{};e.$watch(g[a],function(a){!!a===b&&(c.nextTick(function(){e.$broadcast("$md-resize")}),a={cachedTransitionStyles:n},c.dom.animator.waitTransitionEnd(f,a).then(function(){e.$broadcast("$md-resize")}))})})}}}]}ngmaterial.components.showHide=angular.module("material.components.showHide");VirtualRepeatContainerController.$inject="$$rAF $mdUtil $mdConstant $parse $rootScope $window $scope $element $attrs".split(" ");VirtualRepeatController.$inject="$scope $element $attrs $browser $document $rootScope $$rAF $mdUtil".split(" ");VirtualRepeatDirective.$inject=["$parse"];
...
function VirtualRepeatContainerController(a,b,c,d,e,f,g,h,k){this.$rootScope=e;this.$scope=g;this.$element=h;this.$attrs=k;this.scrollOffset=this.scrollSize=this.size=0;this.horizontal=this.$attrs.hasOwnProperty("mdOrientHorizontal");this.repeater=null;this.autoShrink=this.$attrs.hasOwnProperty("mdAutoShrink");this.autoShrinkMin=parseInt(this.$attrs.mdAutoShrinkMin,10)||0;this.originalSize=null;this.offsetSize=parseInt(this.$attrs.mdOffsetSize,10)||0;this.oldElementSize=null;this.maxElementPixels=
c.ELEMENT_MAX_PIXELS;this.$attrs.mdTopIndex?(this.bindTopIndex=d(this.$attrs.mdTopIndex),this.topIndex=this.bindTopIndex(this.$scope),angular.isDefined(this.topIndex)||(this.topIndex=0,this.bindTopIndex.assign(this.$scope,0)),this.$scope.$watch(this.bindTopIndex,angular.bind(this,function(a){a!==this.topIndex&&this.scrollToIndex(a)}))):this.topIndex=0;this.scroller=h[0].querySelector(".md-virtual-repeat-scroller");this.sizer=this.scroller.querySelector(".md-virtual-repeat-sizer");this.offsetter=this.scroller.querySelector(".md-virtual-repeat-offsetter");
var n=angular.bind(this,this.updateSize);a(angular.bind(this,function(){n();var a=b.debounce(n,10,null,!1),c=angular.element(f);this.size||a();c.on("resize",a);g.$on("$destroy",function(){c.off("resize",a)});g.$emit("$md-resize-enable");g.$on("$md-resize",n)}))}VirtualRepeatContainerController.prototype.register=function(a){this.repeater=a;angular.element(this.scroller).on("scroll wheel touchmove touchend",angular.bind(this,this.handleScroll_))};
...
function ForceHeightDirective(){return{restrict:"A",link:function(a,b,c){(a=a.$eval(c.mdForceHeight)||null)&&b&&(b[0].style.height=a)}}}ForceHeightDirective.$inject=["$mdUtil"];ngmaterial.components.virtualRepeat=angular.module("material.components.virtualRepeat");MdWhiteframeDirective.$inject=["$log"];angular.module("material.components.whiteframe",["material.core"]).directive("mdWhiteframe",MdWhiteframeDirective);function MdWhiteframeDirective(a){function b(b,d,e){var c="";e.$observe("mdWhiteframe",function(b){b=parseInt(b,10)||4;-1!=b&&(24<b||1>b)&&(a.warn("md-whiteframe attribute value is invalid. It should be a number between 1 and 24",d[0]),b=4);b=-1==b?"":"md-whiteframe-"+b+"dp";e.$updateClass(b,c);c=b})}return{link:b}}
ngmaterial.components.whiteframe=angular.module("material.components.whiteframe");angular.module("material.components.autocomplete",["material.core","material.components.icon","material.components.virtualRepeat"]);MdAutocompleteCtrl.$inject="$scope $element $mdUtil $mdConstant $mdTheming $window $animate $rootElement $attrs $q $log $mdLiveAnnouncer".split(" ");angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",MdAutocompleteCtrl);
function MdAutocompleteCtrl(a,b,c,d,e,f,g,h,k,n,q,l){function r(){c.initOptionalProperties(a,k,{searchText:"",selectedItem:null,clearButton:!1});e(b);t();c.nextTick(function(){var c;for(c=b;c.length;c=c.parent()){var d=c.attr("md-autocomplete-snap");if(angular.isDefined(d))break}c.length?c={snap:c[0],wrap:"width"===d.toLowerCase()?c[0]:b.find("md-autocomplete-wrap")[0]}:(c=b.find("md-autocomplete-wrap")[0],c={snap:c,wrap:c});I={main:b[0],scrollContainer:b[0].querySelector(".md-virtual-repeat-container"),
scroller:b[0].querySelector(".md-virtual-repeat-scroller"),ul:b.find("ul")[0],input:b.find("input")[0],wrap:c.wrap,snap:c.snap,root:document.body};I.li=I.ul.getElementsByTagName("li");c=I;d=I;var f={};for(k in d)d.hasOwnProperty(k)&&(f[k]=angular.element(d[k]));var k=f;c.$=k;V=I.$.input.controller("ngModel");I.$.root.length&&(e(I.$.scrollContainer),I.$.scrollContainer.detach(),I.$.root.append(I.$.scrollContainer),g.pin&&g.pin(I.$.scrollContainer,h));if(a.autofocus)b.on("focus",w)})}function m(){a.requireMatch&&
...
h=I.snap.getBoundingClientRect(),l=I.root.getBoundingClientRect(),t=h.bottom-l.top,m=l.bottom-h.top,p=g.left-l.left,n=g.width;h=d();var q=a.dropdownPosition;q||(q=t>m&&l.height-t-8<f?"top":"bottom");k.mdFloatingLabel&&(p+=2,n-=4);p={left:p+"px",minWidth:n+"px",maxWidth:Math.max(g.right-l.left,l.right-g.left)-8+"px"};"top"===q?(p.top="auto",p.bottom=m+"px",p.maxHeight=Math.min(f,g.top-l.top-8)+"px"):(m=l.bottom-g.bottom-8+c.getViewportTop(),p.top=t-h+"px",p.bottom="auto",p.maxHeight=Math.min(f,m)+
"px");I.$.scrollContainer.css(p);c.nextTick(e,!1)}function w(){I.input.focus()}function t(){var b=parseInt(a.delay,10)||0;k.$observe("disabled",function(a){x.isDisabled=c.parseAttributeBoolean(a,!1)});k.$observe("required",function(a){x.isRequired=c.parseAttributeBoolean(a,!1)});k.$observe("readonly",function(a){x.isReadonly=c.parseAttributeBoolean(a,!1)});a.$watch("searchText",b?c.debounce(C,b):C);a.$watch("selectedItem",G);angular.element(f).on("resize",la);a.$on("$destroy",p)}function p(){x.hidden||
c.enableScrolling();angular.element(f).off("resize",la);if(I){var a=["ul","scroller","scrollContainer","input"];angular.forEach(a,function(a){I.$[a].remove()})}}function y(){x.hidden||v()}function z(a,b){!a&&b?(v(),T(!0,fa.Count|fa.Selected),I&&(c.disableScrollAround(I.ul),Z=A(angular.element(I.wrap)))):a&&!b&&(c.enableScrolling(),Z&&(Z(),Z=null))}function A(a){function b(a){a.preventDefault()}a.on("wheel",b);a.on("touchmove",b);return function(){a.off("wheel",b);a.off("touchmove",b)}}function D(){aa=
!0}function B(){ba||x.hidden||I.input.focus();aa=!1;x.hidden=!P()}function E(){I.input.focus()}function G(b,c){m();b?R(b).then(function(d){a.searchText=d;F(b,c)}):c&&a.searchText&&R(c).then(function(b){angular.isString(a.searchText)&&b.toString().toLowerCase()===a.searchText.toLowerCase()&&(a.searchText="")});b!==c&&angular.isFunction(a.itemChange)&&a.itemChange(Y(a.selectedItem))}function F(a,b){W.forEach(function(c){c(a,b)})}function H(a){-1==W.indexOf(a)&&W.push(a)}function J(a){a=W.indexOf(a);
-1!=a&&W.splice(a,1)}function C(b,c){x.index=a.autoselect?0:-1;b!==c&&(m(),R(a.selectedItem).then(function(d){b!==d&&(a.selectedItem=null,b!==c&&angular.isFunction(a.textChange)&&a.textChange(),ma()?pa():(x.matches=[],S(!1),T(!1,fa.Count)))}))}function N(b){ba=!1;if(!aa){x.hidden=!P();var c="ngBlur";b={$event:b};k[c]&&a.$parent.$eval(k[c],b||{})}}function K(b){ba=!0;U()&&ma()&&pa();x.hidden=!P();var c="ngFocus";b={$event:b};k[c]&&a.$parent.$eval(k[c],b||{})}function L(b){switch(b.keyCode){case d.KEY_CODE.DOWN_ARROW:if(x.loading)break;
b.stopPropagation();b.preventDefault();x.index=Math.min(x.index+1,x.matches.length-1);ka();T(!1,fa.Selected);break;case d.KEY_CODE.UP_ARROW:if(x.loading)break;b.stopPropagation();b.preventDefault();x.index=0>x.index?x.matches.length-1:Math.max(0,x.index-1);ka();T(!1,fa.Selected);break;case d.KEY_CODE.TAB:B();if(x.hidden||x.loading||0>x.index||1>x.matches.length)break;ja(x.index);break;case d.KEY_CODE.ENTER:if(x.hidden||x.loading||0>x.index||1>x.matches.length)break;if(x.scope.selectedItem)break;b.stopPropagation();
b.preventDefault();ja(x.index);break;case d.KEY_CODE.ESCAPE:if(b.preventDefault(),X("blur")||!x.hidden||x.loading||X("clear")&&a.searchText)b.stopPropagation(),x.index=0,x.matches=[],a.searchText&&X("clear")&&M(),x.hidden=!0,X("blur")&&(ba=aa=!1,I.input.blur())}}function R(b){return n.when((b&&a.itemText?a.itemText(Y(b)):null)||b).then(function(a){a&&!angular.isString(a)&&q.warn("md-autocomplete: Could not resolve display value to a string. Please check the `md-item-text` attribute.");return a})}
function Y(a){if(a){var b={};x.itemName&&(b[x.itemName]=a);return b}}function S(a){x.loading!=a&&(x.loading=a);x.hidden=!P()}function U(){return x.loading&&!x.matches.length||x.scope.selectedItem||!ba?!1:!0}function X(b){return!a.escapeOptions||-1!==a.escapeOptions.toLowerCase().indexOf(b)}function P(){return x.isReadonly||!U()?!1:ma()&&(x.matches.length?!0:!1)||oa()}function O(){return x.loading&&!x.scope.selectedItem}function ca(){return R(x.matches[x.index])}function ma(){return(a.searchText||
"").length>=(angular.isNumber(a.minLength)?a.minLength:1)}function ia(a,b,c){Object.defineProperty(x,a,{get:function(){return c},set:function(a){var d=c;c=a;b(a,d)}})}function ja(b){c.nextTick(function(){R(x.matches[b]).then(function(a){var b=I.$.input.controller("ngModel");b.$setViewValue(a);b.$render()})["finally"](function(){a.selectedItem=x.matches[b];S(!1)})},!1)}function ra(){x.index=0;x.matches=[];M()}function M(){S(!0);a.searchText="";var b=document.createEvent("CustomEvent");b.initCustomEvent("change",
!0,!0,{value:""});I.input.dispatchEvent(b);I.input.blur();a.searchText="";I.input.focus()}function da(b){function d(b){b&&(b=n.when(b),u++,S(!0),c.nextTick(function(){b.then(e)["finally"](function(){0===--u&&S(!1)})},!0,a))}function e(c){Q[g]=c;(b||"")===(a.searchText||"")&&ea(c)}var f=a.$parent.$eval(ha),g=b.toLowerCase(),h=angular.isArray(f),k=!!f.then;h?e(f):k&&d(f)}function T(a,b){var c=a?"polite":"assertive";a=[];b&fa.Selected&&-1!==x.index&&a.push(ca());b&fa.Count&&a.push(n.resolve(na()));n.all(a).then(function(a){l.announce(a.join(" "),
c)})}function na(){switch(x.matches.length){case 0:return"There are no matches available.";case 1:return"There is 1 match available.";default:return"There are "+x.matches.length+" matches available."}}function ka(){if(I.li[0]){var a=I.li[0].offsetHeight,b=a*x.index;a=b+a;var c=I.scroller.clientHeight,d=I.scroller.scrollTop;b<d?sa(b):a>d+c&&sa(a-c)}}function sa(a){I.$.scrollContainer.controller("mdVirtualRepeatContainer").scrollTo(a)}function oa(){var b=(x.scope.searchText||"").length;return x.hasNotFound&&
!x.matches.length&&(!x.loading||0!==u)&&b>=(angular.isNumber(a.minLength)?a.minLength:1)&&(ba||aa)&&!x.scope.selectedItem}function pa(){var b=a.searchText||"",c=b.toLowerCase();!a.noCache&&Q[c]?ea(Q[c]):da(b);x.hidden=!P()}function ea(b){x.matches=b;x.hidden=!P();x.loading&&S(!1);a.selectOnMatch&&ta();v();T(!0,fa.Count)}function ta(){var b=a.searchText,c=x.matches,d=c[0];1===c.length&&R(d).then(function(c){var d=b==c;a.matchInsensitive&&!d&&(d=b.toLowerCase()==c.toLowerCase());d&&ja(0)})}var x=this,
qa=a.itemsExpr.split(/ in /i),ha=qa[1],I=null,Q={},aa=!1,W=[],ba=!1,u=0,Z=null,V=null,la=c.debounce(y);ia("hidden",z,!0);x.scope=a;x.parent=a.$parent;x.itemName=qa[0];x.matches=[];x.loading=!1;x.hidden=!0;x.index=null;x.id=c.nextUid();x.isDisabled=null;x.isRequired=null;x.isReadonly=null;x.hasNotFound=!1;x.keydown=L;x.blur=N;x.focus=K;x.clear=ra;x.select=ja;x.listEnter=D;x.listLeave=B;x.mouseUp=E;x.getCurrentDisplayValue=ca;x.registerSelectedItemWatcher=H;x.unregisterSelectedItemWatcher=J;x.notFoundVisible=
oa;x.loadingIsVisible=O;x.positionDropdown=v;var fa={Count:1,Selected:2};return r()}MdAutocomplete.$inject=["$$mdSvgRegistry"];angular.module("material.components.autocomplete").directive("mdAutocomplete",MdAutocomplete);
...
function MdAutocompleteItemScopeDirective(a,b){function c(a,c,f){return function(a,c){function d(c,d){h[d]=a[c];a.$watch(c,function(a){b.nextTick(function(){h[d]=a})})}function e(){var b=!1,c=!1;a.$watch(function(){c||b||(b=!0,a.$$postDigest(function(){c||h.$digest();b=c=!1}))});h.$watch(function(){c=!0})}var g=a.$mdAutocompleteCtrl,h=g.parent.$new();g=g.itemName;d("$index","$index");d("item",g);e();f(h,function(a){c.after(a)})}}return{restrict:"AE",compile:c,terminal:!0,transclude:"element"}}
...
MdHighlightCtrl.prototype.sanitizeRegex=function(a){return a&&a.toString().replace(/[\\^$*+?.()|{}[\]]/g,"\\$&")};MdHighlight.$inject=["$interpolate","$parse"];angular.module("material.components.autocomplete").directive("mdHighlightText",MdHighlight);function MdHighlight(a,b){return{terminal:!0,controller:"MdHighlightCtrl",compile:function(c,d){var e=b(d.mdHighlightText),f=a(c.html());return function(a,b,c,d){d.init(e,f)}}}}ngmaterial.components.autocomplete=angular.module("material.components.autocomplete");angular.module("material.components.backdrop",["material.core"]).directive("mdBackdrop",["$mdTheming","$mdUtil","$animate","$rootElement","$window","$log","$$rAF","$document",function(a,b,c,d,e,f,g,h){function k(k,q){function l(){var a=parseInt(n.height,10)+Math.abs(parseInt(n.top,10));q.css("height",a+"px")}c.pin&&c.pin(q,d);var n;g(function(){n=e.getComputedStyle(h[0].body);if("fixed"===n.position){var c=b.debounce(function(){n=e.getComputedStyle(h[0].body);l()},60,null,!1);l();angular.element(e).on("resize",
c);k.$on("$destroy",function(){angular.element(e).off("resize",c)})}var d=q.parent();if(d.length){"BODY"===d[0].nodeName&&q.css("position","fixed");var g=e.getComputedStyle(d[0]);"static"===g.position&&f.warn("<md-backdrop> may not work properly in a scrolled, static-positioned parent container.");a.inherit(q,d)}})}return{restrict:"E",link:k}}]);ngmaterial.components.backdrop=angular.module("material.components.backdrop");MdBottomSheetDirective.$inject=["$mdBottomSheet"];MdBottomSheetProvider.$inject=["$$interimElementProvider"];angular.module("material.components.bottomSheet",["material.core","material.components.backdrop"]).directive("mdBottomSheet",MdBottomSheetDirective).provider("$mdBottomSheet",MdBottomSheetProvider);function MdBottomSheetDirective(a){return{restrict:"E",link:function(b,c){c.addClass("_md");b.$on("$destroy",function(){a.destroy()})}}}
function MdBottomSheetProvider(a){function b(a,b,e,f,g,h,k,n){function c(c,d,k){d=e.extractElementByName(d,"md-bottom-sheet");d.attr("tabindex","-1");d.hasClass("ng-cloak")&&n.warn("$mdBottomSheet: using `<md-bottom-sheet ng-cloak>` will affect the bottom-sheet opening animations.",d[0]);k.isLockedOpen?(k.clickOutsideToClose=!1,k.escapeToClose=!1):k.cleanupGestures=r(d,k.parent);if(!k.disableBackdrop){m=e.createBackdrop(c,"md-bottom-sheet-backdrop md-opaque");m[0].tabIndex=-1;if(k.clickOutsideToClose)m.on("click",
function(){e.nextTick(g.cancel,!0)});f.inherit(m,k.parent);a.enter(m,k.parent,null)}f.inherit(d,k.parent);k.disableParentScroll&&(k.restoreScroll=e.disableScrollAround(d,k.parent));return a.enter(d,k.parent,m).then(function(){var a=e.findFocusTarget(d)||angular.element(d[0].querySelector("button")||d[0].querySelector("a")||d[0].querySelector(e.prefixer("ng-click",!0)))||m;k.escapeToClose&&(k.rootElementKeyupCallback=function(a){a.keyCode===b.KEY_CODE.ESCAPE&&e.nextTick(g.cancel,!0)},h.on("keyup",
k.rootElementKeyupCallback),a&&a.focus())})}function d(b,c,d){d.disableBackdrop||a.leave(m);return a.leave(c).then(function(){d.disableParentScroll&&(d.restoreScroll(),delete d.restoreScroll);d.cleanupGestures&&d.cleanupGestures()})}function r(a,c){function d(){a.css(b.CSS.TRANSITION_DURATION,"0ms")}function f(c){c=c.pointer.distanceY;5>c&&(c=Math.max(-80,c/2));a.css(b.CSS.TRANSFORM,"translate3d(0,"+(80+c)+"px,0)")}function h(c){if(0<c.pointer.distanceY&&(20<c.pointer.distanceY||.5<Math.abs(c.pointer.velocityY))){var d=
a.prop("offsetHeight")-c.pointer.distanceY;c=Math.min(d/c.pointer.velocityY*.75,500);a.css(b.CSS.TRANSITION_DURATION,c+"ms");e.nextTick(g.cancel,!0)}else a.css(b.CSS.TRANSITION_DURATION,""),a.css(b.CSS.TRANSFORM,"")}var l=k.register(c,"drag",{horizontal:!1});c.on("$md.dragstart",d).on("$md.drag",f).on("$md.dragend",h);return function(){l();c.off("$md.dragstart",d);c.off("$md.drag",f);c.off("$md.dragend",h)}}var m;return{themable:!0,onShow:c,onRemove:d,disableBackdrop:!1,escapeToClose:!0,clickOutsideToClose:!0,
...
MdChipsCtrl.prototype.init=function(){var a=this;this.wrapperId="_md-chips-wrapper-"+this.$mdUtil.nextUid();this.deRegister.push(this.$scope.$watchCollection("$mdChipsCtrl.items",function(){a.setupInputAria();a.setupWrapperAria()}));this.deRegister.push(this.$attrs.$observe("mdChipAppendDelay",function(b){a.chipAppendDelay=parseInt(b)||300}))};MdChipsCtrl.prototype.$onDestroy=function(){for(var a;a=this.deRegister.pop();)a.call(this)};
...
MdChipsCtrl.prototype.hasMaxChipsReached=function(){angular.isString(this.maxChips)&&(this.maxChips=parseInt(this.maxChips,10)||0);return 0<this.maxChips&&this.items.length>=this.maxChips};MdChipsCtrl.prototype.validateModel=function(){this.ngModelCtrl.$setValidity("md-max-chips",!this.hasMaxChipsReached());this.ngModelCtrl.$validate()};MdChipsCtrl.prototype.updateNgModel=function(a){a||this.validateModel();angular.forEach(this.ngModelCtrl.$viewChangeListeners,function(a){try{a()}catch(c){this.$exceptionHandler(c)}})};
MdChipsCtrl.prototype.removeChip=function(a,b){var c=this.items.splice(a,1);this.updateNgModel();if(c&&c.length&&this.useOnRemove&&this.onRemove)this.onRemove({$chip:c[0],$index:a,$event:b})};MdChipsCtrl.prototype.removeChipAndFocusInput=function(a,b){this.removeChip(a,b);if(this.autocompleteCtrl)this.autocompleteCtrl.hidden=!0,this.$mdUtil.nextTick(this.onFocus.bind(this));else this.onFocus()};
...
MdChipsCtrl.prototype.shouldAddOnBlur=function(){this.validateModel();var a=this.getChipBuffer().trim(),b=this.ngModelCtrl.$isEmpty(this.ngModelCtrl.$modelValue)||this.ngModelCtrl.$valid,c=this.autocompleteCtrl&&!this.autocompleteCtrl.hidden;this.userInputNgModelCtrl&&(b=b&&this.userInputNgModelCtrl.$valid);return this.addOnBlur&&!this.requireMatch&&a&&b&&!c};MdChipsCtrl.prototype.hasFocus=function(){return this.inputHasFocus||0<=this.selectedChip};MdChipsCtrl.prototype.contentIdFor=function(a){return this.contentIds[a]};
MdChips.$inject="$mdTheming $mdUtil $compile $log $timeout $$mdSvgRegistry".split(" ");angular.module("material.components.chips").directive("mdChips",MdChips);
function MdChips(a,b,c,d,e,f){function g(g,n){function k(a){if(n.ngModel)return(a=l[0].querySelector(a))&&a.outerHTML}var l=n.$mdUserTemplate;n.$mdUserTemplate=null;var r=k("md-chips>md-chip-template");g=b.prefixer().buildList("md-chip-remove").map(function(a){return"md-chips>*["+a+"]"}).join(",");var m=k(g)||h.remove,v=r||h["default"],w=k("md-chips>md-autocomplete")||k("md-chips>input")||h.input,t=l.find("md-chip");l[0].querySelector("md-chip-template>*[md-chip-remove]")&&d.warn("invalid placement of md-chip-remove within md-chip-template.");
return function(d,g,k,l){b.initOptionalProperties(d,n);a(g);var p=l[0];r&&(p.enableChipEdit=!1);p.chipContentsTemplate=v;p.chipRemoveTemplate=m;p.chipInputTemplate=w;p.mdCloseIcon=f.mdClose;g.attr({tabindex:-1}).on("focus",function(){p.onFocus()}).on("click",function(){if(!p.readonly&&-1===p.selectedChip)p.onFocus()});n.ngModel&&(p.configureNgModel(g.controller("ngModel")),k.mdTransformChip&&p.useTransformChipExpression(),k.mdOnAppend&&p.useOnAppendExpression(),k.mdOnAdd&&p.useOnAddExpression(),k.mdOnRemove&&
p.useOnRemoveExpression(),k.mdOnSelect&&p.useOnSelectExpression(),w!=h.input&&d.$watch("$mdChipsCtrl.readonly",function(a){a||b.nextTick(function(){if(0===w.indexOf("<md-autocomplete")){var a=g.find("md-autocomplete");p.configureAutocomplete(a.controller("mdAutocomplete"))}p.configureUserInput(g.find("input"))})}),b.nextTick(function(){var a=g.find("input");a&&(p.configureInput(a),a.toggleClass("md-input",!0))}));if(0<t.length){var q=c(t.clone())(d.$parent);e(function(){g.find("md-chips-wrap").prepend(q)})}}}
...
input:b.processTemplate('        <input            class="md-input"            tabindex="0"            aria-label="{{$mdChipsCtrl.inputAriaLabel}}"             placeholder="{{$mdChipsCtrl.getPlaceholder()}}"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.onInputFocus()"            ng-blur="$mdChipsCtrl.onInputBlur()"            ng-keydown="$mdChipsCtrl.inputKeydown($event)">'),"default":b.processTemplate("      <span>{{$chip}}</span>"),remove:b.processTemplate('      <button          class="md-chip-remove"          ng-if="$mdChipsCtrl.isRemovable()"          ng-click="$mdChipsCtrl.removeChipAndFocusInput($$replacedScope.$index, $event)"          type="button"          tabindex="-1">        <md-icon md-svg-src="{{ $mdChipsCtrl.mdCloseIcon }}"></md-icon>        <span class="md-visually-hidden">          {{$mdChipsCtrl.deleteButtonLabel}}        </span>      </button>')};
return{template:function(a,b){b.$mdUserTemplate=a.clone();return h.chips},require:["mdChips"],restrict:"E",controller:"MdChipsCtrl",controllerAs:"$mdChipsCtrl",bindToController:!0,compile:g,scope:{readonly:"=readonly",removable:"=mdRemovable",placeholder:"@",secondaryPlaceholder:"@",maxChips:"@mdMaxChips",transformChip:"&mdTransformChip",onAppend:"&mdOnAppend",onAdd:"&mdOnAdd",onRemove:"&mdOnRemove",onSelect:"&mdOnSelect",inputAriaLabel:"@",containerHint:"@",deleteHint:"@",deleteButtonLabel:"@",separatorKeys:"=?mdSeparatorKeys",
requireMatch:"=?mdRequireMatch",chipAppendDelayString:"@?mdChipAppendDelay",ngChange:"&"}}}angular.module("material.components.chips").controller("MdContactChipsCtrl",MdContactChipsCtrl);function MdContactChipsCtrl(){this.selectedItem=null;this.searchText=""}MdContactChipsCtrl.prototype.queryContact=function(a){return this.contactQuery({$query:a})};MdContactChipsCtrl.prototype.itemName=function(a){return a[this.contactName]};MdContactChips.$inject=["$mdTheming","$mdUtil"];
angular.module("material.components.chips").directive("mdContactChips",MdContactChips);
function MdContactChips(a,b){function c(c,e){return function(c,d,h,k){var f=k;b.initOptionalProperties(c,e);a(d);d.attr("tabindex","-1");h.$observe("mdChipAppendDelay",function(a){f.chipAppendDelay=a})}}return{template:function(){return'      <md-chips class="md-contact-chips"          ng-model="$mdContactChipsCtrl.contacts"          ng-change="$mdContactChipsCtrl.ngChange($mdContactChipsCtrl.contacts)"          md-require-match="$mdContactChipsCtrl.requireMatch"          md-chip-append-delay="{{$mdContactChipsCtrl.chipAppendDelay}}"           md-autocomplete-snap>          <md-autocomplete              md-menu-class="md-contact-chips-suggestions"              md-selected-item="$mdContactChipsCtrl.selectedItem"              md-search-text="$mdContactChipsCtrl.searchText"              md-items="item in $mdContactChipsCtrl.queryContact($mdContactChipsCtrl.searchText)"              md-item-text="$mdContactChipsCtrl.itemName(item)"              md-no-cache="true"              md-min-length="$mdContactChipsCtrl.minLength"              md-autoselect              placeholder="{{$mdContactChipsCtrl.contacts.length == 0 ?                  $mdContactChipsCtrl.placeholder : $mdContactChipsCtrl.secondaryPlaceholder}}">            <div class="md-contact-suggestion">              <img                   ng-src="{{item[$mdContactChipsCtrl.contactImage]}}"                  alt="{{item[$mdContactChipsCtrl.contactName]}}"                  ng-if="item[$mdContactChipsCtrl.contactImage]" />              <span class="md-contact-name" md-highlight-text="$mdContactChipsCtrl.searchText"                    md-highlight-flags="{{$mdContactChipsCtrl.highlightFlags}}">                {{item[$mdContactChipsCtrl.contactName]}}              </span>              <span class="md-contact-email" >{{item[$mdContactChipsCtrl.contactEmail]}}</span>            </div>          </md-autocomplete>          <md-chip-template>            <div class="md-contact-avatar">              <img                   ng-src="{{$chip[$mdContactChipsCtrl.contactImage]}}"                  alt="{{$chip[$mdContactChipsCtrl.contactName]}}"                  ng-if="$chip[$mdContactChipsCtrl.contactImage]" />            </div>            <div class="md-contact-name">              {{$chip[$mdContactChipsCtrl.contactName]}}            </div>          </md-chip-template>      </md-chips>'},restrict:"E",
controller:"MdContactChipsCtrl",controllerAs:"$mdContactChipsCtrl",bindToController:!0,compile:c,scope:{contactQuery:"&mdContacts",placeholder:"@",secondaryPlaceholder:"@",contactName:"@mdContactName",contactImage:"@mdContactImage",contactEmail:"@mdContactEmail",contacts:"=ngModel",ngChange:"&",requireMatch:"=?mdRequireMatch",minLength:"=?mdMinLength",highlightFlags:"@?mdHighlightFlags",chipAppendDelay:"@?mdChipAppendDelay"}}}ngmaterial.components.chips=angular.module("material.components.chips");(function(){function a(a,b,c){function e(a,b){try{b&&a.css(q(b))}catch(w){c.error(w.message)}}function f(a){a=r(a);return g(a)}function g(c,d){d=d||!1;var e=a.PALETTES[c.palette][c.hue];e=d?e.contrast:e.value;return b.supplant("rgba({0}, {1}, {2}, {3})",[e[0],e[1],e[2],e[3]||c.opacity])}function q(a){var b={},c=a.hasOwnProperty("color");angular.forEach(a,function(a,d){a=r(a);var e=-1<d.indexOf("background");b[d]=g(a);e&&!c&&(b.color=g(a,!0))});return b}function l(b){return angular.isDefined(a.THEMES[b.split("-")[0]])}
function r(c){c=c.split("-");var e=angular.isDefined(a.THEMES[c[0]]);e=e?c.splice(0,1)[0]:a.defaultTheme();var f=c,g=e,h=1<f.length&&-1!==d.indexOf(f[1]);var k=f[0].replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();h&&(k=f[0]+"-"+f.splice(1,1));if(-1===d.indexOf(k)){f=a.THEMES[g].colors[k];if(!f)throw Error(b.supplant("mdColors: couldn't find '{palette}' in the palettes.",{palette:k}));k=f.name}f=c;g=a.THEMES[e].colors;if("hue"===f[1]){h=parseInt(f.splice(2,1)[0],10);if(1>h||3<h)throw Error(b.supplant("mdColors: 'hue-{hueNumber}' is not a valid hue, can be only 'hue-1', 'hue-2' and 'hue-3'",
{hueNumber:h}));f[1]="hue-"+h;if(!(f[0]in g))throw Error(b.supplant("mdColors: 'hue-x' can only be used with [{availableThemes}], but was used with '{usedTheme}'",{availableThemes:Object.keys(g).join(", "),usedTheme:f[0]}));f=g[f[0]].hues[f[1]]}else f=f[1]||g[f[0]in g?f[0]:"primary"].hues["default"];return{theme:e,palette:k,hue:f,opacity:c[2]||1}}d=d||Object.keys(a.PALETTES);return{applyThemeColors:e,getThemeColor:f,hasTheme:l}}function b(a,b,d,h){return{restrict:"A",require:["^?mdTheme"],compile:function(e,
f){function g(){var a=f.mdColors,d=-1<a.indexOf("::"),e=d?!0:c.test(f.mdColors);f.mdColors=a.replace("::","");a=angular.isDefined(f.mdColorsWatch);return d||e?!1:a?b.parseAttributeBoolean(f.mdColorsWatch):!0}var k=g();return function(b,c,e,f){var g=f[0],l={},m=function(c){"string"!==typeof c&&(c="");e.mdColors||(e.mdColors="{}");var d=h(e.mdColors)(b);g&&Object.keys(d).forEach(function(b){var e=d[b];a.hasTheme(e)||(d[b]=(c||g.$mdTheme)+"-"+e)});n(d);return d},n=function(a){if(!angular.equals(a,l)){var b=
Object.keys(l);l.background&&!b.color&&b.push("color");b.forEach(function(a){c.css(a,"")})}l=a},r=angular.noop;g&&(r=g.registerChanges(function(b){a.applyThemeColors(c,m(b))}));b.$on("$destroy",function(){r()});try{k?b.$watch(m,angular.bind(this,a.applyThemeColors,c),!0):a.applyThemeColors(c,m())}catch(D){d.error(D.message)}}}}}b.$inject=["$mdColors","$mdUtil","$log","$parse"];a.$inject=["$mdTheming","$mdUtil","$log"];var c=/^{((\s|,)*?["'a-zA-Z-]+?\s*?:\s*?('|")[a-zA-Z0-9-.]*('|"))+\s*}$/,d=null;
...
bindToController:!0,link:function(a,b,c,d){a=d[0];d=d[1];d.configureNgModel(a)}}}function b(a,b,d,h,k,n,q,l,r){n(a);this.$element=a;this.$scope=b;this.dateUtil=d;this.$mdUtil=h;this.keyCode=k.KEY_CODE;this.$$rAF=q;this.$mdDateLocale=r;this.today=this.dateUtil.createDateAtMidnight();this.ngModelCtrl=null;this.SELECTED_DATE_CLASS="md-calendar-selected-date";this.TODAY_CLASS="md-calendar-date-today";this.FOCUSED_DATE_CLASS="md-focus";this.id=c++;this.lastRenderableDate=this.firstRenderableDate=this.selectedDate=
...
"mdCalendarMonth"],controller:b,controllerAs:"monthCtrl",bindToController:!0,link:function(a,b,e,f){a=f[0];f=f[1];f.initialize(a)}}}function b(a,b,e,f,g,h){this.$element=a;this.$scope=b;this.$animate=e;this.$q=f;this.dateUtil=g;this.dateLocale=h;this.calendarScroller=a[0].querySelector(".md-virtual-repeat-scroller");this.isMonthTransitionInProgress=this.isInitialized=!1;var c=this;this.cellClickHandler=function(){var a=g.getTimestampFromNode(this);c.$scope.$apply(function(){c.calendarCtrl.setNgModelValue(a)})};
...
c=this.dateUtil.getFirstDateOfMonth(b),f=this.getLocaleDay_(c),g=this.dateUtil.getNumberOfDaysInMonth(b);a=document.createDocumentFragment();var h=1,k=this.buildDateRow(h);a.appendChild(k);var n=this.offset===this.monthCtrl.items.length-1,q=0,l=document.createElement("td"),r=document.createElement("span"),m=this.calendarCtrl;r.textContent=this.dateLocale.monthHeaderFormatter(b);l.appendChild(r);l.classList.add("md-calendar-month-label");m.maxDate&&c>m.maxDate?l.classList.add("md-calendar-month-label-disabled"):
m.mode||(l.addEventListener("click",this.monthCtrl.headerClickHandler),l.setAttribute("data-timestamp",c.getTime()),l.setAttribute("aria-label",this.dateLocale.monthFormatter(b)),l.classList.add("md-calendar-label-clickable"),l.appendChild(this.arrowIcon.cloneNode(!0)));if(2>=f){if(l.setAttribute("colspan","7"),b=this.buildDateRow(),b.appendChild(l),a.insertBefore(b,k),n)return a}else q=3,l.setAttribute("colspan","3"),k.appendChild(l);for(;q<f;q++)k.appendChild(this.buildDateCell());for(q=1;q<=g;q++){if(7===
f){if(n)return a;f=0;h++;k=this.buildDateRow(h);a.appendChild(k)}c.setDate(q);l=this.buildDateCell(c);k.appendChild(l);f++}for(;7>k.childNodes.length;)k.appendChild(this.buildDateCell());for(;6>a.childNodes.length;){g=this.buildDateRow();for(h=0;7>h;h++)g.appendChild(this.buildDateCell());a.appendChild(g)}return a};b.prototype.getLocaleDay_=function(a){return(a.getDay()+(7-this.dateLocale.firstDayOfWeek))%7}})();
...
"mdCalendarYear"],controller:b,controllerAs:"yearCtrl",bindToController:!0,link:function(a,b,e,f){a=f[0];f=f[1];f.initialize(a)}}}function b(a,b,e,f,g,h){this.$element=a;this.$scope=b;this.$animate=e;this.$q=f;this.dateUtil=g;this.calendarScroller=a[0].querySelector(".md-virtual-repeat-scroller");this.isMonthTransitionInProgress=this.isInitialized=!1;this.$mdUtil=h;var c=this;this.cellClickHandler=function(){c.onTimestampSelected(g.getTimestampFromNode(this))}}b.$inject="$element $scope $animate $q $$mdDateUtil $mdUtil".split(" ");
...
this.calendarScroller.scrollTop=88*a);return this.$q.when()};b.prototype.handleKeyEvent=function(a,b){var c=this,d=c.calendarCtrl,g=d.displayDate;if("select"===b)c.changeDate(g).then(function(){c.onTimestampSelected(g)});else{var h=null;a=c.dateUtil;switch(b){case "move-right":h=a.incrementMonths(g,1);break;case "move-left":h=a.incrementMonths(g,-1);break;case "move-row-down":h=a.incrementMonths(g,6);break;case "move-row-up":h=a.incrementMonths(g,-6)}if(h){b=d.minDate?a.getFirstDateOfMonth(d.minDate):
null;var k=d.maxDate?a.getFirstDateOfMonth(d.maxDate):null;h=a.getFirstDateOfMonth(c.dateUtil.clampDate(h,b,k));c.changeDate(h).then(function(){d.focus(h)})}}};b.prototype.attachScopeListeners=function(){var a=this;a.$scope.$on("md-calendar-parent-changed",function(b,c){a.calendarCtrl.changeSelectedDate(c?a.dateUtil.getFirstDateOfMonth(c):c);a.changeDate(c)});a.$scope.$on("md-calendar-parent-action",angular.bind(a,a.handleKeyEvent))};b.prototype.onTimestampSelected=function(a){var b=this.calendarCtrl;
...
if(this.dateUtil.isMonthWithinRange(a,c.minDate,c.maxDate)){var h=document.createElement("span");h.classList.add("md-calendar-date-selection-indicator");h.textContent=b;g.appendChild(h);g.addEventListener("click",d.cellClickHandler);c.displayDate&&this.dateUtil.isSameMonthAndYear(a,c.displayDate)&&(this.focusAfterAppend=g)}else g.classList.add("md-calendar-date-disabled"),g.textContent=b;return g};b.prototype.buildBlankCell=function(){var a=document.createElement("td");a.tabIndex=-1;a.classList.add("md-calendar-date");
...
angular.module("material.components.datepicker").config(["$provide",function(a){function b(){this.dates=this.shortDays=this.days=this.shortMonths=this.months=null;this.firstDayOfWeek=0;this.isDateComplete=this.longDateFormatter=this.weekNumberFormatter=this.monthHeaderFormatter=this.parseDate=this.formatDate=null;this.msgOpenCalendar=this.msgCalendar=""}b.prototype.$get=function(a,b){function c(a,c){if(!a)return"";var d=a.toLocaleTimeString(),e=a;0!==a.getHours()||-1===d.indexOf("11:")&&-1===d.indexOf("23:")||
(e=new Date(a.getFullYear(),a.getMonth(),a.getDate(),1,0,0));return b("date")(e,"M/d/yyyy",c)}function d(a){return new Date(a)}function g(a){a=a.trim();var b=/^(([a-zA-Z]{3,}|[0-9]{1,4})([ .,]+|[/-])){2}([a-zA-Z]{3,}|[0-9]{1,4})$/;return b.test(a)}function h(a){return w.shortMonths[a.getMonth()]+" "+a.getFullYear()}function k(a){return w.months[a.getMonth()]+" "+a.getFullYear()}function n(a){return"Week "+a}function q(a){return[w.days[a.getDay()],w.months[a.getMonth()],w.dates[a.getDate()],a.getFullYear()].join(" ")}
for(var l=a.DATETIME_FORMATS.SHORTDAY.map(function(a){return a.substring(0,1)}),r=Array(32),m=1;31>=m;m++)r[m]=m;m=new Date(1880,0,1);var v=new Date(m.getFullYear()+250,0,1),w={months:this.months||a.DATETIME_FORMATS.MONTH,shortMonths:this.shortMonths||a.DATETIME_FORMATS.SHORTMONTH,days:this.days||a.DATETIME_FORMATS.DAY,shortDays:this.shortDays||l,dates:this.dates||r,firstDayOfWeek:this.firstDayOfWeek||0,formatDate:this.formatDate||c,parseDate:this.parseDate||d,isDateComplete:this.isDateComplete||
g,monthHeaderFormatter:this.monthHeaderFormatter||h,monthFormatter:this.monthFormatter||k,weekNumberFormatter:this.weekNumberFormatter||n,longDateFormatter:this.longDateFormatter||q,msgCalendar:this.msgCalendar||"Calendar",msgOpenCalendar:this.msgOpenCalendar||"Open calendar",firstRenderableDate:this.firstRenderableDate||m,lastRenderableDate:this.lastRenderableDate||v};return w};b.prototype.$get.$inject=["$locale","$filter"];a.provider("$mdDateLocale",new b)}]);
...
b){a=c(a);return e(a,b)}function h(a,b){a=d(a);return e(b,a)}function k(a,b){return t((a.getTime()+b.getTime())/2)}function n(b){var c=a(b);return Math.floor((c.getDay()+b.getDate()-1)/7)}function q(a,b){return new Date(a.getFullYear(),a.getMonth(),a.getDate()+b)}function l(a,c){c=new Date(a.getFullYear(),a.getMonth()+c,1);var d=b(c);d<a.getDate()?c.setDate(d):c.setDate(a.getDate());return c}function r(a,b){return 12*(b.getFullYear()-a.getFullYear())+(b.getMonth()-a.getMonth())}function m(a){return new Date(a.getFullYear(),
a.getMonth(),b(a))}function v(a){return a&&a.getTime&&!isNaN(a.getTime())}function w(a){v(a)&&a.setHours(0,0,0,0)}function t(a){a=angular.isUndefined(a)?new Date:new Date(a);w(a);return a}function p(a,b,c){a=t(a);b=v(b)?t(b):null;c=v(c)?t(c):null;return(!b||b<=a)&&(!c||c>=a)}function y(a,b){return l(a,12*b)}function z(a,b){return b.getFullYear()-a.getFullYear()}function A(a,b,c){var d=a;b&&a<b&&(d=new Date(b.getTime()));c&&a>c&&(d=new Date(c.getTime()));return d}function D(a){if(a&&a.hasAttribute("data-timestamp"))return Number(a.getAttribute("data-timestamp"))}
function B(a,b,c){var d=a.getMonth();a=a.getFullYear();return(!b||b.getFullYear()<a||b.getMonth()<=d)&&(!c||c.getFullYear()>a||c.getMonth()>=d)}return{getFirstDateOfMonth:a,getNumberOfDaysInMonth:b,getDateInNextMonth:c,getDateInPreviousMonth:d,isInNextMonth:g,isInPreviousMonth:h,getDateMidpoint:k,isSameMonthAndYear:e,getWeekOfMonth:n,incrementDays:q,incrementMonths:l,getLastDateOfMonth:m,isSameDay:f,getMonthDistance:r,isValidDate:v,setDateTimeToMidnight:w,createDateAtMidnight:t,isDateWithinRange:p,
incrementYears:y,getYearDistance:z,clampDate:A,getTimestampFromNode:D,isMonthWithinRange:B}});
...
require:["ngModel","mdDatepicker","?^mdInputContainer","?^form"],scope:{minDate:"=mdMinDate",maxDate:"=mdMaxDate",placeholder:"@mdPlaceholder",currentView:"@mdCurrentView",mode:"@mdMode",dateFilter:"=mdDateFilter",isOpen:"=?mdIsOpen",debounceInterval:"=mdDebounceInterval",dateLocale:"=mdDateLocale"},controller:b,controllerAs:"ctrl",bindToController:!0,link:function(a,b,d,e){var h=e[0],k=e[1],m=e[2],n=e[3];e=c.parseAttributeBoolean(d.mdNoAsterisk);k.configureNgModel(h,m,g);if(m){var q=b[0].querySelector(".md-errors-spacer");
q&&b.after(angular.element("<div>").append(q));m.setHasPlaceholder(d.mdPlaceholder);m.input=b;m.element.addClass("_md-datepicker-floating-label").toggleClass("_md-datepicker-has-calendar-icon","calendar"!==d.mdHideIcons&&"all"!==d.mdHideIcons);m.label?e||d.$observe("required",function(a){m.label.toggleClass("md-required",!!a)}):f.expect(b,"aria-label",d.mdPlaceholder);a.$watch(m.isErrorGetter||function(){return h.$invalid&&(h.$touched||n&&n.$submitted)},m.setInvalid)}else if(n)var t=a.$watch(function(){return n.$submitted},
function(a){a&&(k.updateErrorState(),t())})}}}function b(a,b,f,g,h,k,n,q,l,r,m){this.$window=g;this.dateUtil=l;this.$mdConstant=h;this.$mdUtil=n;this.$$rAF=r;this.$mdDateLocale=q;this.documentElement=angular.element(document.documentElement);this.ngModelCtrl=null;this.inputElement=b[0].querySelector("input");this.ngInputElement=angular.element(this.inputElement);this.inputContainer=b[0].querySelector(".md-datepicker-input-container");this.calendarPane=b[0].querySelector(".md-datepicker-calendar-pane");
this.calendarButton=b[0].querySelector(".md-datepicker-button");this.inputMask=angular.element(b[0].querySelector(".md-datepicker-input-mask-opaque"));this.$element=b;this.$attrs=f;this.$scope=a;this.date=null;this.isFocused=!1;this.setDisabled(b[0].disabled||angular.isString(f.disabled));this.isCalendarOpen=!1;this.openOnFocus=f.hasOwnProperty("mdOpenOnFocus");this.calendarPaneOpenedFrom=this.mdInputContainer=null;this.calendarPaneId="md-date-pane-"+n.nextUid();this.bodyClickHandler=angular.bind(this,
this.handleBodyClick);this.windowEventName=c.test(navigator.userAgent||navigator.vendor||window.opera)?"orientationchange":"resize";this.windowEventHandler=n.debounce(angular.bind(this,this.closeCalendarPane),100);this.windowBlurHandler=angular.bind(this,this.handleWindowBlur);this.ngDateFilter=m("date");this.leftMargin=20;this.topMargin=null;f.tabindex?(this.ngInputElement.attr("tabindex",f.tabindex),f.$set("tabindex",null)):f.$set("tabindex","-1");f.$set("aria-owns",this.calendarPaneId);k(b);k(angular.element(this.calendarPane));
...
g=b.getBoundingClientRect();if(!this.topMargin||0>this.topMargin)this.topMargin=(this.inputMask.parent().prop("clientHeight")-this.ngInputElement.prop("clientHeight"))/2;b=c.top-g.top-this.topMargin;var h=c.left-g.left-this.leftMargin,k=0>g.top&&0==document.body.scrollTop?-g.top:document.body.scrollTop,n=0>g.left&&0==document.body.scrollLeft?-g.left:document.body.scrollLeft;g=k+this.$window.innerHeight;var q=n+this.$window.innerWidth;this.inputMask.css({position:"absolute",left:this.leftMargin+"px",
top:this.topMargin+"px",width:c.width-1+"px",height:c.height-2+"px"});h+360>q&&(0<q-360?h=q-360:(h=n,c=this.$window.innerWidth/360,a.style.transform="scale("+c+")"),a.classList.add("md-datepicker-pos-adjusted"));b+368>g&&g-368>k&&(b=g-368,a.classList.add("md-datepicker-pos-adjusted"));a.style.left=h+"px";a.style.top=b+"px";document.body.appendChild(a);this.$$rAF(function(){a.classList.add("md-pane-open")})};b.prototype.detachCalendarPane=function(){this.$element.removeClass("md-datepicker-open");
...
controller:c,controllerAs:"dialog",bindToController:!0}}function c(a,b){this.$onInit=function(){var c="prompt"==this.$type;c&&this.initialValue&&(this.result=this.initialValue);this.hide=function(){a.hide(c?this.result:!0)};this.abort=function(){a.cancel()};this.keypress=function(d){var e=c&&this.required&&!angular.isDefined(this.result);d.keyCode!==b.KEY_CODE.ENTER||e||a.hide(this.result)}}}function d(a,b,c,d,q,l,r,m,v,w,t,p,y){function g(a){a.defaultTheme=t.defaultTheme();E(a)}function h(a,b,c,
d){if(d){a=d.htmlContent||c.htmlContent||"";c=d.textContent||c.textContent||d.content||c.content||"";if(a&&!w.has("$sanitize"))throw Error("The ngSanitize module must be loaded in order to use htmlContent.");if(a&&c)throw Error("md-dialog cannot have both `htmlContent` and `textContent`");d.mdHtmlContent=a;d.mdTextContent=c}}function k(a,b,d){angular.element(l[0].body).addClass("md-dialog-is-showing");var e=b.find("md-dialog");e.hasClass("ng-cloak")&&v.warn("$mdDialog: using `<md-dialog ng-cloak>` will affect the dialog opening animations.",
b[0]);G(d);J(e,d);H(a,b,d);F(b,d);return K(b,d).then(function(){C(b,d);b[0].querySelector(".md-actions")&&v.warn("Using a class of md-actions is deprecated, please use <md-dialog-actions>.");if(d.focusOnOpen){var a=c.findFocusTarget(b)||b[0].querySelector(".dialog-close, md-dialog-actions button:last-child")||e;a.focus()}})}function n(a,b,c){function d(){angular.element(l[0].body).removeClass("md-dialog-is-showing");c.contentElement&&c.reverseContainerStretch();c.cleanupElement();c.$destroy||"keyboard"!==
c.originInteraction||c.origin.focus()}c.deactivateListeners();c.unlockScreenReader();c.hideBackdrop(c.$destroy);e&&e.parentNode&&e.parentNode.removeChild(e);f&&f.parentNode&&f.parentNode.removeChild(f);return c.$destroy?d():L(b,c).then(d)}function E(a){var b;a.targetEvent&&a.targetEvent.target&&(b=angular.element(a.targetEvent.target));b=b&&b.controller("mdTheme");a.hasTheme=!!b;if(a.hasTheme){a.themeWatch=b.$shouldWatch;var c=a.theme||b.$mdTheme;c&&(a.scope.theme=c);var d=b.registerChanges(function(b){a.scope.theme=
b;a.themeWatch||d()})}}function G(a){function b(a,b){if((a=angular.element(a||{}))&&a.length){var c={top:0,left:0,height:0,width:0},d=angular.isFunction(a[0].getBoundingClientRect);return angular.extend(b||{},{element:d?a:void 0,bounds:d?a[0].getBoundingClientRect():angular.extend({},c,a[0]),focus:angular.bind(a,a.focus)})}}function c(a,b){angular.isString(a)&&(a=l[0].querySelector(a));return angular.element(a||b)}a.origin=angular.extend({element:null,bounds:null,focus:angular.noop},a.origin||{});
a.parent=c(a.parent,m);a.closeTo=b(c(a.closeTo));a.openFrom=b(c(a.openFrom));a.targetEvent&&(a.origin=b(a.targetEvent.target,a.origin),a.originInteraction=y.getLastInteractionType())}function F(b,e){var f=angular.element(r),g=c.debounce(function(){N(b,e)},60),h=[],k=function(){var b="alert"==e.$type?a.hide:a.cancel;c.nextTick(b,!0)};if(e.escapeToClose){var l=e.parent,p=function(a){a.keyCode===d.KEY_CODE.ESCAPE&&(a.stopPropagation(),a.preventDefault(),k())};b.on("keydown",p);l.on("keydown",p);h.push(function(){b.off("keydown",
p);l.off("keydown",p)})}f.on("resize",g);h.push(function(){f.off("resize",g)});if(e.clickOutsideToClose){var m=b,n,t=function(a){n=a.target},q=function(a){n===m[0]&&a.target===m[0]&&(a.stopPropagation(),a.preventDefault(),k())};m.on("mousedown",t);m.on("mouseup",q);h.push(function(){m.off("mousedown",t);m.off("mouseup",q)})}e.deactivateListeners=function(){h.forEach(function(a){a()});e.deactivateListeners=null}}function H(a,b,d){d.disableParentScroll&&(d.restoreScroll=c.disableScrollAround(b,d.parent));
d.hasBackdrop&&(d.backdrop=c.createBackdrop(a,"md-dialog-backdrop md-opaque"),q.enter(d.backdrop,d.parent));d.hideBackdrop=function(a){d.backdrop&&(a?d.backdrop.remove():q.leave(d.backdrop));d.disableParentScroll&&(d.restoreScroll&&d.restoreScroll(),delete d.restoreScroll);d.hideBackdrop=null}}function J(a,d){var g="alert"===d.$type?"alertdialog":"dialog",h=a.find("md-dialog-content"),k=a.attr("id"),l="dialogContent_"+(k||c.nextUid());a.attr({role:g,tabIndex:"-1"});0===h.length&&(h=a,k&&(l=k));h.attr("id",
l);a.attr("aria-describedby",l);d.ariaLabel?b.expect(a,"aria-label",d.ariaLabel):b.expectAsync(a,"aria-label",function(){if(d.title)return d.title;var a=h.text().split(/\s+/);3<a.length&&(a=a.slice(0,3).concat("..."));return a.join(" ")});e=document.createElement("div");e.classList.add("md-dialog-focus-trap");e.tabIndex=0;f=e.cloneNode(!1);g=function(){a.focus()};e.addEventListener("focus",g);f.addEventListener("focus",g);a[0].parentNode.insertBefore(e,a[0]);a.after(f)}function C(a,b){function c(a){a:{for(var b=
[];a.parentNode;){if(a===document.body){a=b;break a}for(var c=a.parentNode.children,e=0;e<c.length;e++){var f;(f=a===c[e])||(f=["SCRIPT","STYLE"],f=-1!==f.indexOf(c[e].nodeName)?!0:void 0);f||c[e].hasAttribute("aria-live")||b.push(c[e])}a=a.parentNode}a=b}for(b=0;b<a.length;b++)a[b].setAttribute("aria-hidden",d)}var d=!0;c(a[0]);b.unlockScreenReader=function(){d=!1;c(a[0]);b.unlockScreenReader=null}}function N(a,b){var c="fixed"==r.getComputedStyle(l[0].body).position,d=b.backdrop?r.getComputedStyle(b.backdrop[0]):
null;d=d?Math.min(l[0].body.clientHeight,Math.ceil(Math.abs(parseInt(d.height,10)))):0;var e={top:a.css("top"),height:a.css("height")};b=Math.abs(b.parent[0].getBoundingClientRect().top);a.css({top:(c?b:0)+"px",height:d?d+"px":"100%"});return function(){a.css(e)}}function K(a,b){b.parent.append(a);b.reverseContainerStretch=N(a,b);var d=a.find("md-dialog"),e=c.dom.animator,f=e.calculateZoomToOrigin,g={transitionInClass:"md-transition-in",transitionOutClass:"md-transition-out"},h=e.toTransformCss(f(d,
b.openFrom||b.origin)),k=e.toTransformCss("");d.toggleClass("md-dialog-fullscreen",!!b.fullscreen);return e.translate3d(d,h,k,g).then(function(a){b.reverseAnimate=function(){delete b.reverseAnimate;return b.closeTo?(g={transitionInClass:"md-transition-out",transitionOutClass:"md-transition-in"},h=k,k=e.toTransformCss(f(d,b.closeTo)),e.translate3d(d,h,k,g)):a(k=e.toTransformCss(f(d,b.origin)))};b.clearAnimate=function(){delete b.clearAnimate;d.removeClass([g.transitionOutClass,g.transitionInClass].join(" "));
return e.translate3d(d,k,e.toTransformCss(""),{})};return!0})}function L(a,b){return b.reverseAnimate().then(function(){b.contentElement&&b.clearAnimate()})}return{hasBackdrop:!0,isolateScope:!0,onCompiling:g,onShow:k,onShowing:h,onRemove:n,clickOutsideToClose:!1,escapeToClose:!0,targetEvent:null,closeTo:null,openFrom:null,focusOnOpen:!0,disableParentScroll:!0,autoWrap:!0,fullscreen:!1,transformTemplate:function(a,b){var c=p.startSymbol(),d=p.endSymbol();c=c+(b.themeWatch?"":"::")+"theme"+d;c=b.hasTheme?
'md-theme="'+c+'"':"";b=b.autoWrap&&!/<\/md-dialog>/g.test(a)?"<md-dialog>"+(a||"")+"</md-dialog>":a||"";return'<div class="md-dialog-container" tabindex="-1" '+c+">"+b+"</div>"}}}c.$inject=["$mdDialog","$mdConstant"];d.$inject="$mdDialog $mdAria $mdUtil $mdConstant $animate $document $window $rootElement $log $injector $mdTheming $interpolate $mdInteraction".split(" ");var e,f;return a("$mdDialog").setDefaults({methods:"disableParentScroll hasBackdrop clickOutsideToClose escapeToClose targetEvent closeTo openFrom parent fullscreen multiple".split(" "),
options:d}).addPreset("alert",{methods:"title htmlContent textContent content ariaLabel ok theme css".split(" "),options:b}).addPreset("confirm",{methods:"title htmlContent textContent content ariaLabel ok cancel theme css".split(" "),options:b}).addPreset("prompt",{methods:"title htmlContent textContent initialValue content placeholder ariaLabel ok cancel theme css required".split(" "),options:b})}ngmaterial.components.dialog=angular.module("material.components.dialog");MdDividerDirective.$inject=["$mdTheming"];angular.module("material.components.divider",["material.core"]).directive("mdDivider",MdDividerDirective);function MdDividerDirective(a){return{restrict:"E",link:a}}ngmaterial.components.divider=angular.module("material.components.divider");(function(){function a(a){return{restrict:"E",require:["^?mdFabSpeedDial","^?mdFabToolbar"],compile:function(b){b=b.children();var c=a.prefixer().hasAttribute(b,"ng-repeat");c?b.addClass("md-fab-action-item"):b.wrap('<div class="md-fab-action-item">')}}}a.$inject=["$mdUtil"];angular.module("material.components.fabActions",["material.core"]).directive("mdFabActions",a)})();ngmaterial.components.fabActions=angular.module("material.components.fabActions");(function(){function a(a,c,d,e,f,g){function b(){var b=["click","focusin","focusout"];angular.forEach(b,function(a){c.on(a,k)});a.$on("$destroy",function(){angular.forEach(b,function(a){c.off(a,k)});r()})}function k(a){"click"==a.type&&p(a);"focusout"!=a.type||A||(A=g(function(){y.close()},100,!1));"focusin"==a.type&&A&&(g.cancel(A),A=null)}function n(){a.$watch("vm.direction",function(a,b){d.removeClass(c,"md-"+b);d.addClass(c,"md-"+a);y.currentActionIndex=-1});var b,e;a.$watch("vm.isOpen",function(a){y.currentActionIndex=
-1;b&&e||(b=c.find("md-fab-trigger"),e=c.find("md-fab-actions"));a?l():r();var f=a?"md-is-open":"",g=a?"":"md-is-open";b.attr("aria-haspopup",!0);b.attr("aria-expanded",a);e.attr("aria-hidden",!a);d.setClass(c,f,g)})}function q(){0<c[0].scrollHeight?d.addClass(c,"_md-animations-ready").then(function(){c.removeClass("md-animations-waiting")}):10>z&&(g(q,100),z+=1)}function l(){c.on("keydown",v);e.nextTick(function(){angular.element(document).on("click touchend",m)})}function r(){c.off("keydown",v);
angular.element(document).off("click touchend",m)}function m(a){if(a.target){var b=e.getClosest(a.target,"md-fab-trigger");a=e.getClosest(a.target,"md-fab-actions");b||a||y.close()}}function v(a){switch(a.which){case f.KEY_CODE.ESCAPE:return y.close(),a.preventDefault(),!1;case f.KEY_CODE.LEFT_ARROW:return"left"===y.direction?w(a,1):w(a,-1),!1;case f.KEY_CODE.UP_ARROW:return"down"===y.direction?w(a,-1):w(a,1),!1;case f.KEY_CODE.RIGHT_ARROW:return"left"===y.direction?w(a,-1):w(a,1),!1;case f.KEY_CODE.DOWN_ARROW:return"up"===
y.direction?w(a,-1):w(a,1),!1}}function w(a,b){var c=t();y.currentActionIndex+=b;y.currentActionIndex=Math.min(c.length-1,y.currentActionIndex);y.currentActionIndex=Math.max(0,y.currentActionIndex);b=angular.element(c[y.currentActionIndex]).children()[0];angular.element(b).attr("tabindex",0);b.focus();a.preventDefault();a.stopImmediatePropagation()}function t(){var a=c.find("md-fab-actions")[0].querySelectorAll(".md-fab-action-item");angular.forEach(a,function(a){angular.element(angular.element(a).children()[0]).attr("tabindex",
-1)});return a}function p(a){e.getClosest(a.target,"md-fab-trigger")&&y.toggle();e.getClosest(a.target,"md-fab-actions")&&y.close()}var y=this,z=0;y.open=function(){a.$evalAsync("vm.isOpen = true")};y.close=function(){a.$evalAsync("vm.isOpen = false");c.find("md-fab-trigger")[0].focus()};y.toggle=function(){a.$evalAsync("vm.isOpen = !vm.isOpen")};y.$onInit=function(){y.direction=y.direction||"down";y.isOpen=y.isOpen||!1;y.currentActionIndex=-1;c.addClass("md-animations-waiting");b();n();q()};1===
...
var f=parseInt(window.getComputedStyle(a).zIndex);angular.forEach(d,function(a,b){a=a.style;a.transform=a.webkitTransform="";a.transitionDelay="";a.opacity=1;a.zIndex=d.length-b+f});e.style.zIndex=f+d.length+1;c.isOpen||angular.forEach(d,function(a,b){var d=a.style,f=(e.clientHeight-a.clientHeight)/2,g=(e.clientWidth-a.clientWidth)/2;switch(c.direction){case "up":var h=a.scrollHeight*(b+1)+f;var k="Y";break;case "down":h=-(a.scrollHeight*(b+1)+f);k="Y";break;case "left":h=a.scrollWidth*(b+1)+g;k=
"X";break;case "right":h=-(a.scrollWidth*(b+1)+g),k="X"}a="translate"+k+"("+h+"px)";d.transform=d.webkitTransform=a})}}return{addClass:function(c,e,f){c.hasClass("md-fling")?(b(c),a(f,d,!1)):f()},removeClass:function(c,e,f){b(c);a(f,d,!1)}}}function c(a){function b(a){var b=a[0],c=a.controller("mdFabSpeedDial"),d=b.querySelectorAll(".md-fab-action-item");a=b.querySelector("._md-css-variables");var e=parseInt(window.getComputedStyle(a).zIndex);angular.forEach(d,function(a,b){a=a.style;var f=65*b;a.opacity=
...
var d=c.querySelector(".md-fab-toolbar-background"),e=c.querySelector("md-fab-trigger button"),k=c.querySelector("md-toolbar"),n=c.querySelector("md-fab-trigger button md-icon"),q=a.find("md-fab-actions").children();if(e&&d){var l=window.getComputedStyle(e).getPropertyValue("background-color");c=c.offsetWidth;var r=c/e.offsetWidth*2;d.style.backgroundColor=l;d.style.borderRadius=c+"px";b.isOpen?(k.style.pointerEvents="inherit",d.style.width=e.offsetWidth+"px",d.style.height=e.offsetHeight+"px",d.style.transform=
"scale("+r+")",d.style.transitionDelay="0ms",n&&(n.style.transitionDelay=".3s"),angular.forEach(q,function(a,b){a.style.transitionDelay=25*(q.length-b)+"ms"})):(k.style.pointerEvents="none",d.style.transform="scale(1)",d.style.top="0",a.hasClass("md-right")&&(d.style.left="0",d.style.right=null),a.hasClass("md-left")&&(d.style.right="0",d.style.left=null),d.style.transitionDelay="200ms",n&&(n.style.transitionDelay="0ms"),angular.forEach(q,function(a,b){a.style.transitionDelay=200+25*b+"ms"}))}}}return{addClass:function(b,
...
function GridListDirective(a,b,c,d){function e(e,g,h,k){function f(){for(var a in b.MEDIA)d(a),d.getQuery(b.MEDIA[a]).addListener(A);return d.watchResponsiveAttributes(["md-cols","md-row-height","md-gutter"],h,l)}function q(){k.layoutDelegate=angular.noop;D();for(var a in b.MEDIA)d.getQuery(b.MEDIA[a]).removeListener(A)}function l(a){null==a?k.invalidateLayout():d(a)&&k.invalidateLayout()}function r(a){var b=v(),f={tileSpans:w(b),colCount:t(),rowMode:y(),rowHeight:p(),gutter:z(d.getResponsiveAttribute(h,
"md-gutter")||1)};if(a||!angular.equals(f,B))a=c(f.colCount,f.tileSpans,b).map(function(a,c){return{grid:{element:g,style:m(f.colCount,c,f.gutter,f.rowMode,f.rowHeight)},tiles:a.map(function(a,d){d=angular.element(b[d]);var e=a.position;a=a.spans;var g=f.colCount,h=c,k=f.gutter,l=f.rowMode,p=f.rowHeight,m=1/g*100;g=(g-1)/g;var t=F({share:m,gutterShare:g,gutter:k}),n="rtl"!=document.dir&&"rtl"!=document.body.dir;t=n?{left:H({unit:t,offset:e.col,gutter:k}),width:J({unit:t,span:a.col,gutter:k}),paddingTop:"",
marginTop:"",top:"",height:""}:{right:H({unit:t,offset:e.col,gutter:k}),width:J({unit:t,span:a.col,gutter:k}),paddingTop:"",marginTop:"",top:"",height:""};switch(l){case "fixed":t.top=H({unit:p,offset:e.row,gutter:k});t.height=J({unit:p,span:a.row,gutter:k});break;case "ratio":h=m/p;h=F({share:h,gutterShare:g,gutter:k});t.paddingTop=J({unit:h,span:a.row,gutter:k});t.marginTop=H({unit:h,offset:e.row,gutter:k});break;case "fit":l=(h-1)/h,h=1/h*100,h=F({share:h,gutterShare:l,gutter:k}),t.top=H({unit:h,
offset:e.row,gutter:k}),t.height=J({unit:h,span:a.row,gutter:k})}e=t;return{element:d,style:e}})}}).reflow().performance(),e.mdOnLayout({$event:{performance:a}}),B=f}function m(a,b,c,d,e){var f={};switch(d){case "fixed":f.height=J({unit:e,span:b,gutter:c});f.paddingBottom="";break;case "ratio":d=1===a?0:(a-1)/a,a=1/a*100,e=1/e*a,e=F({share:e,gutterShare:d,gutter:c}),f.height="",f.paddingBottom=J({unit:e,span:b,gutter:c})}return f}function v(){return[].filter.call(g.children(),function(a){return"MD-GRID-TILE"==
a.tagName&&!a.$$mdDestroyed})}function w(a){return[].map.call(a,function(a){a=angular.element(a).controller("mdGridTile");return{row:parseInt(d.getResponsiveAttribute(a.$attrs,"md-rowspan"),10)||1,col:parseInt(d.getResponsiveAttribute(a.$attrs,"md-colspan"),10)||1}})}function t(){var a=parseInt(d.getResponsiveAttribute(h,"md-cols"),10);if(isNaN(a))throw"md-grid-list: md-cols attribute was not found, or contained a non-numeric value";return a}function p(){var a=d.getResponsiveAttribute(h,"md-row-height");
if(!a)throw"md-grid-list: md-row-height attribute was not found";switch(y()){case "fixed":return z(a);case "ratio":return a=a.split(":"),parseFloat(a[0])/parseFloat(a[1]);case "fit":return 0}}function y(){var a=d.getResponsiveAttribute(h,"md-row-height");if(!a)throw"md-grid-list: md-row-height attribute was not found";return"fit"==a?"fit":-1!==a.indexOf(":")?"ratio":"fixed"}function z(a){return/\D$/.test(a)?a:a+"px"}g.addClass("_md");g.attr("role","list");k.layoutDelegate=r;var A=angular.bind(k,k.invalidateLayout),
D=f();e.$on("$destroy",q);var B,E=a.startSymbol(),G=a.endSymbol(),F=a(E+"share"+G+"% - ("+(E+"gutter"+G)+" * "+(E+"gutterShare"+G)+")"),H=a("calc(("+(E+"unit"+G)+" + "+(E+"gutter"+G)+") * "+(E+"offset"+G)+")"),J=a("calc(("+(E+"unit"+G)+") * "+(E+"span"+G)+" + ("+(E+"span"+G)+" - 1) * "+(E+"gutter"+G)+")")}return{restrict:"E",controller:GridListController,scope:{mdOnLayout:"&"},link:e}}
...
function GridLayoutFactory(a){function b(b,c){var f,g,n,q,l;var r=a.time(function(){g=d(b,c)});return f={layoutInfo:function(){return g},map:function(b){q=a.time(function(){var a=f.layoutInfo();n=b(a.positioning,a.rowCount)});return f},reflow:function(b){l=a.time(function(){var a=b||e;a(n.grid,n.tiles)});return f},performance:function(){return{tileCount:c.length,layoutTime:r,mapTime:q,reflowTime:l,totalTime:r+q+l}}}}function c(a,b){a.element.css(a.style);b.forEach(function(a){a.element.css(a.style)})}
function d(a,b){function c(a,b,c){for(var d=a;d<a+b;d++)g[d]=Math.max(g[d]+c,0)}function d(){for(var b=[],c=0;c<a;c++)b.push(0);return b}var e=0,f=0,g=d();return{positioning:b.map(function(b,d){var h=b;if(h.col>a)throw"md-grid-list: Tile at position "+d+" has a colspan ("+h.col+") that exceeds the column count ("+a+")";for(var k=d=0;k-d<h.col;)if(e>=a)e=0,f++,c(0,a,-1);else{d=g.indexOf(0,e);var l;if(!(l=-1===d)){a:{for(k=d+1;k<g.length;k++)if(0!==g[k])break a;k=k===g.length?k:void 0}l=-1===k}l?(e=
d=k=0,f++,c(0,a,-1)):e=k+1}c(d,h.col,h.row);e=d+h.col;h={col:d,row:f};return{spans:b,position:h}}),rowCount:f+Math.max.apply(Math,g)}}var e=c;b.animateWith=function(a){e=angular.isFunction(a)?a:c};return b}
...
function inputTextareaDirective(a,b,c,d,e){function f(f,h,k,n){function g(a){v.setHasValue(!t.$isEmpty(a));return a}function l(){v.label&&k.$observe("required",function(a){v.label.toggleClass("md-required",a&&!y)})}function r(){v.setHasValue(0<h.val().length||(h[0].validity||{}).badInput)}function m(){function c(){h.attr("rows",1).css("height","auto").addClass("md-no-flex");var a=A.offsetHeight;var b=A.scrollHeight-a;a+=Math.max(b,0);r||(b=h[0].style.padding||"",r=h.css("padding",0).prop("offsetHeight"),
h[0].style.padding=b);n&&r&&(a=Math.max(a,r*n));q&&r&&(b=r*q,b<a?(h.attr("md-no-autogrow",""),a=b):h.removeAttr("md-no-autogrow"));r&&h.attr("rows",Math.round(a/r));h.css("height",a+"px").removeClass("md-no-flex")}function g(b){a.nextTick(c);return b}function l(){if(m&&(m=!1,angular.element(b).off("resize",c),y&&y(),h.attr("md-no-autogrow","").off("input",c),w)){var a=t.$formatters.indexOf(g);-1<a&&t.$formatters.splice(a,1)}}function p(){function a(a){a.preventDefault();p=!0;t=parseFloat(h.css("height"))||
h.prop("offsetHeight")}function b(a){p&&(a.preventDefault(),l(),m.addClass("md-input-resized"))}function c(a){p&&h.css("height",t+a.pointer.distanceY+"px")}function d(){p&&(p=!1,m.removeClass("md-input-resized"))}if(!k.hasOwnProperty("mdNoResize")){var g=angular.element('<div class="md-resize-handle"></div>'),p=!1,t=0,m=v.element,n=e.register(g,"drag",{horizontal:!1});h.wrap('<div class="md-resize-wrapper">').after(g);g.on("mousedown",a);m.on("$md.dragstart",b).on("$md.drag",c).on("$md.dragend",d);
f.$on("$destroy",function(){g.off("mousedown",a).remove();m.off("$md.dragstart",b).off("$md.drag",c).off("$md.dragend",d);n();n=m=g=null})}}var m=!k.hasOwnProperty("mdNoAutogrow");p();if(m){var n=k.hasOwnProperty("rows")?parseInt(k.rows):NaN,q=k.hasOwnProperty("maxRows")?parseInt(k.maxRows):NaN,y=f.$on("md-resize-textarea",c),r=null,A=h[0];d(function(){a.nextTick(c)},10,!1);h.on("input",c);w&&t.$formatters.push(g);n||h.attr("rows",1);angular.element(b).on("resize",c);f.$on("$destroy",l);if(k.hasOwnProperty("mdDetectHidden")){var z=
function(){var a=!1;return function(){var b=0===A.offsetHeight;!1===b&&!0===a&&c();a=b}}();f.$watch(function(){a.nextTick(z,!1);return!0})}}}var v=n[0],w=!!n[1],t=n[1]||a.fakeNgModel(),p=n[2];n=angular.isDefined(k.readonly);var y=a.parseAttributeBoolean(k.mdNoAsterisk),z=h[0].tagName.toLowerCase();if(v)if("hidden"===k.type)h.attr("aria-hidden","true");else{if(v.input){if(v.input[0].contains(h[0]))return;throw Error("<md-input-container> can only have *one* <input>, <textarea> or <md-select> child element!");
}v.input=h;l();var A=angular.element('<div class="md-errors-spacer">');h.after(A);A=angular.isString(k.placeholder)?k.placeholder.trim():"";v.label||A.length||c.expect(h,"aria-label");h.addClass("md-input");h.attr("id")||h.attr("id","input_"+a.nextUid());"input"===z&&"number"===k.type&&k.min&&k.max&&!k.step?h.attr("step","any"):"textarea"===z&&m();w||r();z=v.isErrorGetter||function(){return t.$invalid&&(t.$touched||p&&p.$submitted)};f.$watch(z,v.setInvalid);k.ngValue&&k.$observe("value",r);t.$parsers.push(g);
t.$formatters.push(g);h.on("input",r);if(!n)h.on("focus",function(){a.nextTick(function(){v.setFocused(!0)})}).on("blur",function(){a.nextTick(function(){v.setFocused(!1);r()})});f.$on("$destroy",function(){v.setFocused(!1);v.setHasValue(!1);v.input=null})}}return{restrict:"E",require:["^?mdInputContainer","?ngModel","?^form"],link:f}}
function mdMaxlengthDirective(a,b){function c(c,e,f,g){function d(a){a=v&&!w&&angular.isString(a)?a.trim():a;if(void 0===a||null===a)a="";return String(a).length}function k(){r&&r.parent()&&r.text(d(e.val())+" / "+n)}var n=parseInt(f.mdMaxlength);isNaN(n)&&(n=-1);var q=g[0],l=g[1],r,m,v=angular.isDefined(f.ngTrim)?b.parseAttributeBoolean(f.ngTrim):!0,w="password"===f.type;c.$watch(f.mdMaxlength,function(a){n=a});q.$validators["md-maxlength"]=function(a,b){if(!angular.isNumber(n)||0>n)return!0;k();
a=e.val()||b;if(void 0===a||null===a)a="";a=v&&!w&&angular.isString(a)?a.trim():a;return String(a).length<=n};q.$isEmpty=function(a){return 0===d(a)};b.nextTick(function(){m=angular.element(l.element[0].querySelector(".md-errors-spacer"));r=angular.element('<div class="md-char-counter">');m.append(r);f.$observe("ngTrim",function(a){v=angular.isDefined(a)?b.parseAttributeBoolean(a):!0});c.$watch(f.mdMaxlength,function(b){angular.isNumber(b)&&0<b?(r.parent().length||a.enter(r,m),k()):a.leave(r)})})}
return{restrict:"A",require:["ngModel","^mdInputContainer"],link:c}}
function placeholderDirective(a){function b(b,d,e,f){if(f){var c=f.element.find("label"),h=f.element.attr("md-no-float");c&&c.length||""===h||b.$eval(h)?f.setHasPlaceholder(!0):"MD-SELECT"!=d[0].nodeName&&(d=angular.element('<label ng-click="delegateClick()" tabindex="-1">'+e.placeholder+"</label>"),e.$set("placeholder",null),f.element.addClass("md-icon-float").prepend(d),a(d)(b))}}return{restrict:"A",require:"^^?mdInputContainer",priority:200,link:{pre:b}}}
function mdSelectOnFocusDirective(a,b){function c(c,e){function d(){h=!0;b(function(){a[0].activeElement===e[0]&&e[0].select();h=!1},1,!1)}function g(a){h&&a.preventDefault()}if("INPUT"===e[0].nodeName||"TEXTAREA"===e[0].nodeName){var h=!1;e.on("focus",d).on("mouseup",g);c.$on("$destroy",function(){e.off("focus",d).off("mouseup",g)})}}return{restrict:"A",link:c}}var visibilityDirectives=["ngIf","ngShow","ngHide","ngSwitchWhen","ngSwitchDefault"];
...
function mdListItemDirective(a,b,c,d){var e=["md-checkbox","md-switch","md-menu"];return{restrict:"E",controller:"MdListController",compile:function(f,g){function h(){for(var a=["md-switch","md-checkbox"],b,c=0,d;d=a[c];++c)if((b=f.find(d)[0])&&!b.hasAttribute("aria-label")){d=f.find("p")[0];if(!d)break;b.setAttribute("aria-label","Toggle "+d.textContent)}}function k(){var a=angular.element(w),b=a.parent().hasClass("md-secondary-container")||w.parentNode.firstElementChild!==w,c="left";b&&(c="right");
a.attr("md-position-mode")||a.attr("md-position-mode",c+" target");a=a.children().eq(0);r(a[0])||a.attr("ng-click","$mdMenu.open($event)");a.attr("aria-label")||a.attr("aria-label","Open List Menu")}function n(b){"div"==b?(t=angular.element('<div class="md-no-style md-list-item-inner">'),t.append(f.contents()),f.addClass("md-proxy-focus")):(t=angular.element('<div class="md-button md-no-style">   <div class="md-list-item-inner"></div></div>'),b=angular.element('<md-button class="md-no-style"></md-button>'),
l(f[0],b[0]),b.attr("aria-label")||b.attr("aria-label",a.getText(f)),f.hasClass("md-no-focus")&&b.addClass("md-no-focus"),t.prepend(b),t.children().eq(1).append(f.contents()),f.addClass("_md-button-wrap"));f[0].setAttribute("tabindex","-1");f.append(t)}function q(){var b=angular.element('<div class="md-secondary-container">');angular.forEach(v,function(c){var d=b,h;if(h=c)h=c.nodeName.toUpperCase(),h="MD-BUTTON"==h||"BUTTON"==h,h=!h;h&&c.hasAttribute("ng-click")&&(a.expect(c,"aria-label"),h=angular.element('<md-button class="md-secondary md-icon-button">'),
l(c,h[0],["ng-if","ng-hide","ng-show"]),c.setAttribute("tabindex","-1"),h.append(c),c=h[0]);c&&(!r(c)||!g.ngClick&&-1!=e.indexOf(c.nodeName.toLowerCase()))&&angular.element(c).removeClass("md-secondary");f.addClass("md-with-secondary");d.append(c)});t.append(b)}function l(a,b,d){var e=c.prefixer("ng-if ng-click ng-dblclick aria-label ng-disabled ui-sref href ng-href rel target ng-attr-ui-sref ui-sref-opts download".split(" "));d&&(e=e.concat(c.prefixer(d)));angular.forEach(e,function(c){a.hasAttribute(c)&&
(b.setAttribute(c,a.getAttribute(c)),a.removeAttribute(c))})}function r(a){a=a.attributes;for(var b=0;b<a.length;b++)if("ngClick"===g.$normalize(a[b].name))return!0;return!1}function m(a,f,g,h){function k(){m&&m.children&&!t&&!q&&angular.forEach(e,function(a){angular.forEach(m.querySelectorAll(a+":not(.md-secondary)"),function(a){p.push(a)})})}function l(a){var b=["md-slider"];if(!a.path)return-1!==b.indexOf(a.target.tagName.toLowerCase());for(var c=a.path.indexOf(f.children()[0]),d=0;d<c;d++)if(-1!==
b.indexOf(a.path[d].tagName.toLowerCase()))return!0}f.addClass("_md");var p=[],m=f[0].firstElementChild,n=(g=f.hasClass("_md-button-wrap"))?m.firstElementChild:m,t=n&&r(n),q=f.hasClass("md-no-proxy");k();if(1==p.length||t)f.addClass("md-clickable"),t||h.attachRipple(a,angular.element(f[0].querySelector(".md-no-style")));p.length&&angular.forEach(p,function(b){b=angular.element(b);a.mouseActive=!1;b.on("mousedown",function(){a.mouseActive=!0;d(function(){a.mouseActive=!1},100)}).on("focus",function(){!1===
a.mouseActive&&f.addClass("md-focused");b.on("blur",function S(){f.removeClass("md-focused");b.off("blur",S)})})});var y=function(a){if("INPUT"!=a.target.nodeName&&"TEXTAREA"!=a.target.nodeName&&!a.target.isContentEditable){var c=a.which||a.keyCode;c==b.KEY_CODE.SPACE&&n&&(n.click(),a.preventDefault(),a.stopPropagation())}};t||p.length||n&&n.addEventListener("keypress",y);f.off("click");f.off("keypress");if(1==p.length&&n)f.children().eq(0).on("click",function(a){if(!l(a)){var b=c.getClosest(a.target,
"BUTTON");!b&&n.contains(a.target)&&angular.forEach(p,function(b){a.target===b||b.contains(a.target)||("MD-MENU"===b.nodeName&&(b=b.children[0]),angular.element(b).triggerHandler("click"))})}});a.$on("$destroy",function(){n&&n.removeEventListener("keypress",y)})}var v=f[0].querySelectorAll(".md-secondary"),w,t=f;f[0].setAttribute("role","listitem");if(g.ngClick||g.ngDblclick||g.ngHref||g.href||g.uiSref||g.ngAttrUiSref)n("button");else if(!f.hasClass("md-no-proxy")){for(var p=0,y;y=e[p];++p)if(w=f[0].querySelector(y)){var z=
!0;break}z?n("div"):f.addClass("md-no-proxy")}q();h();z&&"MD-MENU"===w.nodeName&&k();return m}}}function MdListController(a,b,c){function d(a,b){var d={};c.attach(a,b,d)}a=this;a.attachRipple=d}ngmaterial.components.list=angular.module("material.components.list");angular.module("material.components.menu",["material.core","material.components.backdrop"]);MenuController.$inject="$mdMenu $attrs $element $scope $mdUtil $timeout $rootScope $q $log".split(" ");angular.module("material.components.menu").controller("mdMenuCtrl",MenuController);
function MenuController(a,b,c,d,e,f,g,h,k){var n=e.prefixer(),q,l=this,r;this.nestLevel=parseInt(b.mdNestLevel,10)||0;this.init=function(b,f){f=f||{};q=b;r=c[0].querySelector(n.buildSelector(["ng-click","ng-mouseenter"]));r.setAttribute("aria-expanded","false");this.isInMenuBar=f.isInMenuBar;this.nestedMenus=e.nodesToArray(q[0].querySelectorAll(".md-nested-menu"));q.on("$mdInterimElementRemove",function(){l.isOpen=!1;e.nextTick(function(){l.onIsOpenChanged(l.isOpen)})});e.nextTick(function(){l.onIsOpenChanged(l.isOpen)});
b="menu_container_"+e.nextUid();q.attr("id",b);angular.element(r).attr({"aria-owns":b,"aria-haspopup":"true"});d.$on("$destroy",angular.bind(this,function(){this.disableHoverListener();a.destroy()}));q.on("$destroy",function(){a.destroy()})};var m,v,w=[];this.enableHoverListener=function(){w.push(g.$on("$mdMenuOpen",function(a,b){q[0].contains(b[0])&&(l.currentlyOpenMenu=b.controller("mdMenu"),l.isAlreadyOpening=!1,l.currentlyOpenMenu.registerContainerProxy(l.triggerContainerProxy.bind(l)))}));w.push(g.$on("$mdMenuClose",
function(a,b){q[0].contains(b[0])&&(l.currentlyOpenMenu=void 0)}));v=angular.element(e.nodesToArray(q[0].children[0].children));v.on("mouseenter",l.handleMenuItemHover);v.on("mouseleave",l.handleMenuItemMouseLeave)};this.disableHoverListener=function(){for(;w.length;)w.shift()();v&&v.off("mouseenter",l.handleMenuItemHover);v&&v.off("mouseleave",l.handleMenuItemMouseLeave)};this.handleMenuItemHover=function(a){if(!l.isAlreadyOpening){var b=a.target.querySelector("md-menu")||e.getClosest(a.target,"MD-MENU");
m=f(function(){b&&(b=angular.element(b).controller("mdMenu"));if(l.currentlyOpenMenu&&l.currentlyOpenMenu!=b){var a=l.nestLevel+1;l.currentlyOpenMenu.close(!0,{closeTo:a});l.isAlreadyOpening=!!b;b&&b.open()}else b&&!b.isOpen&&b.open&&(l.isAlreadyOpening=!!b,b&&b.open())},b?100:250);(a=a.currentTarget.querySelector(".md-button:not([disabled])"))&&a.focus()}};this.handleMenuItemMouseLeave=function(){m&&(f.cancel(m),m=void 0)};this.open=function(b){b&&b.stopPropagation();b&&b.preventDefault();l.isOpen||
(l.enableHoverListener(),l.isOpen=!0,e.nextTick(function(){l.onIsOpenChanged(l.isOpen)}),r=r||(b?b.target:c[0]),r.setAttribute("aria-expanded","true"),d.$emit("$mdMenuOpen",c),a.show({scope:d,mdMenuCtrl:l,nestLevel:l.nestLevel,element:q,target:r,preserveElement:!0,parent:"body"})["finally"](function(){r.setAttribute("aria-expanded","false");l.disableHoverListener()}))};this.onIsOpenChanged=function(a){a?(q.attr("aria-hidden","false"),c[0].classList.add("md-open"),angular.forEach(l.nestedMenus,function(a){a.classList.remove("md-open")})):
(q.attr("aria-hidden","true"),c[0].classList.remove("md-open"));d.$mdMenuIsOpen=l.isOpen};this.focusMenuContainer=function(){var a=q[0].querySelector(n.buildSelector(["md-menu-focus-target","md-autofocus"]));a||(a=q[0].querySelector(".md-button:not([disabled])"));a.focus()};this.registerContainerProxy=function(a){this.containerProxy=a};this.triggerContainerProxy=function(a){this.containerProxy&&this.containerProxy(a)};this.destroy=function(){return l.isOpen?a.destroy():h.when(!1)};this.close=function(b,
...
top:a[1]};if(1===a.length)return{top:a[0],left:a[0]};throw Error("Invalid offsets specified. Please follow format <x, y> or <n>");};d.$mdMenu={open:this.open,close:this.close};d.$mdOpenMenu=angular.bind(this,function(){k.warn("mdMenu: The $mdOpenMenu method is deprecated. Please use `$mdMenu.open`.");return this.open.apply(this,arguments)})}MenuDirective.$inject=["$mdUtil"];angular.module("material.components.menu").directive("mdMenu",MenuDirective);
...
function MenuProvider(a){function b(a,b,f,g,h,k,n,q,l,r){function d(b,c,d){if(d.nestLevel)return angular.noop;d.disableParentScroll&&!a.getClosest(d.target,"MD-DIALOG")?d.restoreScroll=a.disableScrollAround(d.element,d.parent):d.disableParentScroll=!1;d.hasBackdrop&&(d.backdrop=a.createBackdrop(b,"md-menu-backdrop md-click-catcher"),l.enter(d.backdrop,g[0].body));return function(){d.backdrop&&d.backdrop.remove();d.disableParentScroll&&d.restoreScroll()}}function e(a,b,d){function f(){b.removeClass("md-active");
var a=b,f=d;f.preserveElement?c(a).style.display="none":c(a).parentNode===c(f.parent)&&c(f.parent).removeChild(c(a));d.alreadyOpen=!1}d.cleanupInteraction();d.cleanupBackdrop();d.cleanupResizing();d.hideBackdrop();b.removeClass("md-clickable");return!0===d.$destroy?f():q(b,{addClass:"md-leave"}).start().then(f)}function w(c,e,g){function l(){g.parent.append(e);e[0].style.display="";return k(function(a){var b=p(e,g);e.removeClass("md-leave");q(e,{addClass:"md-active",from:z.toCss(b),to:z.toCss({transform:""})}).start().then(a)})}
function m(){var a=function(a,b){return n.throttle(function(){if(!g.isRemoved){var c=p(a,b);a.css(z.toCss(c))}})}(e,g);h.addEventListener("resize",a);h.addEventListener("orientationchange",a);return function(){h.removeEventListener("resize",a);h.removeEventListener("orientationchange",a)}}function v(){if(!g.backdrop)return angular.noop;g.backdrop.on("click",w);return function(){g.backdrop.off("click",w)}}function w(a){a.preventDefault();a.stopPropagation();c.$apply(function(){g.mdMenuCtrl.close(!0,
{closeAll:!0})})}function A(){function b(b){switch(b.keyCode){case f.KEY_CODE.ESCAPE:g.mdMenuCtrl.close(!1,{closeAll:!0});var c=!0;break;case f.KEY_CODE.TAB:g.mdMenuCtrl.close(!1,{closeAll:!0});c=!1;break;case f.KEY_CODE.UP_ARROW:t(b,g.menuContentEl,g,-1)||g.nestLevel||g.mdMenuCtrl.triggerContainerProxy(b);c=!0;break;case f.KEY_CODE.DOWN_ARROW:t(b,g.menuContentEl,g,1)||g.nestLevel||g.mdMenuCtrl.triggerContainerProxy(b);c=!0;break;case f.KEY_CODE.LEFT_ARROW:g.nestLevel?g.mdMenuCtrl.close():g.mdMenuCtrl.triggerContainerProxy(b);
c=!0;break;case f.KEY_CODE.RIGHT_ARROW:(c=a.getClosest(b.target,"MD-MENU"))&&c!=g.parent[0]?b.target.click():g.mdMenuCtrl.triggerContainerProxy(b),c=!0}c&&(b.preventDefault(),b.stopImmediatePropagation())}function d(b){function d(){c.$apply(function(){g.mdMenuCtrl.close(!0,{closeAll:!0})})}function f(a,b){if(!a)return!1;for(var c=0,d;d=b[c];++c)if(y.hasAttribute(a,d))return!0;return!1}b=b.target;do{if(b==g.menuContentEl[0])break;if((f(b,["ng-click","ng-href","ui-sref"])||"BUTTON"==b.nodeName||"MD-BUTTON"==
b.nodeName)&&!f(b,["md-prevent-menu-close"])){var e=a.getClosest(b,"MD-MENU");b.hasAttribute("disabled")||e&&e!=g.parent[0]||d();break}}while(b=b.parentNode)}if(!g.menuContentEl[0])return angular.noop;g.menuContentEl.on("keydown",b);g.menuContentEl[0].addEventListener("click",d,!0);var e=g.menuContentEl[0].querySelector(y.buildSelector(["md-menu-focus-target","md-autofocus"]));if(!e)for(var h=g.menuContentEl[0].children.length,k=0;k<h;k++){var l=g.menuContentEl[0].children[k];if(e=l.querySelector(".md-button:not([disabled])"))break;
...
g.target):r.warn("$mdMenu: Menu elements should always contain a `md-menu-content` element,otherwise interactivity features will not work properly.",e);g.cleanupResizing=m();g.hideBackdrop=d(c,e,g);return l().then(function(a){g.alreadyOpen=!0;g.cleanupInteraction=A();g.cleanupBackdrop=v();e.addClass("md-clickable");return a})}function t(b,c,d,f){b=a.getClosest(b.target,"MD-MENU-ITEM");c=a.nodesToArray(c[0].children);b=c.indexOf(b);for(b+=f;0<=b&&b<c.length;b+=f){var e=c[b].querySelector(".md-button");
e&&-1!=e.getAttribute("tabindex")?(e.focus(),e=g[0].activeElement==e):e=void 0;if(e)break}return e}function p(b,c){function d(a){a.top=Math.max(Math.min(a.top,q.bottom-f.offsetHeight),q.top);a.left=Math.max(Math.min(a.left,q.right-f.offsetWidth),q.left)}function e(){for(var a=0;a<k.children.length;++a)if("none"!=h.getComputedStyle(k.children[a]).display)return k.children[a]}var f=b[0],k=b[0].firstElementChild,l=k.getBoundingClientRect();b=g[0].body;var m=b.getBoundingClientRect(),p=h.getComputedStyle(k),
n=c.target[0].querySelector(y.buildSelector("md-menu-origin"))||c.target[0];b=n.getBoundingClientRect();var q={left:m.left+8,top:Math.max(m.top,0)+8,bottom:Math.max(m.bottom,Math.max(m.top,0)+m.height)-8,right:m.right-8},r={top:0,left:0,right:0,bottom:0},t={top:0,left:0,right:0,bottom:0},v=c.mdMenuCtrl.positionMode();if("target"===v.top||"target"===v.left||"target-right"===v.left)if(m=e())m=m.firstElementChild||m,m=m.querySelector(y.buildSelector("md-menu-align-target"))||m,r=m.getBoundingClientRect(),
t={top:parseFloat(f.style.top||0),left:parseFloat(f.style.left||0)};m={};var w="top ";switch(v.top){case "target":m.top=t.top+b.top-r.top;break;case "cascade":m.top=b.top-parseFloat(p.paddingTop)-n.style.top;break;case "bottom":m.top=b.top+b.height;break;default:throw Error('Invalid target mode "'+v.top+'" specified for md-menu on Y axis.');}p="rtl"===a.bidi();switch(v.left){case "target":m.left=t.left+b.left-r.left;w+=p?"right":"left";break;case "target-left":m.left=b.left;w+="left";break;case "target-right":m.left=
b.right-l.width+(l.right-r.right);w+="right";break;case "cascade":p=p?b.left-l.width<q.left:b.right+l.width<q.right;m.left=p?b.right-n.style.left:b.left-n.style.left-l.width;w+=p?"left":"right";break;case "right":p?(m.left=b.right-b.width,w+="left"):(m.left=b.right-l.width,w+="right");break;case "left":p?(m.left=b.right-l.width,w+="right"):(m.left=b.left,w+="left");break;default:throw Error('Invalid target mode "'+v.left+'" specified for md-menu on X axis.');}l=c.mdMenuCtrl.offsets();m.top+=l.top;
m.left+=l.left;d(m);l=Math.round(100*Math.min(b.width/f.offsetWidth,1))/100;b=Math.round(100*Math.min(b.height/f.offsetHeight,1))/100;return{top:Math.round(m.top),left:Math.round(m.left),transform:c.alreadyOpen?void 0:a.supplant("scale({0},{1})",[l,b]),transformOrigin:w}}var y=a.prefixer(),z=a.dom.animator;return{parent:"body",onShow:w,onRemove:e,hasBackdrop:!0,disableParentScroll:!0,skipCompile:!0,preserveScope:!0,multiple:!0,themable:!0}}function c(a){a instanceof angular.element&&(a=a[0]);return a}
...
function MenuBarController(a,b,c,d,e,f,g,h){this.$element=c;this.$attrs=d;this.$mdConstant=e;this.$mdUtil=g;this.$document=f;this.$scope=a;this.$rootScope=b;this.$timeout=h;var k=this;angular.forEach(BOUND_MENU_METHODS,function(a){k[a]=angular.bind(k,k[a])})}
...
function(c,e,h){c=d.getMenus();-1!=c.indexOf(e[0])&&(a[0].classList.remove("md-open"),e[0].classList.remove("md-open"));if(a[0].contains(e[0])){for(e=e[0];e&&-1==c.indexOf(e);)e=b.getClosest(e,"MD-MENU",!0);e&&(h.skipFocus||e.querySelector("button:not([disabled])").focus(),d.currentlyOpenMenu=void 0,d.disableOpenOnHover(),d.setKeyboardMode(!0))}}));c.$on("$destroy",function(){for(d.disableOpenOnHover();e.length;)e.shift()()});this.setKeyboardMode(!0)};
...
f,g,h){var k;b(function(){var b=h[0],q=h[1],l=angular.element(f[0].querySelector("._md-nav-button"));b.name||(b.name=angular.element(f[0].querySelector("._md-nav-button-text")).text().trim());l.on("click",function(){q.mdSelectedNavItem=b.name;e.$apply()});b.disabled=c.parseAttributeBoolean(g.disabled,!1);if("MutationObserver"in d){l={attributes:!0,attributeFilter:["disabled"]};var r=f[0],m=function(a){c.nextTick(function(){b.disabled=c.parseAttributeBoolean(g[a[0].attributeName],!1)})};m=new MutationObserver(m);
m.observe(r,l);k=m.disconnect.bind(m)}else g.$observe("disabled",function(a){b.disabled=c.parseAttributeBoolean(a,!1)});a.expectWithText(f,"aria-label")});e.$on("destroy",function(){k()})}}}function MdNavItemController(a){this._$element=a;this._focused=this._selected=!1}MdNavItemController.prototype.getNgClassMap=function(){return{"md-active":this._selected,"md-primary":this._selected,"md-unselected":!this._selected,"md-focused":this._focused}};MdNavItemController.prototype.getName=function(){return this.name};
...
MdPanelRef.prototype._callInterceptors=function(a){var b=this,c=b._$q;a=b._interceptors&&b._interceptors[a]||[];return a.reduceRight(function(a,e){var d=e&&angular.isFunction(e.then),g=d?e:null;return a.then(function(){if(!g)try{g=e(b)}catch(h){g=c.reject(h)}return g})},c.resolve(b))};MdPanelRef.prototype._simpleBind=function(a,b){return function(c){return a.apply(b,c)}};MdPanelRef.prototype._done=function(a,b){return function(){a(b)}};
...
function MdProgressCircularDirective(a,b,c,d,e){function f(f,r,m){function l(c,e,g,h,l,m){function p(b){A.attr("stroke-dashoffset",(t-v)*a.Math.PI*(3*(H||100)/100-b/100));A.attr("transform","rotate("+C+" "+t/2+" "+t/2+")")}var q=++G,y=d.now(),r=e-c,t=k(f.mdDiameter),v=b.strokeWidth/100*t,w=g||b.easeFn,z=h||b.duration,C=-90*(l||0),H=m||100;e===c?p(e):F=n(function M(){var b=a.Math.max(0,a.Math.min(d.now()-y,z));p(w(b,c,r,z));q===G&&b<z&&(F=n(M))})}function w(){l(D,B,b.easeFnIndeterminate,b.durationIndeterminate,
E,75);E=++E%4}function t(){H||(H=e(w,b.durationIndeterminate,0,!1),w(),r.addClass("md-mode-indeterminate").removeAttr("aria-valuenow"))}function p(){H&&(e.cancel(H),H=null,r.removeClass("md-mode-indeterminate"))}var y=r[0],z=angular.element(y.querySelector("svg")),A=angular.element(y.querySelector("path")),D=b.startIndeterminate,B=b.endIndeterminate,E=0,G=0,F,H;c(r);r.toggleClass("_md-progress-circular-disabled",m.hasOwnProperty("disabled"));"indeterminate"===f.mdMode&&t();f.$on("$destroy",function(){p();
F&&q(F)});f.$watchGroup(["value","mdMode",function(){var a=y.disabled;return!0===a||!1===a?a:angular.isDefined(r.attr("disabled"))}],function(a,b){var c=a[1],d=a[2],e=b[2];d!==e&&r.toggleClass("_md-progress-circular-disabled",!!d);d?p():("determinate"!==c&&"indeterminate"!==c&&(c="indeterminate",m.$set("mdMode",c)),"indeterminate"===c?t():(a=h(a[0]),p(),r.attr("aria-valuenow",a),l(h(b[0]),a)))});f.$watch("mdDiameter",function(c){c=k(c);var d=b.strokeWidth/100*c,e=h(f.value),m=c/2+"px",p={width:c+
"px",height:c+"px"};z[0].setAttribute("viewBox","0 0 "+c+" "+c);z.css(p).css("transform-origin",m+" "+m+" "+m);r.css(p);A.attr("stroke-width",d);A.attr("stroke-linecap","square");"indeterminate"==f.mdMode?(A.attr("d",g(c,d,!0)),A.attr("stroke-dasharray",(c-d)*a.Math.PI*.75),A.attr("stroke-dashoffset",(c-d)*a.Math.PI*2.24)):(A.attr("d",g(c,d,!1)),A.attr("stroke-dasharray",(c-d)*a.Math.PI),A.attr("stroke-dashoffset",(c-d)*a.Math.PI*3),l(e,e))})}function g(a,b,c){a/=2;var d=b/2;b=a+","+d;var e=d+","+
a;a-=d;return"M"+b+"A"+a+","+a+" 0 1 1 "+e+(c?"":"A"+a+","+a+" 0 0 1 "+b)}function h(b){return a.Math.max(0,a.Math.min(b||0,100))}function k(a){var c=b.progressSize;if(a){var d=parseFloat(a);a.lastIndexOf("%")===a.length-1&&(d=d/100*c);return d}return c}var n=a.requestAnimationFrame||a.webkitRequestAnimationFrame||angular.noop,q=a.cancelAnimationFrame||a.webkitCancelAnimationFrame||a.webkitCancelRequestAnimationFrame||angular.noop;return{restrict:"E",scope:{value:"@",mdDiameter:"@",mdMode:"@"},template:'<svg xmlns="http://www.w3.org/2000/svg"><path fill="none"/></svg>',
...
function MdProgressLinearDirective(a,b){function c(a){a.attr("aria-valuemin",0);a.attr("aria-valuemax",100);a.attr("role","progressbar");return d}function d(c,d,g){function e(){g.$observe("value",function(a){a=Math.max(0,Math.min(a||0,100));d.attr("aria-valuenow",a);"query"!=n()&&q(w,a)});g.$observe("mdBufferValue",function(a){q(v,Math.max(0,Math.min(a||0,100)))});g.$observe("disabled",function(a){r=!0===a||!1===a?!!a:angular.isDefined(a);d.toggleClass("_md-progress-linear-disabled",r);t.toggleClass(l,
!r)});g.$observe("mdMode",function(a){l&&t.removeClass(l);switch(a){case "query":case "buffer":case "determinate":case "indeterminate":t.addClass(l="md-mode-"+a);break;default:t.addClass(l="md-mode-indeterminate")}})}function f(){if(angular.isUndefined(g.mdMode)){var a=angular.isDefined(g.value);a=a?"determinate":"indeterminate";d.attr("md-mode",a);g.mdMode=a}}function n(){var a=(g.mdMode||"").trim();if(a)switch(a){case "determinate":case "indeterminate":case "buffer":case "query":break;default:a=
"indeterminate"}return a}function q(a,c){!r&&n()&&(c=b.supplant("translateX({0}%) scale({1},1)",[(c-100)/2,c/100]),c=m({transform:c}),angular.element(a).css(c))}a(d);var l,r=g.hasOwnProperty("disabled"),m=b.dom.animator.toCss,v=angular.element(d[0].querySelector(".md-bar1")),w=angular.element(d[0].querySelector(".md-bar2")),t=angular.element(d[0].querySelector(".md-container"));d.attr("md-mode",n()).toggleClass("_md-progress-linear-disabled",r);f();e()}return{restrict:"E",template:'<div class="md-container"><div class="md-dashed"></div><div class="md-bar md-bar1"></div><div class="md-bar md-bar2"></div></div>',
...
function mdRadioGroupDirective(a,b,c,d){function e(e,f,g,h){function k(){f.hasClass("md-focused")||f.addClass("md-focused")}function l(c){var d=c.which||c.keyCode;if(d==b.KEY_CODE.ENTER||c.currentTarget==c.target)switch(d){case b.KEY_CODE.LEFT_ARROW:case b.KEY_CODE.UP_ARROW:c.preventDefault();n.selectPrevious();k();break;case b.KEY_CODE.RIGHT_ARROW:case b.KEY_CODE.DOWN_ARROW:c.preventDefault();n.selectNext();k();break;case b.KEY_CODE.ENTER:c=angular.element(a.getClosest(f[0],"form")),0<c.length&&
c.triggerHandler("submit")}}f.addClass("_md");c(f);var n=h[0];g=h[1]||a.fakeNgModel();n.init(g);e.mouseActive=!1;f.attr({role:"radiogroup",tabIndex:f.attr("tabindex")||"0"}).on("keydown",l).on("mousedown",function(){e.mouseActive=!0;d(function(){e.mouseActive=!1},100)}).on("focus",function(){!1===e.mouseActive&&n.$element.addClass("md-focused")}).on("blur",function(){n.$element.removeClass("md-focused")})}function f(a){this._radioButtonRenderFns=[];this.$element=a}function g(){return{init:function(a){this._ngModelCtrl=
a;this._ngModelCtrl.$render=angular.bind(this,this.render)},add:function(a){this._radioButtonRenderFns.push(a)},remove:function(a){a=this._radioButtonRenderFns.indexOf(a);-1!==a&&this._radioButtonRenderFns.splice(a,1)},render:function(){this._radioButtonRenderFns.forEach(function(a){a()})},setViewValue:function(a,b){this._ngModelCtrl.$setViewValue(a,b);this.render()},getViewValue:function(){return this._ngModelCtrl.$viewValue},selectNext:function(){return h(this.$element,1)},selectPrevious:function(){return h(this.$element,
-1)},setActiveDescendant:function(a){this.$element.attr("aria-activedescendant",a)},isDisabled:function(){return this.$element[0].hasAttribute("disabled")}}}function h(b,c){var d=a.iterator(b[0].querySelectorAll("md-radio-button"),!0);if(d.count()){var e=function(a){return!angular.element(a).attr("disabled")};b=b[0].querySelector("md-radio-button.md-checked");c=d[0>c?"previous":"next"](b,e)||d.first();angular.element(c).triggerHandler("click")}}f.prototype=g();return{restrict:"E",controller:["$element",
f],require:["mdRadioGroup","?ngModel"],link:{pre:e}}}
function mdRadioButtonDirective(a,b,c){function d(d,f,g,h){function e(){if(!h)throw"RadioButton: No RadioGroupController could be found.";h.add(q);g.$observe("value",q);f.on("click",n).on("$destroy",function(){h.remove(q)})}function n(a){f[0].hasAttribute("disabled")||h.isDisabled()||d.$apply(function(){h.setViewValue(g.value,a&&a.type)})}function q(){var a=h.getViewValue()==g.value;a!==r&&("md-radio-group"!==f[0].parentNode.nodeName.toLowerCase()&&f.parent().toggleClass("md-checked",a),a&&h.setActiveDescendant(f.attr("id")),
r=a,f.attr("aria-checked",a).toggleClass("md-checked",a))}function l(c){c.attr({id:g.id||"radio_"+b.nextUid(),role:"radio","aria-checked":"false"});a.expectWithText(c,"aria-label")}var r;c(f);l(f,d);g.ngValue?b.nextTick(e,!1):e()}return{restrict:"E",require:"^mdRadioGroup",transclude:!0,template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-off"></div><div class="md-on"></div></div><div ng-transclude class="md-label"></div>',link:d}}
...
function SelectDirective(a,b,c,d,e,f,g){function h(h,n){var k=angular.element("<md-select-value><span></span></md-select-value>");k.append('<span class="md-select-icon" aria-hidden="true"></span>');k.addClass("md-select-value");k[0].hasAttribute("id")||k.attr("id","select_value_label_"+b.nextUid());var l=h.find("md-content");l.length||h.append(angular.element("<md-content>").append(h.contents()));l.attr("role","presentation");n.mdOnOpen&&(h.find("md-content").prepend(angular.element('<div> <md-progress-circular md-mode="indeterminate" ng-if="$$loadingAsyncDone === false" md-diameter="25px"></md-progress-circular></div>')),
h.find("md-option").attr("ng-show","$$loadingAsyncDone"));if(n.name){var r=angular.element('<select class="md-visually-hidden"></select>');r.attr({name:n.name,"aria-hidden":"true",tabindex:"-1"});l=h.find("md-option");angular.forEach(l,function(a){var b=angular.element("<option>"+a.innerHTML+"</option>");a.hasAttribute("ng-value")?b.attr("ng-value",a.getAttribute("ng-value")):a.hasAttribute("value")&&b.attr("value",a.getAttribute("value"));r.append(b)});r.append('<option ng-value="'+n.ngModel+'" selected></option>');
h.parent().append(r)}var m=b.parseAttributeBoolean(n.multiple);l=m?"multiple":"";var v='<div class="md-select-menu-container" aria-hidden="true" role="presentation"><md-select-menu role="presentation" {0}>{1}</md-select-menu></div>';v=b.supplant(v,[l,h.html()]);h.empty().append(k);h.append(v);n.tabindex||n.$set("tabindex",0);return function(h,k,l,n){function p(){U&&(P=P||U.find("md-select-menu").controller("mdSelectMenu"),N.setLabelText(P.selectedLabels()))}function q(){if(J){var a=P.selectedLabels({mode:"aria"});
k.attr("aria-label",a.length?J+": "+a:J)}}function y(){C&&C.setHasValue(0<P.selectedLabels().length||(k[0].validity||{}).badInput)}function r(){U=angular.element(k[0].querySelector(".md-select-menu-container"));X=h;if(l.mdContainerClass){var a=U[0].getAttribute("class")+" "+l.mdContainerClass;U[0].setAttribute("class",a)}P=U.find("md-select-menu").controller("mdSelectMenu");P.init(K,l.ngModel);k.on("$destroy",function(){U.remove()})}function v(a){c.isNavigationKey(a)?(a.preventDefault(),t(a)):shouldHandleKey(a,
c)&&(a.preventDefault(),(a=P.optNodeForKeyboardSearch(a))&&!a.hasAttribute("disabled")&&(a=angular.element(a).controller("mdOption"),P.isMultiple||P.deselect(Object.keys(P.selected)[0]),P.select(a.hashKey,a.value),P.refreshViewValue()))}function t(){X._mdSelectIsOpen=!0;k.attr("aria-expanded","true");a.show({scope:X,preserveScope:!0,skipCompile:!0,element:U,target:k[0],selectCtrl:N,preserveElement:!0,hasBackdrop:!0,loadingAsync:l.mdOnOpen?h.$eval(l.mdOnOpen)||!0:!1})["finally"](function(){X._mdSelectIsOpen=
!1;k.focus();k.attr("aria-expanded","false");K.$setTouched()})}var w=!0,H,J,C=n[0],N=n[1],K=n[2],L=n[3],R=k.find("md-select-value");n=angular.isDefined(l.readonly);var Y=b.parseAttributeBoolean(l.mdNoAsterisk);Y&&k.addClass("md-no-asterisk");if(C){var S=C.isErrorGetter||function(){return K.$invalid&&(K.$touched||L&&L.$submitted)};if(C.input&&k.find("md-select-header").find("input")[0]!==C.input[0])throw Error("<md-input-container> can only have *one* child <input>, <textarea> or <select> element!");
C.input=k;C.label||e.expect(k,"aria-label",k.attr("placeholder"));h.$watch(S,C.setInvalid)}var U,X,P;r();d(k);L&&angular.isDefined(l.multiple)&&b.nextTick(function(){var a=K.$modelValue||K.$viewValue;a&&L.$setPristine()});var O=K.$render;K.$render=function(){O();p();q();y()};l.$observe("placeholder",K.$render);C&&C.label&&l.$observe("required",function(a){C.label.toggleClass("md-required",a&&!Y)});N.setLabelText=function(a){N.setIsPlaceholder(!a);var b=!1;if(l.mdSelectedText&&l.mdSelectedHtml)throw Error("md-select cannot have both `md-selected-text` and `md-selected-html`");
l.mdSelectedText||l.mdSelectedHtml?(a=f(l.mdSelectedText||l.mdSelectedHtml)(h),b=!0):a||(a=(a=l.placeholder||(C&&C.label?C.label.text():""))||"",b=!0);var c=R.children().eq(0);l.mdSelectedHtml?c.html(g.getTrustedHtml(a)):b?c.text(a):c.html(a)};N.setIsPlaceholder=function(a){a?(R.addClass("md-select-placeholder"),C&&C.label&&C.label.addClass("md-placeholder")):(R.removeClass("md-select-placeholder"),C&&C.label&&C.label.removeClass("md-placeholder"))};n||(k.on("focus",function(){C&&C.setFocused(!0)}),
k.on("blur",function(a){w&&(w=!1,X._mdSelectIsOpen&&a.stopImmediatePropagation());X._mdSelectIsOpen||(C&&C.setFocused(!1),y())}));N.triggerClose=function(){f(l.mdOnClose)(h)};h.$$postDigest(function(){var a=k.attr("aria-label")||k.attr("placeholder");!a&&C&&C.label&&(a=C.label.text());J=a;e.expect(k,"aria-label",a);p();q()});h.$watch(function(){return P.selectedLabels()},p);var ca;l.$observe("ngMultiple",function(a){ca&&ca();var b=f(a);ca=h.$watch(function(){return b(h)},function(a,b){if(void 0!==
a||void 0!==b)a?k.attr("multiple","multiple"):k.removeAttr("multiple"),k.attr("aria-multiselectable",a?"true":"false"),U&&(P.setMultiple(a),O=K.$render,K.$render=function(){O();p();q();y()},K.$render())})});l.$observe("disabled",function(a){angular.isString(a)&&(a=!0);if(void 0===H||H!==a)if(H=a)k.attr({"aria-disabled":"true"}).removeAttr("tabindex").off("click",t).off("keydown",v);else k.attr({tabindex:l.tabindex,"aria-disabled":"false"}).on("click",t).on("keydown",v)});l.hasOwnProperty("disabled")||
l.hasOwnProperty("ngDisabled")||(k.attr({"aria-disabled":"false"}),k.on("click",t),k.on("keydown",v));n={role:"listbox","aria-expanded":"false","aria-multiselectable":m&&!l.ngMultiple?"true":"false"};k[0].hasAttribute("id")||(n.id="select_"+b.nextUid());S="select_container_"+b.nextUid();U.attr("id",S);k.find("md-select-menu").length||(n["aria-owns"]=S);k.attr(n);h.$on("$destroy",function(){a.destroy()["finally"](function(){C&&(C.setFocused(!1),C.setHasValue(!1),C.input=null);K.$setTouched()})})}}
return{restrict:"E",require:["^?mdInputContainer","mdSelect","ngModel","?^form"],compile:h,controller:function(){}}}
function SelectMenuDirective(a,b,c,d){function e(a,c,e,f){function g(a){13!=a.keyCode&&32!=a.keyCode||h(a)}function h(c){var d=b.getClosest(c.target,"md-option"),e=d&&angular.element(d).data("$mdOptionController");if(d&&e){if(d.hasAttribute("disabled"))return c.stopImmediatePropagation(),!1;var f=k.hashGetter(e.value),g=angular.isDefined(k.selected[f]);a.$apply(function(){k.isMultiple?g?k.deselect(f):k.select(f,e.value):g||(k.deselect(Object.keys(k.selected)[0]),k.select(f,e.value));k.refreshViewValue()})}}
var k=f[0];c.addClass("_md");d(c);c.on("click",h);c.on("keypress",g)}function f(c,d,e){function f(){var a=h.ngModel.$modelValue||h.ngModel.$viewValue||[];if(angular.isArray(a)){var b=Object.keys(h.selected),c=a.map(h.hashGetter);b=b.filter(function(a){return-1===c.indexOf(a)});b.forEach(h.deselect);c.forEach(function(b,c){h.select(b,a[c])})}}function g(){var a=h.ngModel.$viewValue||h.ngModel.$modelValue;Object.keys(h.selected).forEach(h.deselect);h.select(h.hashGetter(a),a)}var h=this;h.isMultiple=
angular.isDefined(d.multiple);h.selected={};h.options={};c.$watchCollection(function(){return h.options},function(){h.ngModel.$render()});var k;h.setMultiple=function(a){function b(a,b){return angular.isArray(a||b||[])}var d=h.ngModel;h.isMultiple=a;k&&k();h.isMultiple?(d.$validators["md-multiple"]=b,d.$render=f,c.$watchCollection(h.modelBinding,function(a){b(a)&&f(a)}),d.$isEmpty=function(a){return!a||0===a.length}):(delete d.$validators["md-multiple"],d.$render=g)};var m="",v,w,t;h.optNodeForKeyboardSearch=
function(a){v&&clearTimeout(v);v=setTimeout(function(){v=void 0;m="";w=t=void 0},300);m+=a.key;a=new RegExp("^"+m,"i");w||(w=e.find("md-option"),t=Array(w.length),angular.forEach(w,function(a,b){t[b]=a.textContent.trim()}));for(var b=0;b<t.length;++b)if(a.test(t[b]))return w[b]};h.init=function(d,e){h.ngModel=d;h.modelBinding=e;h.ngModel.$isEmpty=function(a){return!h.options[h.hashGetter(a)]};if(d=b.getModelOption(d,"trackBy")){var f={},g=a(d);h.hashGetter=function(a,b){f.$value=a;return g(b||c,f)}}else h.hashGetter=
function(a){return angular.isObject(a)?"object_"+(a.$$mdSelectId||(a.$$mdSelectId=++selectNextId)):a};h.setMultiple(h.isMultiple)};h.selectedLabels=function(a){a=a||{};a=a.mode||"html";var c=b.nodesToArray(e[0].querySelectorAll("md-option[selected]"));if(c.length){var d;"html"==a?d=function(a){if(a.hasAttribute("md-option-empty"))return"";var b=a.innerHTML,c=a.querySelector(".md-ripple-container");c&&(b=b.replace(c.outerHTML,""));(a=a.querySelector(".md-container"))&&(b=b.replace(a.outerHTML,""));
return b}:"aria"==a&&(d=function(a){return a.hasAttribute("aria-label")?a.getAttribute("aria-label"):a.textContent});return b.uniq(c.map(d)).join(", ")}return""};h.select=function(a,b){var c=h.options[a];c&&c.setSelected(!0);h.selected[a]=b};h.deselect=function(a){var b=h.options[a];b&&b.setSelected(!1);delete h.selected[a]};h.addOption=function(a,b){if(angular.isDefined(h.options[a]))throw Error('Duplicate md-option values are not allowed in a select. Duplicate value "'+b.value+'" found.');h.options[a]=
b;angular.isDefined(h.selected[a])&&(h.select(a,b.value),angular.isDefined(h.ngModel.$modelValue)&&h.hashGetter(h.ngModel.$modelValue)===a&&h.ngModel.$validate(),h.refreshViewValue())};h.removeOption=function(a){delete h.options[a]};h.refreshViewValue=function(){var a=[],c;for(d in h.selected)(c=h.options[d])?a.push(c.value):a.push(h.selected[d]);c=b.getModelOption(h.ngModel,"trackBy");a=h.isMultiple?a:a[0];var d=h.ngModel.$modelValue;(c?angular.equals(d,a):d+""===a)||(h.ngModel.$setViewValue(a),
h.ngModel.$render())}}f.$inject=["$scope","$attrs","$element"];return{restrict:"E",require:["mdSelectMenu"],scope:!1,controller:f,link:{pre:e}}}
function OptionDirective(a,b,c){function d(a,b){a.append(angular.element('<div class="md-text">').append(a.contents()));a.attr("tabindex",b.tabindex||"0");var c=b.value;b=b.ngValue;(c=c||b)||a.attr("md-option-empty","");return e}function e(d,e,f,n){function g(a,b,c){if(m.hashGetter){c=m.hashGetter(b,d);var e=m.hashGetter(a,d);k.hashKey=e;k.value=a;m.removeOption(c,k);m.addOption(e,k)}else c||d.$$postDigest(function(){g(a,b,!0)})}function h(){var a={role:"option","aria-selected":"false"};e[0].hasAttribute("id")||
(a.id="select_option_"+b.nextUid());e.attr(a)}var k=n[0],m=n[1];c(e);m.isMultiple&&(e.addClass("md-checkbox-enabled"),e.prepend(CHECKBOX_SELECTION_INDICATOR.clone()));angular.isDefined(f.ngValue)?d.$watch(f.ngValue,g):angular.isDefined(f.value)?g(f.value):d.$watch(function(){return e.text().trim()},g);f.$observe("disabled",function(a){a?e.attr("tabindex","-1"):e.attr("tabindex","0")});d.$$postDigest(function(){f.$observe("selected",function(a){angular.isDefined(a)&&("string"==typeof a&&(a=!0),a?(m.isMultiple||
m.deselect(Object.keys(m.selected)[0]),m.select(k.hashKey,k.value)):m.deselect(k.hashKey),m.refreshViewValue())})});a.attach(d,e);h();d.$on("$destroy",function(){m.removeOption(k.hashKey,k)})}function f(a){this.selected=!1;this.setSelected=function(b){b&&!this.selected?a.attr({selected:"selected","aria-selected":"true"}):!b&&this.selected&&(a.removeAttr("selected"),a.attr("aria-selected","false"));this.selected=b}}f.$inject=["$element"];return{restrict:"E",require:["mdOption","^^mdSelectMenu"],controller:f,
...
function SelectProvider(a){function b(a,b,e,f,g,h,k,n,q){function c(a,b,c){function d(){f();b.removeClass("md-active").attr("aria-hidden","true").css("display","none");b.parent().find("md-select-value").removeAttr("aria-hidden");var a=c.selectCtrl;if(a){var d=c.selectEl.controller("mdSelectMenu");a.setLabelText(d?d.selectedLabels():"");a.triggerClose()}!c.$destroy&&c.restoreFocus&&c.target.focus()}var e=null,f=a.$on("$destroy",function(){e.end()});c=c||{};c.cleanupInteraction();c.cleanupResizing();
c.hideBackdrop();!0===c.$destroy?a=d():(e=k(b,{addClass:"md-leave"}),a=e.start(),a=a.then(d));return a}function d(c,d,l){function p(a,b,c){c.parent!==b.parent()&&b.parent().attr("aria-owns",b.attr("id"));b.parent().find("md-select-value").attr("aria-hidden","true");c.parent.append(b);return g(function(a,c){try{k(b,{removeClass:"md-leave",duration:0}).start().then(r).then(a)}catch(L){c(L)}})}function r(){return g(function(a){if(l.isRemoved)return g.reject(!1);var b=m(c,d,l);b.container.element.css(v.toCss(b.container.styles));
b.dropDown.element.css(v.toCss(b.dropDown.styles));h(function(){d.addClass("md-active");b.dropDown.element.css(v.toCss({transform:""}));a()})})}function t(a,b,c){c.disableParentScroll&&!e.getClosest(c.target,"MD-DIALOG")?c.restoreScroll=e.disableScrollAround(c.element,c.parent):c.disableParentScroll=!1;c.hasBackdrop&&(c.backdrop=e.createBackdrop(a,"md-select-backdrop md-click-catcher"),n.enter(c.backdrop,q[0].body,null,{duration:0}));return function(){c.backdrop&&c.backdrop.remove();c.disableParentScroll&&
c.restoreScroll();delete c.restoreScroll}}function y(a,b){a=d.find("md-select-menu");if(!b.target)throw Error(e.supplant("$mdSelect.show() expected a target element in options.target but got '{0}'!",[b.target]));angular.extend(b,{isRemoved:!1,target:angular.element(b.target),parent:angular.element(b.parent),selectEl:a,contentEl:d.find("md-content"),optionNodes:a[0].getElementsByTagName("md-option")})}function E(){var a=function(a,b,c){return function(){if(!c.isRemoved){var d=m(a,b,c),e=d.container;
d=d.dropDown;e.element.css(v.toCss(e.styles));d.element.css(v.toCss(d.styles))}}}(c,d,l),b=angular.element(f);b.on("resize",a);b.on("orientationchange",a);return function(){b.off("resize",a);b.off("orientationchange",a)}}function G(){l.loadingAsync&&!l.isRemoved&&(c.$$loadingAsyncDone=!1,g.when(l.loadingAsync).then(function(){c.$$loadingAsyncDone=!0;delete l.loadingAsync}).then(function(){h(r)}))}function F(){function c(b){b.preventDefault();b.stopPropagation();l.restoreFocus=!1;e.nextTick(a.hide,
!0)}function f(c){c.preventDefault();c.stopPropagation();switch(c.keyCode){case w.UP_ARROW:return g("prev"),c=void 0;case w.DOWN_ARROW:return g("next"),c=void 0;case w.SPACE:case w.ENTER:var d=e.getClosest(c.target,"md-option");d&&(k.triggerHandler({type:"click",target:d}),c.preventDefault());h(c);break;case w.TAB:case w.ESCAPE:c.stopPropagation();c.preventDefault();l.restoreFocus=!0;e.nextTick(a.hide,!0);break;default:shouldHandleKey(c,b)&&(c=k.controller("mdSelectMenu").optNodeForKeyboardSearch(c),
...
d>c.querySelector("md-option").offsetWidth&&(a=!0))}return a}if(!(b&&"click"==b.type&&b.currentTarget!=k[0]||c())){var d=e.getClosest(b.target,"md-option");d&&d.hasAttribute&&!d.hasAttribute("disabled")&&(b.preventDefault(),b.stopPropagation(),m.isMultiple||(l.restoreFocus=!0,e.nextTick(function(){a.hide(m.ngModel.$viewValue)},!0)))}}if(!l.isRemoved){var k=l.selectEl,m=k.controller("mdSelectMenu")||{};d.addClass("md-clickable");l.backdrop&&l.backdrop.on("click",c);k.on("keydown",f);k.on("click",h);
return function(){l.backdrop&&l.backdrop.off("click",c);k.off("keydown",f);k.off("click",h);d.removeClass("md-clickable");l.isRemoved=!0}}}G();y(c,l);l.hideBackdrop=t(c,d,l);return p(c,d,l).then(function(a){d.attr("aria-hidden","false");l.alreadyOpen=!0;l.cleanupInteraction=F();l.cleanupResizing=E();var b=l.focusedNode;b&&!b.hasAttribute("disabled")&&b.focus();return a},l.hideBackdrop)}function m(a,b,c){a=b[0];var d=c.target[0].children[0],g=q[0].body,h=c.selectEl[0],k=c.contentEl[0],l=g.getBoundingClientRect(),
m=d.getBoundingClientRect();g={left:l.left+8,top:8,bottom:l.height-8,right:l.width-8-(e.floatingScrollbars()?16:0)};var n={top:m.top-g.top,left:m.left-g.left,right:g.right-(m.left+m.width),bottom:g.bottom-(m.top+m.height)};l=l.width-16;var r=h.querySelector("md-option[selected]"),p=h.getElementsByTagName("md-option"),v=h.getElementsByTagName("md-optgroup"),t=k,y=b[0].style.display;b[0].style.display="block";t=t.scrollHeight>t.offsetHeight;b[0].style.display=y;b=t;v=(y=(y=c.loadingAsync)&&angular.isFunction(y.then))?
k.firstElementChild||k:r?r:v.length?v[0]:p.length?p[0]:k.firstElementChild||k;k.offsetWidth>l?k.style["max-width"]=l+"px":k.style.maxWidth=null;b&&h.classList.add("md-overflow");r=v;"MD-OPTGROUP"===(r.tagName||"").toUpperCase()&&(v=r=p[0]||k.firstElementChild||k);c.focusedNode=r;a.style.display="block";p=h.getBoundingClientRect();r=v?{left:v.offsetLeft,top:v.offsetTop,width:v.offsetWidth,height:v.offsetHeight}:{left:0,top:0,width:0,height:0};v&&(v=f.getComputedStyle(v),r.paddingLeft=parseInt(v.paddingLeft,
10)||0,r.paddingRight=parseInt(v.paddingRight,10)||0);b&&(v=k.offsetHeight/2,k.scrollTop=r.top+r.height/2-v,n.top<v?k.scrollTop=Math.min(r.top,k.scrollTop+v-n.top):n.bottom<v&&(k.scrollTop=Math.max(r.top+r.height-p.height,k.scrollTop-v+n.bottom)));n=m.left+r.left-r.paddingLeft+2;v=Math.floor(m.top+m.height/2-r.height/2-r.top+k.scrollTop)+2;k=r.left+m.width/2+"px "+(r.top+r.height/2-k.scrollTop)+"px 0px";l=Math.min(m.width+r.paddingLeft+r.paddingRight,l);d=window.getComputedStyle(d)["font-size"];r=
a.getBoundingClientRect();b=Math.round(100*Math.min(m.width/p.width,1))/100;m=Math.round(100*Math.min(m.height/p.height,1))/100;return{container:{element:angular.element(a),styles:{left:Math.floor(Math.max(g.left,Math.min(n,g.right-r.width))),top:Math.floor(Math.max(g.top,Math.min(v,g.bottom-r.height))),"min-width":l,"font-size":d}},dropDown:{element:angular.element(h),styles:{transformOrigin:k,transform:c.alreadyOpen?"":e.supplant("scale({0},{1})",[b,m])}}}}var v=e.dom.animator,w=b.KEY_CODE;return{parent:"body",
...
var h={find:f,waitFor:g};return function(a,b){if(angular.isUndefined(a))return h;var c=!0===b,d=h.find(a,c);return!d&&c?h.waitFor(a):!d&&angular.isUndefined(b)?e(h,a):d}}function SidenavFocusDirective(){return{restrict:"A",require:"^mdSidenav",link:function(){}}}
function SidenavDirective(a,b,c,d,e,f,g,h,k,n,q,l,r){function m(g,m,t,p){function v(a,b){g.isLockedOpen=a;if(a===b)m.toggleClass("md-locked-open",!!a);else f[a?"addClass":"removeClass"](m,"md-locked-open");F&&F.toggleClass("md-locked-open",!!a)}function w(a){var c=b.findFocusTarget(m)||b.findFocusTarget(m,"[md-sidenav-focus]")||m,d=m.parent();if(!J&&(d[a?"on":"off"]("keydown",B),F))F[a?"on":"off"]("click",E);var h=A(d,a);a&&(N=q[0].activeElement,C=e.getLastInteractionType());a&&!G?(G=H.css("overflow"),
H.css("overflow","hidden")):angular.isDefined(G)&&(H.css("overflow",G),G=void 0);return L=n.all([a&&F?f.enter(F,d):F?f.leave(F):n.when(!0),f[a?"removeClass":"addClass"](m,"md-closed")]).then(function(){g.isOpen&&(r(function(){Y.triggerHandler("resize")}),c&&c.focus());h&&h()})}function A(a,b){var c=m[0],d=a[0].scrollTop;b&&d&&(K={top:c.style.top,bottom:c.style.bottom,height:c.style.height},a={top:d+"px",bottom:"auto",height:a[0].clientHeight+"px"},m.css(a),F.css(a));if(!b&&K)return function(){c.style.top=
K.top;c.style.bottom=K.bottom;c.style.height=K.height;F[0].style.top=null;F[0].style.bottom=null;K=F[0].style.height=null}}function D(a){if(g.isOpen===a)return n.when(!0);if(g.isOpen&&p.onCloseCb)p.onCloseCb();return n(function(c){g.isOpen=a;b.nextTick(function(){L.then(function(a){!g.isOpen&&N&&"keyboard"===C&&(N.focus(),N=null);c(a)})})})}function B(a){var b=a.keyCode===c.KEY_CODE.ESCAPE;return b?E(a):n.when(!0)}function E(a){a.preventDefault();return p.close()}var G,F,H=null,J,C,N=null,K,L=n.when(!0),
R=h(t.mdIsLockedOpen),Y=angular.element(l),S=function(){return R(g.$parent,{$media:function(b){k.warn("$media is deprecated for is-locked-open. Use $mdMedia instead.");return a(b)},$mdMedia:a})};t.mdDisableScrollTarget&&((H=q[0].querySelector(t.mdDisableScrollTarget))?H=angular.element(H):k.warn(b.supplant('mdSidenav: couldn\'t find element matching selector "{selector}". Falling back to parent.',{selector:t.mdDisableScrollTarget})));H||(H=m.parent());t.hasOwnProperty("mdDisableBackdrop")||(F=b.createBackdrop(g,
"md-sidenav-backdrop md-opaque ng-enter"));t.hasOwnProperty("mdDisableCloseEvents")&&(J=!0);m.addClass("_md");d(m);F&&d.inherit(F,m);m.on("$destroy",function(){F&&F.remove();p.destroy()});g.$on("$destroy",function(){F&&F.remove()});g.$watch(S,v);g.$watch("isOpen",w);p.$toggleOpen=D}return{restrict:"E",scope:{isOpen:"=?mdIsOpen"},controller:"$mdSidenavController",compile:function(a){a.addClass("md-closed").attr("tabIndex","-1");return m}}}
function SidenavController(a,b,c,d,e){var f=this;f.isOpen=function(){return!!a.isOpen};f.isLockedOpen=function(){return!!a.isLockedOpen};f.onClose=function(a){f.onCloseCb=a;return f};f.open=function(){return f.$toggleOpen(!0)};f.close=function(){return f.$toggleOpen(!1)};f.toggle=function(){return f.$toggleOpen(!a.isOpen)};f.$toggleOpen=function(b){return d.when(a.isOpen=b)};var g=b.mdComponentId,h=g&&-1<g.indexOf(e.startSymbol());e=h?e(g)(a.$parent):g;f.destroy=c.register(f,e);h&&b.$observe("mdComponentId",
...
function(a){var c=b[0].querySelector("md-input-container");if(c){var d=getComputedStyle(c),e=parseInt(d.minWidth),g=parseInt(d.paddingLeft)+parseInt(d.paddingRight);f=f||parseInt(d.maxWidth);a=Math.max(f,e+g+e/2*a);c.style.maxWidth=a+"px"}}}}}}}
function SliderDirective(a,b,c,d,e,f,g,h,k,n){function q(a,b){var d=angular.element(a[0].getElementsByClassName("md-slider-wrapper")),e=b.tabindex||0;d.attr("tabindex",e);(b.disabled||b.ngDisabled)&&d.attr("tabindex",-1);a.attr("role","slider");c.expect(a,"aria-label");return l}function l(c,l,q,w){function m(){E();K()}function r(a){Q=parseFloat(a);M.$viewValue=L(M.$modelValue,Q,aa);l.attr("aria-valuemin",a);m()}function v(a){aa=parseFloat(a);M.$viewValue=L(M.$modelValue,Q,aa);l.attr("aria-valuemax",
a);m()}function z(a){W=parseFloat(a)}function A(a){ba=L(parseInt(a),0,6)}function D(){l.attr("aria-disabled",!!T())}function B(){if(qa&&!T()&&!angular.isUndefined(W)){if(0>=W)throw k.error("Slider step value must be greater than zero when in discrete mode"),Error("Slider step value must be greater than zero when in discrete mode");var a=Math.floor((aa-Q)/W);u||(u=angular.element("<canvas>").css("position","absolute"),pa.append(u),Z=u[0].getContext("2d"));var c=G();!c||c.height||c.width||(E(),c=V);
u[0].width=c.width;u[0].height=c.height;for(var d,e=0;e<=a;e++)d=b.getComputedStyle(pa[0]),Z.fillStyle=d.color||"black",d=Math.floor(e/a*(x?c.height:c.width)),Z.fillRect(x?0:d-1,x?d-1:0,x?c.width:2,x?2:c.height)}}function E(){V=sa[0].getBoundingClientRect()}function G(){ta();return V}function F(a){if(!T()){if(x?a.keyCode===e.KEY_CODE.DOWN_ARROW:a.keyCode===e.KEY_CODE.LEFT_ARROW)var b=-W;else if(x?a.keyCode===e.KEY_CODE.UP_ARROW:a.keyCode===e.KEY_CODE.RIGHT_ARROW)b=W;if(b=ha?-b:b){if(a.metaKey||a.ctrlKey||
a.altKey)b*=4;a.preventDefault();a.stopPropagation();c.$evalAsync(function(){N(M.$viewValue+b)})}}}function H(){B();c.mouseActive=!0;ea.removeClass("md-focused");n(function(){c.mouseActive=!1},100)}function J(){!1===c.mouseActive&&ea.addClass("md-focused")}function C(){ea.removeClass("md-focused");l.removeClass("md-active");if(u&&Z){var a=G();Z.clearRect(0,0,a.width,a.height)}}function N(a){M.$setViewValue(L(R(a)))}function K(){isNaN(M.$viewValue)&&(M.$viewValue=M.$modelValue);M.$viewValue=L(M.$viewValue);
var a=ra(M.$viewValue);c.modelValue=M.$viewValue;l.attr("aria-valuenow",M.$viewValue);Y(a);na.text(M.$viewValue)}function L(a,b,c){if(angular.isNumber(a))return b=angular.isNumber(b)?b:Q,c=angular.isNumber(c)?c:aa,Math.max(b,Math.min(c,a))}function R(a){if(angular.isNumber(a)){var b=Math.round((a-Q)/W)*W+Q;b=Math.round(b*Math.pow(10,ba))/Math.pow(10,ba);da&&da.fitInputWidthToTextLength&&d.debounce(function(){da.fitInputWidthToTextLength(b.toString().length)},100)();return b}}function Y(a){a=Math.max(0,
Math.min(a||0,1));var b=100*a+"%",c=ha?100*(1-a)+"%":b;x?ka.css("bottom",b):d.bidiProperty(ka,"left","right",b);oa.css(x?"height":"width",c);l.toggleClass(ha?"md-max":"md-min",0===a);l.toggleClass(ha?"md-min":"md-max",1===a)}function S(a){if(!T()){l.addClass("md-active");l[0].focus();E();a=ja(ia(x?a.pointer.y:a.pointer.x));var b=L(R(a));c.$apply(function(){N(b);Y(ra(b))})}}function U(a){if(!T()){l.removeClass("md-dragging");a=ja(ia(x?a.pointer.y:a.pointer.x));var b=L(R(a));c.$apply(function(){N(b);
K()})}}function X(a){T()||(la=!0,a.stopPropagation(),l.addClass("md-dragging"),ca(a))}function P(a){la&&(a.stopPropagation(),ca(a))}function O(a){la&&(a.stopPropagation(),la=!1)}function ca(a){if(qa){a=x?a.pointer.y:a.pointer.x;var b=ja(ia(a));b=L(R(b));Y(ia(a));na.text(b)}else ma(x?a.pointer.y:a.pointer.x)}function ma(a){c.$evalAsync(function(){N(ja(ia(a)))})}function ia(a){var b=x?V.top:V.left,c=x?V.height:V.width;a=(a-b)/c;x||"rtl"!==d.bidi()||(a=1-a);return Math.max(0,Math.min(1,x?1-a:a))}function ja(a){a=
ha?1-a:a;return Q+a*(aa-Q)}function ra(a){a=(a-Q)/(aa-Q);return ha?1-a:a}f(l);var M=w[0]||{$setViewValue:function(a){this.$viewValue=a;this.$viewChangeListeners.forEach(function(a){a()})},$parsers:[],$formatters:[],$viewChangeListeners:[]},da=w[1];angular.element(d.getClosest(l,"_md-slider-container",!0));var T=q.ngDisabled?angular.bind(null,h(q.ngDisabled),c.$parent):function(){return l[0].hasAttribute("disabled")};w=angular.element(l[0].querySelector(".md-thumb"));var na=angular.element(l[0].querySelector(".md-thumb-text")),
ka=w.parent(),sa=angular.element(l[0].querySelector(".md-track-container")),oa=angular.element(l[0].querySelector(".md-track-fill")),pa=angular.element(l[0].querySelector(".md-track-ticks")),ea=angular.element(l[0].getElementsByClassName("md-slider-wrapper"));angular.element(l[0].getElementsByClassName("md-slider-content"));var ta=d.throttle(E,5E3),x=angular.isDefined(q.mdVertical),qa=angular.isDefined(q.mdDiscrete),ha=angular.isDefined(q.mdInvert);angular.isDefined(q.min)?q.$observe("min",r):r(0);
angular.isDefined(q.max)?q.$observe("max",v):v(100);angular.isDefined(q.step)?q.$observe("step",z):z(1);angular.isDefined(q.round)?q.$observe("round",A):A(3);q.ngDisabled&&c.$parent.$watch(q.ngDisabled,D);g.register(ea,"drag",{horizontal:!x});c.mouseActive=!1;ea.on("keydown",F).on("mousedown",H).on("focus",J).on("blur",C).on("$md.pressdown",S).on("$md.pressup",U).on("$md.dragstart",X).on("$md.drag",P).on("$md.dragend",O);setTimeout(m,0);var I=a.throttle(m);angular.element(b).on("resize",I);c.$on("$destroy",
function(){angular.element(b).off("resize",I)});M.$render=K;M.$viewChangeListeners.push(K);M.$formatters.push(L);M.$formatters.push(R);var Q,aa,W,ba,u,Z,V={};E();var la=!1}return{scope:{},require:["?ngModel","?^mdSliderContainer"],template:'<div class="md-slider-wrapper"><div class="md-slider-content"><div class="md-track-container"><div class="md-track"></div><div class="md-track md-track-fill"></div><div class="md-track-ticks"></div></div><div class="md-thumb-container"><div class="md-thumb"></div><div class="md-focus-thumb"></div><div class="md-focus-ring"></div><div class="md-sign"><span class="md-thumb-text"></span></div><div class="md-disabled-thumb"></div></div></div></div>',
compile:q}}ngmaterial.components.slider=angular.module("material.components.slider");MdSticky.$inject=["$mdConstant","$$rAF","$mdUtil","$compile"];angular.module("material.components.sticky",["material.core","material.components.content"]).factory("$mdSticky",MdSticky);
function MdSticky(a,b,c,d){function e(d){function e(a,b){b.addClass("md-sticky-clone");var d={element:a,clone:b};p.items.push(d);c.nextTick(function(){w.prepend(d.clone)});t();return function(){p.items.forEach(function(b,c){b.element[0]===a[0]&&(p.items.splice(c,1),b.clone.remove())});t()}}function g(){p.items.forEach(h);p.items=p.items.sort(function(a,b){return a.top<b.top?-1:1});for(var a,b=w.prop("scrollTop"),c=p.items.length-1;0<=c;c--)if(b>p.items[c].top){a=p.items[c];break}r(a)}function h(a){var b=
a.element[0];a.top=0;a.left=0;for(a.right=0;b&&b!==w[0];)a.top+=b.offsetTop,a.left+=b.offsetLeft,b.offsetParent&&(a.right+=b.offsetParent.offsetWidth-b.offsetWidth-b.offsetLeft),b=b.offsetParent;a.height=a.element.prop("offsetHeight");b=c.floatingScrollbars()?"0":void 0;c.bidi(a.clone,"margin-left",a.left,b);c.bidi(a.clone,"margin-right",b,a.right)}function l(){var a=w.prop("scrollTop"),b=a>(l.prevScrollTop||0);l.prevScrollTop=a;if(0===a)r(null);else{if(b){if(p.next&&p.next.top<=a){r(p.next);return}if(p.current&&
p.next&&p.next.top-a<=p.next.height){v(p.current,a+(p.next.top-p.next.height-a));return}}if(!b){if(p.current&&p.prev&&a<p.current.top){r(p.prev);return}if(p.next&&p.current&&a>=p.next.top-p.current.height){v(p.current,a+(p.next.top-a-p.current.height));return}}p.current&&v(p.current,a)}}function r(a){p.current!==a&&(p.current&&(v(p.current,null),m(p.current,null)),a&&m(a,"active"),p.current=a,a=p.items.indexOf(a),p.next=p.items[a+1],p.prev=p.items[a-1],m(p.next,"next"),m(p.prev,"prev"))}function m(a,
b){a&&a.state!==b&&(a.state&&(a.clone.attr("sticky-prev-state",a.state),a.element.attr("sticky-prev-state",a.state)),a.clone.attr("sticky-state",b),a.element.attr("sticky-state",b),a.state=b)}function v(b,d){b&&(null===d||void 0===d?b.translateY&&(b.translateY=null,b.clone.css(a.CSS.TRANSFORM,"")):(b.translateY=d,c.bidi(b.clone,a.CSS.TRANSFORM,"translate3d("+b.left+"px,"+d+"px,0)","translateY("+d+"px)")))}var w=d.$element,t=b.throttle(g);f(w);w.on("$scrollstart",t);w.on("$scroll",l);var p;return p=
{prev:null,current:null,next:null,items:[],add:e,refreshElements:g}}function f(a){function d(){200<+c.now()-f?(e=!1,a.triggerHandler("$scrollend")):(a.triggerHandler("$scroll"),b.throttle(d))}var e,f;a.on("scroll touchmove",function(){e||(e=!0,b.throttle(d),a.triggerHandler("$scrollstart"));a.triggerHandler("$scroll");f=+c.now()})}var g=c.checkStickySupport();return function(a,b,c){var f=b.controller("mdContent");if(f)if(g)b.css({position:g,top:0,"z-index":2});else{var h=f.$element.data("$$sticky");
h||(h=e(f),f.$element.data("$$sticky",h));c=c||d(b.clone())(a);b=h.add(b,c);a.$on("$destroy",b)}}}ngmaterial.components.sticky=angular.module("material.components.sticky");MdSubheaderDirective.$inject=["$mdSticky","$compile","$mdTheming","$mdUtil","$mdAria"];angular.module("material.components.subheader",["material.core","material.components.sticky"]).directive("mdSubheader",MdSubheaderDirective);
function MdSubheaderDirective(a,b,c,d,e){return{restrict:"E",replace:!0,transclude:!0,template:'<div class="md-subheader _md">  <div class="md-subheader-inner">    <div class="md-subheader-content"></div>  </div></div>',link:function(f,g,h,k,n){function q(a){return angular.element(a[0].querySelector(".md-subheader-content"))}c(g);g.addClass("_md");d.prefixer().removeAttribute(g,"ng-repeat");var l=g[0].outerHTML;h.$set("role","heading");e.expect(g,"aria-level","2");n(f,function(a){q(g).append(a)});
g.hasClass("md-no-sticky")||n(f,function(c){var e=b('<div class="md-subheader-wrapper" aria-hidden="true">'+l+"</div>")(f);d.nextTick(function(){q(e).append(c)});a(f,g,e)})}}}ngmaterial.components.subheader=angular.module("material.components.subheader");angular.module("material.components.swipe",["material.core"]).directive("mdSwipeLeft",getDirective("SwipeLeft")).directive("mdSwipeRight",getDirective("SwipeRight")).directive("mdSwipeUp",getDirective("SwipeUp")).directive("mdSwipeDown",getDirective("SwipeDown"));
...
function MdSwitch(a,b,c,d,e,f,g){function h(a,h){var l=k.compile(a,h).post;a.addClass("md-dragging");return function(a,h,k,n){function m(b){D&&D(a)||(b.stopPropagation(),h.addClass("md-dragging"),F={width:B.prop("offsetWidth")})}function q(a){F&&(a.stopPropagation(),a.srcEvent&&a.srcEvent.preventDefault(),a=a.pointer.distanceX/F.width,a=w.$viewValue?1+a:a,a=Math.max(0,Math.min(1,a)),B.css(c.CSS.TRANSFORM,"translate3d("+100*a+"%,0,0)"),F.translate=a)}function r(b){F&&(b.stopPropagation(),h.removeClass("md-dragging"),
B.css(c.CSS.TRANSFORM,""),(b=w.$viewValue?.5>F.translate:.5<F.translate)&&v(!w.$viewValue),F=null,a.skipToggle=!0,g(function(){a.skipToggle=!1},1))}function v(b){a.$apply(function(){w.$setViewValue(b);w.$render()})}var w=n[1]||b.fakeNgModel(),D=null;null!=k.disabled?D=function(){return!0}:k.ngDisabled&&(D=d(k.ngDisabled));var B=angular.element(h[0].querySelector(".md-thumb-container")),E=angular.element(h[0].querySelector(".md-container")),G=angular.element(h[0].querySelector(".md-label"));e(function(){h.removeClass("md-dragging")});
l(a,h,k,n);D&&a.$watch(D,function(a){h.attr("tabindex",a?-1:0)});k.$observe("mdInvert",function(a){(a=b.parseAttributeBoolean(a))?h.prepend(G):h.prepend(E);h.toggleClass("md-inverted",a)});f.register(E,"drag");E.on("$md.dragstart",m).on("$md.drag",q).on("$md.dragend",r);var F}}var k=a[0];return{restrict:"E",priority:c.BEFORE_NG_ARIA,transclude:!0,template:'<div class="md-container"><div class="md-bar"></div><div class="md-thumb-container"><div class="md-thumb" md-ink-ripple md-ink-ripple-checkbox></div></div></div><div ng-transclude class="md-label"></div>',
...
function MdTabsPaginationService(){function a(a,b){var d=a.canvas;a=c(a);var e;for(e=0;e<a.length;e++)if(a[e]>=b){var f=a[e];break}return Math.max(0,f-d.clientWidth)}function b(a,b){var e=a.canvas,f=d(a)-e.clientWidth;a=c(a);var k;for(k=0;k<a.length,a[k]<=b+e.clientWidth;k++)var n=a[k];return Math.min(f,n)}function c(a){var b,c=0,d=[];for(b=0;b<a.tabs.length;b++){var e=a.tabs[b];d.push(c);c+=e.offsetWidth}return d}function d(a){var b=0,c;for(c=0;c<a.tabs.length;c++){var d=a.tabs[c];b+=d.offsetWidth}return b}
...
function MdTabsController(a,b,c,d,e,f,g,h,k,n,q,l){function r(){w("stretchTabs",y);da("focusIndex",G,u.selectedIndex||0);da("offsetLeft",E,0);da("hasContent",B,!1);da("maxTabWidth",A,ka());da("shouldPaginate",D,!1);t("noInkBar",S);t("dynamicHeight",U);t("noPagination");t("swipeContent");t("noDisconnect");t("autoselect");t("noSelectClick");t("centerTabs",z,!1);t("enableDisconnect");u.scope=a;u.parent=a.$parent;u.tabs=[];u.lastSelectedIndex=null;u.hasFocus=!1;u.styleTabItemFocus=!1;u.shouldCenterTabs=
u.centerTabs&&!u.shouldPaginate;u.tabContentPrefix="tab-content-";m()}function m(){u.selectedIndex=u.selectedIndex||0;v();a.$watch("$mdTabsCtrl.selectedIndex",F);angular.element(c).on("resize",Y);a.$on("$destroy",p);n(b);f.nextTick(function(){O();ha();ea();I();u.tabs[u.selectedIndex]&&u.tabs[u.selectedIndex].scope.select();fa=!0;T()})}function v(){var a=h.$mdTabsTemplate,c=angular.element(b[0].querySelector("md-tab-data"));c.html(a);k(c.contents())(u.parent);delete h.$mdTabsTemplate}function w(a,
b){var c=h.$normalize("md-"+a);b&&da(a,b);h.$observe(c,function(b){u[a]=b})}function t(a,b){function c(b){u[a]="false"!==b}var d=h.$normalize("md-"+a);b&&da(a,b);h.hasOwnProperty(d)&&c(h[d]);h.$observe(d,c)}function p(){la=!0;angular.element(c).off("resize",Y)}function y(){var a=O();angular.element(a.wrapper).toggleClass("md-stretch-tabs",ja());I()}function z(){u.shouldCenterTabs=u.centerTabs&&!u.shouldPaginate}function A(a,b){a!==b&&(b=O(),angular.forEach(b.tabs,function(b){b.style.maxWidth=a+"px"}),
angular.forEach(b.dummies,function(b){b.style.maxWidth=a+"px"}),f.nextTick(u.updateInkBarStyles))}function D(a,b){a!==b&&(u.maxTabWidth=ka(),u.shouldCenterTabs=u.centerTabs&&!u.shouldPaginate,f.nextTick(function(){u.maxTabWidth=ka();ea(u.selectedIndex)}))}function B(a){b[a?"removeClass":"addClass"]("md-no-tab-content")}function E(b){var c=O();b=(u.shouldCenterTabs||ba()?"":"-")+b+"px";b=b.replace("--","");angular.element(c.paging).css(d.CSS.TRANSFORM,"translate3d("+b+", 0, 0)");a.$broadcast("$mdTabsPaginationChanged")}
function G(a,b){a!==b&&O().tabs[a]&&(ea(),pa())}function F(b,c){b!==c&&(u.selectedIndex=M(b),u.lastSelectedIndex=c,u.updateInkBarStyles(),ha(),ea(b),a.$broadcast("$mdTabsChanged"),u.tabs[c]&&u.tabs[c].scope.deselect(),u.tabs[b]&&u.tabs[b].scope.select())}function H(a){var c=b[0].getElementsByTagName("md-tab");return Array.prototype.indexOf.call(c,a[0])}function J(){J.watcher||(J.watcher=a.$watch(function(){f.nextTick(function(){J.watcher&&b.prop("offsetParent")&&(J.watcher(),J.watcher=null,Y())},
!1)}))}function C(a){switch(a.keyCode){case d.KEY_CODE.LEFT_ARROW:a.preventDefault();oa(-1,!0);break;case d.KEY_CODE.RIGHT_ARROW:a.preventDefault();oa(1,!0);break;case d.KEY_CODE.SPACE:case d.KEY_CODE.ENTER:a.preventDefault();Z||N(u.focusIndex);break;case d.KEY_CODE.TAB:u.focusIndex!==u.selectedIndex&&(u.focusIndex=u.selectedIndex)}}function N(a,b){Z||(u.focusIndex=u.selectedIndex=a);b&&u.noSelectClick||f.nextTick(function(){u.tabs[a].element.triggerHandler("click")},!1)}function K(a){u.shouldPaginate&&
(a.preventDefault(),u.offsetLeft=Q(u.offsetLeft-a.wheelDelta))}function L(){if(u.canPageForward()){var a=l.increasePageOffset(O(),u.offsetLeft);u.offsetLeft=Q(a)}}function R(){if(u.canPageBack()){var a=l.decreasePageOffset(O(),u.offsetLeft);u.offsetLeft=Q(a)}}function Y(){u.lastSelectedIndex=u.selectedIndex;u.offsetLeft=Q(u.offsetLeft);f.nextTick(function(){u.updateInkBarStyles();T()})}function S(a){angular.element(O().inkBar).toggleClass("ng-hide",a)}function U(a){b.toggleClass("md-dynamic-height",
a)}function X(a){if(!la){var b=u.selectedIndex;a=u.tabs.splice(a.getIndex(),1)[0];qa();u.selectedIndex===b&&(a.scope.deselect(),u.tabs[u.selectedIndex]&&u.tabs[u.selectedIndex].scope.select());f.nextTick(function(){T();u.offsetLeft=Q(u.offsetLeft)})}}function P(a,b){var c=fa,d={getIndex:function(){return u.tabs.indexOf(e)},isActive:function(){return this.getIndex()===u.selectedIndex},isLeft:function(){return this.getIndex()<u.selectedIndex},isRight:function(){return this.getIndex()>u.selectedIndex},
shouldRender:function(){return!u.noDisconnect||this.isActive()},hasFocus:function(){return u.styleTabItemFocus&&u.hasFocus&&this.getIndex()===u.focusIndex},id:f.nextUid(),hasContent:!(!a.template||!a.template.trim())},e=angular.extend(d,a);angular.isDefined(b)?u.tabs.splice(b,0,e):u.tabs.push(e);ta();x();f.nextTick(function(){T();W(e);c&&u.autoselect&&f.nextTick(function(){f.nextTick(function(){N(u.tabs.indexOf(e))})})});return e}function O(){var a={},c=b[0];a.wrapper=c.querySelector("md-tabs-wrapper");
a.canvas=a.wrapper.querySelector("md-tabs-canvas");a.paging=a.canvas.querySelector("md-pagination-wrapper");a.inkBar=a.paging.querySelector("md-ink-bar");a.nextButton=c.querySelector("md-next-button");a.prevButton=c.querySelector("md-prev-button");a.contents=c.querySelectorAll("md-tabs-content-wrapper > md-tab-content");a.tabs=a.paging.querySelectorAll("md-tab-item");a.dummies=a.canvas.querySelectorAll("md-dummy-tab");return a}function ca(){return 0<u.offsetLeft}function ma(){var a=O(),b=a.tabs[a.tabs.length-
1];return ba()?u.offsetLeft<a.paging.offsetWidth-a.canvas.offsetWidth:b&&b.offsetLeft+b.offsetWidth>a.canvas.clientWidth+u.offsetLeft}function ia(){var a=u.tabs[u.focusIndex];return a&&a.id?"tab-item-"+a.id:null}function ja(){switch(u.stretchTabs){case "always":return!0;case "never":return!1;default:return!u.shouldPaginate&&c.matchMedia("(max-width: 600px)").matches}}function ra(){if(u.noPagination||!fa)return!1;var a=b.prop("clientWidth");angular.forEach(O().tabs,function(b){a-=b.offsetWidth});return 0>
a}function M(a){if(-1===a)return-1;var b=Math.max(u.tabs.length-a,a),c,d;for(c=0;c<=b;c++)if((d=u.tabs[a+c])&&!0!==d.scope.disabled||(d=u.tabs[a-c])&&!0!==d.scope.disabled)return d.getIndex();return a}function da(a,b,c){Object.defineProperty(u,a,{get:function(){return c},set:function(a){var d=c;c=a;b&&b(a,d)}})}function T(){u.maxTabWidth=ka();u.shouldPaginate=ra()}function na(a){var b=0;angular.forEach(a,function(a){b+=Math.max(a.offsetWidth,a.getBoundingClientRect().width)});return Math.ceil(b)}
function ka(){var a=O();a=a.canvas.clientWidth;return Math.max(0,Math.min(a-1,264))}function sa(){var a=u.tabs[u.selectedIndex],b=u.tabs[u.focusIndex];u.tabs=u.tabs.sort(function(a,b){return a.index-b.index});u.selectedIndex=u.tabs.indexOf(a);u.focusIndex=u.tabs.indexOf(b)}function oa(a,b){var c=b?"focusIndex":"selectedIndex",d=u[c];for(b=d+a;u.tabs[b]&&u.tabs[b].scope.disabled;b+=a);b=(d+a+u.tabs.length)%u.tabs.length;u.tabs[b]&&(u[c]=b)}function pa(){u.styleTabItemFocus="keyboard"===q.getLastInteractionType();
O().tabs[u.focusIndex].focus()}function ea(a){var b=O();angular.isNumber(a)||(a=u.focusIndex);if(b.tabs[a]&&!u.shouldCenterTabs){var c=b.tabs[a],d=c.offsetLeft;c=c.offsetWidth+d;0==a?u.offsetLeft=0:ba()?(d=na(Array.prototype.slice.call(b.tabs,0,a)),a=na(Array.prototype.slice.call(b.tabs,0,a+1)),u.offsetLeft=Math.min(u.offsetLeft,Q(d)),u.offsetLeft=Math.max(u.offsetLeft,Q(a-b.canvas.clientWidth))):(u.offsetLeft=Math.max(u.offsetLeft,Q(c-b.canvas.clientWidth+32)),u.offsetLeft=Math.min(u.offsetLeft,
Q(d)))}}function ta(){V.forEach(function(a){f.nextTick(a)});V=[]}function x(){for(var a=!1,b=0;b<u.tabs.length;b++)if(u.tabs[b].hasContent){a=!0;break}u.hasContent=a}function qa(){u.selectedIndex=M(u.selectedIndex);u.focusIndex=M(u.focusIndex)}function ha(){if(!u.dynamicHeight)return b.css("height","");if(!u.tabs.length)return V.push(ha);var a=O(),c=a.contents[u.selectedIndex];c=c?c.offsetHeight:0;a=a.wrapper.offsetHeight;c+=a;var d=b.prop("clientHeight");d!==c&&("bottom"===b.attr("md-align-tabs")&&
(d-=a,c-=a,void 0!==b.attr("md-border-bottom")&&++d),Z=!0,a={height:d+"px"},c={height:c+"px"},b.css(a),g(b,{from:a,to:c,easing:"cubic-bezier(0.35, 0, 0.25, 1)",duration:.5}).start().done(function(){b.css({transition:"none",height:""});f.nextTick(function(){b.css("transition","")});Z=!1}))}function I(){var a=O();if(a.tabs[u.selectedIndex]){if(!u.tabs.length)return V.push(u.updateInkBarStyles);if(!b.prop("offsetParent"))return J();var c=u.selectedIndex,d=a.paging.offsetWidth,e=a.tabs[c];c=e.offsetLeft;
e=d-c-e.offsetWidth;if(u.shouldCenterTabs){var g=na(a.tabs);d>g&&f.nextTick(I,!1)}var h=O();d=u.selectedIndex;g=u.lastSelectedIndex;h=angular.element(h.inkBar);angular.isNumber(g)&&h.toggleClass("md-left",d<g).toggleClass("md-right",d>g);angular.element(a.inkBar).css({left:c+"px",right:e+"px"})}else angular.element(a.inkBar).css({left:"auto",right:"auto"})}function Q(a){var b=O();if(!b.tabs.length||!u.shouldPaginate)return 0;var c=b.tabs[b.tabs.length-1];c=c.offsetLeft+c.offsetWidth;ba()?(a=Math.min(b.paging.offsetWidth-
b.canvas.clientWidth,a),a=Math.max(0,a)):(a=Math.max(0,a),a=Math.min(c-b.canvas.clientWidth,a));return a}function aa(a,b){var c=O();c={colorElement:angular.element(c.inkBar)};e.attach(a,b,c)}function W(a){if(a.hasContent){var c=b[0].querySelectorAll('[md-tab-id="'+a.id+'"]');angular.element(c).attr("aria-controls",u.tabContentPrefix+a.id)}}function ba(){return"rtl"==f.bidi()}var u=this,Z=!1;O();var V=[],la=!1,fa=!1;u.$onInit=r;u.updatePagination=f.debounce(T,100);u.redirectFocus=pa;u.attachRipple=
aa;u.insertTab=P;u.removeTab=X;u.select=N;u.scroll=K;u.nextPage=L;u.previousPage=R;u.keydown=C;u.canPageForward=ma;u.canPageBack=ca;u.refreshIndex=qa;u.incrementIndex=oa;u.getTabElementIndex=H;u.updateInkBarStyles=f.debounce(I,100);u.updateTabOrder=f.debounce(sa,100);u.getFocusedTabId=ia;1===angular.version.major&&4>=angular.version.minor&&this.$onInit()}MdTabs.$inject=["$$mdSvgRegistry"];angular.module("material.components.tabs").directive("mdTabs",MdTabs);
...
function MdTabsDummyWrapper(a,b){return{require:"^?mdTabs",link:function(c,d,e,f){if(f){var g=function(){f.updatePagination();f.updateInkBarStyles()};if("MutationObserver"in b){e={childList:!0,subtree:!0,characterData:!0};g=new MutationObserver(g);g.observe(d[0],e);var h=g.disconnect.bind(g)}else e=a.debounce(g,15,null,!1),d.on("DOMSubtreeModified",e),h=d.off.bind(d,"DOMSubtreeModified",e);c.$on("$destroy",function(){h()})}}}}MdTabsTemplate.$inject=["$compile","$mdUtil"];
angular.module("material.components.tabs").directive("mdTabsTemplate",MdTabsTemplate);
function MdTabsTemplate(a,b){function c(c,e,f,g){function d(){c.$watch("connected",function(a){!1===a?g.enableDisconnect&&b.disconnectScope(n):k()});c.$on("$destroy",k)}function k(){g.enableDisconnect&&b.reconnectScope(n)}if(g){var n=g.enableDisconnect?c.compileScope.$new():c.compileScope;e.html(c.template);a(e.contents())(n);return b.nextTick(d)}}return{restrict:"A",link:c,scope:{template:"=mdTabsTemplate",connected:"=?mdConnectedIf",compileScope:"=mdScope"},require:"^?mdTabs"}}
...
function MdToastProvider(a){function b(a){e=a}function c(a,b){this.$onInit=function(){var c=this;c.highlightAction&&(b.highlightClasses=["md-highlight",c.highlightClass]);b.$watch(function(){return e},function(){c.content=e});this.resolve=function(){a.hide("ok")}}}function d(a,b,c,d){function f(f,g,k){e=k.textContent||k.content;var l=!d("gt-sm");g=c.extractElementByName(g,"md-toast",!0);k.element=g;k.onSwipe=function(a){a=a.type.replace("$md.","");var d=a.replace("swipe","");"down"===d&&-1!=k.position.indexOf("top")&&
!l||"up"===d&&(-1!=k.position.indexOf("bottom")||l)||("left"===d||"right"===d)&&l||(g.addClass("md-"+a),c.nextTick(b.cancel))};k.openClass=h(k.position);g.addClass(k.toastClass);k.parent.addClass(k.openClass);c.hasComputedStyle(k.parent,"position","static")&&k.parent.css("position","relative");g.on("$md.swipeleft $md.swiperight $md.swipeup $md.swipedown",k.onSwipe);g.addClass(l?"md-bottom":k.position.split(" ").map(function(a){return"md-"+a}).join(" "));k.parent&&k.parent.addClass("md-toast-animating");
return a.enter(g,k.parent).then(function(){k.parent&&k.parent.removeClass("md-toast-animating")})}function g(b,d,e){d.off("$md.swipeleft $md.swiperight $md.swipeup $md.swipedown",e.onSwipe);e.parent&&e.parent.addClass("md-toast-animating");e.openClass&&e.parent.removeClass(e.openClass);return(1==e.$destroy?d.remove():a.leave(d)).then(function(){e.parent&&e.parent.removeClass("md-toast-animating");c.hasComputedStyle(e.parent,"position","static")&&e.parent.css("position","")})}function h(a){return d("gt-xs")?
...
function mdToolbarDirective(a,b,c,d,e){var f=angular.bind(null,c.supplant,"translate3d(0,{0}px,0)");return{template:"",restrict:"E",link:function(g,h,k){function n(){function d(a){var b=h.parent().find("md-content");!t&&b.length&&l(null,b);a=g.$eval(a);!1===a?p():p=m()}function l(a,b){b&&h.parent()[0]===b.parent()[0]&&(t&&t.off("scroll",D),t=b,p=m())}function n(a){a=a?a.target.scrollTop:z;B();y=Math.min(w/A,Math.max(0,y+a-z));h.css(b.CSS.TRANSFORM,f([-y*A]));t.css(b.CSS.TRANSFORM,f([(w-y)*A]));z=
a;c.nextTick(function(){var a=h.hasClass("md-whiteframe-z1");a&&!y?e.removeClass(h,"md-whiteframe-z1"):!a&&y&&e.addClass(h,"md-whiteframe-z1")})}function m(){if(!t)return angular.noop;t.on("scroll",D);t.attr("scroll-shrink","true");c.nextTick(v,!1);return function(){t.off("scroll",D);t.attr("scroll-shrink","false");v()}}function v(){w=h.prop("offsetHeight");var a=-w*A+"px";t.css({"margin-top":a,"margin-bottom":a});n()}var w,t,p=angular.noop,y=0,z=0,A=k.mdShrinkSpeedFactor||.5,D=a.throttle(n),B=c.debounce(v,
5E3);g.$on("$mdContentLoaded",l);k.$observe("mdScrollShrink",d);k.ngShow&&g.$watch(k.ngShow,v);k.ngHide&&g.$watch(k.ngHide,v);g.$on("$destroy",p)}h.addClass("_md");d(h);c.nextTick(function(){h.addClass("_md-toolbar-transitions")},!1);angular.isDefined(k.mdScrollShrink)&&n()}}}ngmaterial.components.toolbar=angular.module("material.components.toolbar");MdTooltipDirective.$inject="$timeout $window $$rAF $document $interpolate $mdUtil $mdPanel $$mdTooltipRegistry".split(" ");angular.module("material.components.tooltip",["material.core","material.components.panel"]).directive("mdTooltip",MdTooltipDirective).service("$$mdTooltipRegistry",MdTooltipRegistry);
function MdTooltipDirective(a,b,c,d,e,f,g,h){function k(k,l,r){function m(){k.mdZIndex=k.mdZIndex||100;k.mdDelay=k.mdDelay||0;n[k.mdDirection]||(k.mdDirection="bottom")}function q(a){a=a||e(l.text().trim())(k.$parent);if(!B.attr("aria-label")&&!B.attr("aria-labelledby")||B.attr("md-labeled-by-tooltip"))B.attr("aria-label",a),B.attr("md-labeled-by-tooltip")||B.attr("md-labeled-by-tooltip",D)}function w(){m();C&&C.panelEl&&C.panelEl.removeClass(F);F="md-origin-"+k.mdDirection;H=n[k.mdDirection];J=g.newPanelPosition().relativeTo(B).addPanelPosition(H.x,
H.y);C&&C.panelEl&&(C.panelEl.addClass(F),C.updatePosition(J))}function t(){function c(a){a.some(function(a){return"disabled"===a.attributeName&&B[0].disabled});return!1}function e(){y(!1)}function g(){L=document.activeElement===B[0]}function l(a){if("focus"===a.type&&L)L=!1;else if(!k.mdVisible&&(B.on("blur touchcancel mouseleave",m),y(!0),"touchstart"===a.type))B.one("touchend",function(){f.nextTick(function(){d.one("touchend",m)},!1)})}function m(){if((N=k.hasOwnProperty("mdAutohide")?k.mdAutohide:
r.hasOwnProperty("mdAutohide"))||G||d[0].activeElement!==B[0])K&&(a.cancel(K),y.queued=!1,K=null),B.off("blur touchcancel mouseleave",m),B.triggerHandler("blur"),y(!1);G=!1}function n(){G=!0}function p(){h.deregister("scroll",e,!0);h.deregister("blur",g);h.deregister("resize",E);B.off("focus touchstart mouseenter",l).off("blur touchcancel mouseleave",m).off("mousedown",n);m();q&&q.disconnect()}if(B[0]&&"MutationObserver"in b){var q=new MutationObserver(function(a){c(a)&&f.nextTick(function(){y(!1)})});
q.observe(B[0],{attributes:!0})}L=!1;h.register("scroll",e,!0);h.register("blur",g);h.register("resize",E);k.$on("$destroy",p);B.on("mousedown",n);B.on("focus touchstart mouseenter",l)}function p(){function a(){k.$destroy()}if(l[0]&&"MutationObserver"in b){var c=new MutationObserver(function(a){a.forEach(function(a){"md-visible"!==a.attributeName||k.visibleWatcher||(k.visibleWatcher=k.$watch("mdVisible",z))})});c.observe(l[0],{attributes:!0});r.hasOwnProperty("mdVisible")&&(k.visibleWatcher=k.$watch("mdVisible",
z))}else k.visibleWatcher=k.$watch("mdVisible",z);k.$watch("mdDirection",w);l.one("$destroy",a);B.one("$destroy",a);k.$on("$destroy",function(){y(!1);C&&C.destroy();c&&c.disconnect();l.remove()});-1<l.text().indexOf(e.startSymbol())&&k.$watch(function(){return l.text().trim()},q)}function y(b){y.queued&&y.value===!!b||!y.queued&&k.mdVisible===!!b||(y.value=!!b,y.queued||(b?(y.queued=!0,K=a(function(){k.mdVisible=y.value;y.queued=!1;K=null;k.visibleWatcher||z(k.mdVisible)},k.mdDelay)):f.nextTick(function(){k.mdVisible=
!1;k.visibleWatcher||z(!1)})))}function z(a){a?A():C&&C.close()}function A(){if(!l[0].textContent.trim())throw Error("Text for the tooltip has not been provided. Please include text within the mdTooltip element.");if(!C){var a=angular.element(document.body),b=g.newPanelAnimation().openFrom(B).closeTo(B).withAnimation({open:"md-show",close:"md-hide"});a={id:D,attachTo:a,contentElement:l,propagateContainerEvents:!0,panelClass:"md-tooltip",animation:b,position:J,zIndex:k.mdZIndex,focusOnOpen:!1,onDomAdded:function(){C.panelEl.addClass(F)}};
C=g.create(a)}C.open().then(function(){C.panelEl.attr("role","tooltip")})}var D="md-tooltip-"+f.nextUid(),B=f.getParentWithPointerEvents(l),E=c.throttle(w),G=!1,F,H,J,C,N,K,L=null;m();q();l.detach();w();t();p()}var n={top:{x:g.xPosition.CENTER,y:g.yPosition.ABOVE},right:{x:g.xPosition.OFFSET_END,y:g.yPosition.CENTER},bottom:{x:g.xPosition.CENTER,y:g.yPosition.BELOW},left:{x:g.xPosition.OFFSET_START,y:g.yPosition.CENTER}};return{restrict:"E",priority:210,scope:{mdZIndex:"=?mdZIndex",mdDelay:"=?mdDelay",
mdVisible:"=?mdVisible",mdAutohide:"=?mdAutohide",mdDirection:"@?mdDirection"},link:k}}
function MdTooltipRegistry(){function a(a){d[a.type]&&d[a.type].forEach(function(b){b.call(this,a)},this)}function b(b,c,h){var f=d[b]=d[b]||[];f.length||(h?window.addEventListener(b,a,!0):e.on(b,a));-1===f.indexOf(c)&&f.push(c)}function c(b,c,h){var f=d[b];c=f?f.indexOf(c):-1;-1<c&&(f.splice(c,1),0===f.length&&(h?window.removeEventListener(b,a,!0):e.off(b,a)))}var d={},e=angular.element(window);return{register:b,deregister:c}}ngmaterial.components.tooltip=angular.module("material.components.tooltip");/*
 Angular Material Design
 https://github.com/angular/material
 @license MIT
 v1.1.0
